...
echo ""
echo "--- Performance Baseline A720 Big ---"
taskset -c 10 "${BUILD_DIR}/test_sve2_baseline"
echo "--- Performance Baseline A720 Mid ---"
taskset -c 7 "${BUILD_DIR}/test_sve2_baseline"
echo "--- Performance Baseline A520 ---"
taskset -c 5 "${BUILD_DIR}/test_sve2_baseline"
