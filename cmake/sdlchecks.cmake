...
macro(FindLibraryAndSONAME _LIB)
  ...
  if(${_LNAME}_LIB)
    ...
    elseif(CYGWIN)
      ...
      string(REGEX MATCH "libXtst\\.dll\\.a" LIBXTST ${_LIB_JUSTNAME})
      string(REGEX MATCH "libfribidi\\.dll\\.a" LIBFRIBIDI ${_LIB_JUSTNAME})
      string(REGEX MATCH "libthai\\.dll\\.a" LIBTHAI ${_LIB_JUSTNAME})
      string(REGEX MATCH "libXss\\.dll\\.a" LIBXSS ${_LIB_JUSTNAME})
      if(LIBPULSE)
      ...
      elseif(LIBXTST)
        set(_LIB_REGEXD "cygXtst-6.dll")
      elseif(LIBFRIBIDI)
        set(_LIB_REGEXD "cygfribidi-0.dll")
      elseif(LIBTHAI)
        set(_LIB_REGEXD "cygthai-0.dll")
      elseif(LIBXSS)
        set(_LIB_REGEXD "cygXss-1.dll")
      else()
