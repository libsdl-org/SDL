...
function(sdl_glob_sources)
  ...
  source_group(TREE ${PROJECT_SOURCE_DIR} FILES ${shared_sources} ${shared_sources} ${both_sources})
...
function(sdl_sources)
  ...
  source_group(TREE ${PROJECT_SOURCE_DIR} FILES ${ARGS_SHARED} ${ARGS_STATIC} ${ARGS_UNPARSED_ARGUMENTS})
