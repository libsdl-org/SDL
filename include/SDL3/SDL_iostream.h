 ...
 */
[[free(SDL_CloseIO)]]
extern SDL_DECLSPEC SDL_IOStream *SDLCALL SDL_IOFromFile([[in]] const char *file, [[in]] const char *mode);
 ...
 */
[[free(SDL_CloseIO)]]
extern SDL_DECLSPEC SDL_IOStream *SDLCALL SDL_IOFromMem([[inout, array(size)]] void *mem, size_t size);
 ...
 */
[[free(SDL_CloseIO)]]
extern SDL_DECLSPEC SDL_IOStream *SDLCALL SDL_IOFromConstMem([[in, array(size)]] const void *mem, size_t size);
 ...
 */
[[free(SDL_CloseIO)]]
extern SDL_DECLSPEC SDL_IOStream *SDLCALL SDL_OpenIO(
    [[in]] const SDL_IOStreamInterface *iface, [[inout]] void *userdata);
 ...
 * \sa SDL_OpenIO
 */
extern SDL_DECLSPEC int SDLCALL SDL_CloseIO([[self]] SDL_IOStream *context);
 ...
 * \sa SDL_SetProperty
 */
extern SDL_DECLSPEC SDL_PropertiesID SDLCALL SDL_GetIOProperties([[self]] SDL_IOStream *context);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC SDL_IOStatus SDLCALL SDL_GetIOStatus([[self]] SDL_IOStream *context);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC Sint64 SDLCALL SDL_GetIOSize([[self]] SDL_IOStream *context);
 ...
 * \sa SDL_TellIO
 */
extern SDL_DECLSPEC Sint64 SDLCALL SDL_SeekIO([[self]] SDL_IOStream *context, Sint64 offset, SDL_IOWhence whence);
 ...
 * \sa SDL_SeekIO
 */
extern SDL_DECLSPEC Sint64 SDLCALL SDL_TellIO([[self]] SDL_IOStream *context);
 ...
 * \sa SDL_GetIOStatus
 */
extern SDL_DECLSPEC size_t SDLCALL SDL_ReadIO(
    [[self]] SDL_IOStream *context,
    [[inout, array(size)]] void *ptr, size_t size);
 ...
 * \sa SDL_GetIOStatus
 */
extern SDL_DECLSPEC size_t SDLCALL SDL_WriteIO(
    [[self]] SDL_IOStream *context,
    [[in, array(size)]] const void *ptr, size_t size);
 ...
 * \sa SDL_WriteIO
 */
extern SDL_DECLSPEC size_t SDLCALL SDL_IOprintf([[self]] SDL_IOStream *context, SDL_PRINTF_FORMAT_STRING const char *fmt, ...) SDL_PRINTF_VARARG_FUNC(2);
 ...
 * \sa SDL_WriteIO
 */
extern SDL_DECLSPEC size_t SDLCALL SDL_IOvprintf([[self]] SDL_IOStream *context, SDL_PRINTF_FORMAT_STRING const char *fmt, va_list ap) SDL_PRINTF_VARARG_FUNCV(2);
 ...
 */
[[free(SDL_free)]]
extern SDL_DECLSPEC void *SDLCALL SDL_LoadFile_IO(
    [[self]] SDL_IOStream *src,
    [[out]] size_t *datasize,
    SDL_bool closeio);
 ...
 * The data should be freed with SDL_free().
 *
 * \param[in] file the path to read all available data from.
 * \param datasize if not NULL, will store the number of bytes read.
 * \returns the data, or NULL if there was an error.
 *
 * \since This function is available since SDL 3.0.0.
 ...
 */
[[free(SDL_free)]]
extern SDL_DECLSPEC void *SDLCALL SDL_LoadFile(
    [[in]] const char *file, [[out]] size_t *datasize);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_ReadU8(
    [[self]] SDL_IOStream *src,
    [[out]] Uint8 *value);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_ReadS8([[self]] SDL_IOStream *src, Sint8 *value);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_ReadU16LE(
    [[self]] SDL_IOStream *src,
    [[out]] Uint16 *value);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_ReadS16LE(
    [[self]] SDL_IOStream *src,
    [[out]] Sint16 *value);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_ReadU16BE(
    [[self]] SDL_IOStream *src,
    [[out]] Uint16 *value);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_ReadS16BE(
    [[self]] SDL_IOStream *src,
    [[out]] Sint16 *value);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_ReadU32LE(
    [[self]] SDL_IOStream *src,
    [[out]] Uint32 *value);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_ReadS32LE(
    [[self]] SDL_IOStream *src,
    [[out]] Sint32 *value);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_ReadU32BE(
    [[self]] SDL_IOStream *src,
    [[out]] Uint32 *value);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_ReadS32BE(
    [[self]] SDL_IOStream *src,
    [[out]] Sint32 *value);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_ReadU64LE(
    [[self]] SDL_IOStream *src,
    [[out]] Uint64 *value);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_ReadS64LE(
    [[self]] SDL_IOStream *src,
    [[out]] Sint64 *value);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_ReadU64BE(
    [[self]] SDL_IOStream *src,
    [[out]] Uint64 *value);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_ReadS64BE(
    [[self]] SDL_IOStream *src,
    [[out]] Sint64 *value);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_WriteU8([[self]] SDL_IOStream *dst, Uint8 value);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_WriteS8([[self]] SDL_IOStream *dst, Sint8 value);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_WriteU16LE([[self]] SDL_IOStream *dst, Uint16 value);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_WriteS16LE([[self]] SDL_IOStream *dst, Sint16 value);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_WriteU16BE([[self]] SDL_IOStream *dst, Uint16 value);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_WriteS16BE([[self]] SDL_IOStream *dst, Sint16 value);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_WriteU32LE([[self]] SDL_IOStream *dst, Uint32 value);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_WriteS32LE([[self]] SDL_IOStream *dst, Sint32 value);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_WriteU32BE([[self]] SDL_IOStream *dst, Uint32 value);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_WriteS32BE([[self]] SDL_IOStream *dst, Sint32 value);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_WriteU64LE([[self]] SDL_IOStream *dst, Uint64 value);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_WriteS64LE([[self]] SDL_IOStream *dst, Sint64 value);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_WriteU64BE([[self]] SDL_IOStream *dst, Uint64 value);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_WriteS64BE([[self]] SDL_IOStream *dst, Sint64 value);
