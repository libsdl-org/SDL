 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_Vulkan_LoadLibrary(const char *path);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN SDL_FunctionPointer SDLCALL SDL_Vulkan_GetVkGetInstanceProcAddr(void);
 ...
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_Vulkan_UnloadLibrary(void);
 ...
 */
extern SDL_DECLSPEC_RETURN char const* const* SDLCALL SDL_Vulkan_GetInstanceExtensions(Uint32 *count);
 ...
 * \sa SDL_Vulkan_CreateSurface
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_Vulkan_DestroySurface(VkInstance instance,
                                                       VkSurfaceKHR surface,
                                                       const struct VkAllocationCallbacks *allocator);
