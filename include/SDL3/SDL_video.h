...
#define SDL_WINDOW_FULLSCREEN           ((SDL_WindowFlags) 0x00000001U) /**< window is in fullscreen mode */
#define SDL_WINDOW_OPENGL               ((SDL_WindowFlags) 0x00000002U) /**< window usable with OpenGL context */
#define SDL_WINDOW_OCCLUDED             ((SDL_WindowFlags) 0x00000004U) /**< window is occluded */
#define SDL_WINDOW_HIDDEN               ((SDL_WindowFlags) 0x00000008U) /**< window is neither mapped onto the desktop nor shown in the taskbar/dock/window list; SDL_ShowWindow() is required for it to become visible */
#define SDL_WINDOW_BORDERLESS           ((SDL_WindowFlags) 0x00000010U) /**< no window decoration */
#define SDL_WINDOW_RESIZABLE            ((SDL_WindowFlags) 0x00000020U) /**< window can be resized */
#define SDL_WINDOW_MINIMIZED            ((SDL_WindowFlags) 0x00000040U) /**< window is minimized */
#define SDL_WINDOW_MAXIMIZED            ((SDL_WindowFlags) 0x00000080U) /**< window is maximized */
#define SDL_WINDOW_MOUSE_GRABBED        ((SDL_WindowFlags) 0x00000100U) /**< window has grabbed mouse input */
#define SDL_WINDOW_INPUT_FOCUS          ((SDL_WindowFlags) 0x00000200U) /**< window has input focus */
#define SDL_WINDOW_MOUSE_FOCUS          ((SDL_WindowFlags) 0x00000400U) /**< window has mouse focus */
#define SDL_WINDOW_EXTERNAL             ((SDL_WindowFlags) 0x00000800U) /**< window not created by SDL */
#define SDL_WINDOW_HIGH_PIXEL_DENSITY   ((SDL_WindowFlags) 0x00002000U) /**< window uses high pixel density back buffer if possible */
#define SDL_WINDOW_MOUSE_CAPTURE        ((SDL_WindowFlags) 0x00004000U) /**< window has mouse captured (unrelated to MOUSE_GRABBED) */
#define SDL_WINDOW_ALWAYS_ON_TOP        ((SDL_WindowFlags) 0x00008000U) /**< window should always be above others */
#define SDL_WINDOW_UTILITY              ((SDL_WindowFlags) 0x00020000U) /**< window should be treated as a utility window, not showing in the task bar and window list */
#define SDL_WINDOW_TOOLTIP              ((SDL_WindowFlags) 0x00040000U) /**< window should be treated as a tooltip */
#define SDL_WINDOW_POPUP_MENU           ((SDL_WindowFlags) 0x00080000U) /**< window should be treated as a popup menu */
#define SDL_WINDOW_KEYBOARD_GRABBED     ((SDL_WindowFlags) 0x00100000U) /**< window has grabbed keyboard input */
#define SDL_WINDOW_VULKAN               ((SDL_WindowFlags) 0x10000000U) /**< window usable for Vulkan surface */
#define SDL_WINDOW_METAL                ((SDL_WindowFlags) 0x20000000U) /**< window usable for Metal view */
#define SDL_WINDOW_TRANSPARENT          ((SDL_WindowFlags) 0x40000000U) /**< window with transparent buffer */
#define SDL_WINDOW_NOT_FOCUSABLE        ((SDL_WindowFlags) 0x80000000U) /**< window should not be focusable */
