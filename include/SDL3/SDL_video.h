 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetNumVideoDrivers(void);
 ...
 */
extern SDL_DECLSPEC_RETURN const char *SDLCALL SDL_GetVideoDriver(int index);
 ...
 * \sa SDL_GetVideoDriver
 */
extern SDL_DECLSPEC_RETURN const char *SDLCALL SDL_GetCurrentVideoDriver(void);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN SDL_SystemTheme SDLCALL SDL_GetSystemTheme(void);
 ...
 * \sa SDL_GetDisplays
 */
extern SDL_DECLSPEC_RETURN SDL_DisplayID SDLCALL SDL_GetPrimaryDisplay(void);
 ...
 * \sa SDL_SetProperty
 */
extern SDL_DECLSPEC_RETURN SDL_PropertiesID SDLCALL SDL_GetDisplayProperties(SDL_DisplayID displayID);
 ...
 * \sa SDL_GetDisplays
 */
extern SDL_DECLSPEC_RETURN const char *SDLCALL SDL_GetDisplayName(SDL_DisplayID displayID);
 ...
 * \sa SDL_GetDisplays
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetDisplayBounds(SDL_DisplayID displayID, SDL_Rect *rect);
 ...
 * \sa SDL_GetDisplays
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetDisplayUsableBounds(SDL_DisplayID displayID, SDL_Rect *rect);
 ...
 * \sa SDL_GetDisplays
 */
extern SDL_DECLSPEC_RETURN SDL_DisplayOrientation SDLCALL SDL_GetNaturalDisplayOrientation(SDL_DisplayID displayID);
 ...
 * \sa SDL_GetDisplays
 */
extern SDL_DECLSPEC_RETURN SDL_DisplayOrientation SDLCALL SDL_GetCurrentDisplayOrientation(SDL_DisplayID displayID);
 ...
 * \sa SDL_GetDisplays
 */
extern SDL_DECLSPEC_RETURN float SDLCALL SDL_GetDisplayContentScale(SDL_DisplayID displayID);
 ...
 * \sa SDL_GetFullscreenDisplayModes
 */
extern SDL_DECLSPEC_RETURN const SDL_DisplayMode *SDLCALL SDL_GetClosestFullscreenDisplayMode(SDL_DisplayID displayID, int w, int h, float refresh_rate, SDL_bool include_high_density_modes);
 ...
 * \sa SDL_GetDisplays
 */
extern SDL_DECLSPEC_RETURN const SDL_DisplayMode *SDLCALL SDL_GetDesktopDisplayMode(SDL_DisplayID displayID);
 ...
 * \sa SDL_GetDisplays
 */
extern SDL_DECLSPEC_RETURN const SDL_DisplayMode *SDLCALL SDL_GetCurrentDisplayMode(SDL_DisplayID displayID);
 ...
 * \sa SDL_GetDisplays
 */
extern SDL_DECLSPEC_RETURN SDL_DisplayID SDLCALL SDL_GetDisplayForPoint(const SDL_Point *point);
 ...
 * \sa SDL_GetDisplays
 */
extern SDL_DECLSPEC_RETURN SDL_DisplayID SDLCALL SDL_GetDisplayForRect(const SDL_Rect *rect);
 ...
 * \sa SDL_GetDisplays
 */
extern SDL_DECLSPEC_RETURN SDL_DisplayID SDLCALL SDL_GetDisplayForWindow(SDL_Window *window);
 ...
 */
extern SDL_DECLSPEC_RETURN float SDLCALL SDL_GetWindowPixelDensity(SDL_Window *window);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN float SDLCALL SDL_GetWindowDisplayScale(SDL_Window *window);
 ...
 * \sa SDL_SyncWindow
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetWindowFullscreenMode(SDL_Window *window, const SDL_DisplayMode *mode);
 ...
 * \sa SDL_SetWindowFullscreen
 */
extern SDL_DECLSPEC_RETURN const SDL_DisplayMode *SDLCALL SDL_GetWindowFullscreenMode(SDL_Window *window);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN Uint32 SDLCALL SDL_GetWindowPixelFormat(SDL_Window *window);
 ...
 */
extern SDL_DECLSPEC_RETURN SDL_WindowID SDLCALL SDL_GetWindowID(SDL_Window *window);
 ...
 * \sa SDL_GetWindowID
 */
extern SDL_DECLSPEC_RETURN SDL_Window *SDLCALL SDL_GetWindowFromID(SDL_WindowID id);
 ...
 * \sa SDL_CreatePopupWindow
 */
extern SDL_DECLSPEC_RETURN SDL_Window *SDLCALL SDL_GetWindowParent(SDL_Window *window);
 ...
 */
extern SDL_DECLSPEC_RETURN SDL_PropertiesID SDLCALL SDL_GetWindowProperties(SDL_Window *window);
 ...
 * \sa SDL_ShowWindow
 */
extern SDL_DECLSPEC_RETURN SDL_WindowFlags SDLCALL SDL_GetWindowFlags(SDL_Window *window);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetWindowTitle(SDL_Window *window, const char *title);
 ...
 */
extern SDL_DECLSPEC_RETURN const char *SDLCALL SDL_GetWindowTitle(SDL_Window *window);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetWindowIcon(SDL_Window *window, SDL_Surface *icon);
 ...
 * \sa SDL_SyncWindow
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetWindowPosition(SDL_Window *window, int x, int y);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetWindowPosition(SDL_Window *window, int *x, int *y);
 ...
 * \sa SDL_SyncWindow
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetWindowSize(SDL_Window *window, int w, int h);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetWindowSize(SDL_Window *window, int *w, int *h);
 ...
 * \sa SDL_GetWindowSize
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetWindowBordersSize(SDL_Window *window, int *top, int *left, int *bottom, int *right);
 ...
 * \sa SDL_GetWindowSize
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetWindowSizeInPixels(SDL_Window *window, int *w, int *h);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetWindowMinimumSize(SDL_Window *window, int min_w, int min_h);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetWindowMinimumSize(SDL_Window *window, int *w, int *h);
 ...
 * \sa SDL_SetWindowMinimumSize
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetWindowMaximumSize(SDL_Window *window, int max_w, int max_h);
 ...
 * \sa SDL_SetWindowMaximumSize
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetWindowMaximumSize(SDL_Window *window, int *w, int *h);
 ...
 * \sa SDL_GetWindowFlags
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetWindowBordered(SDL_Window *window, SDL_bool bordered);
 ...
 * \sa SDL_GetWindowFlags
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetWindowResizable(SDL_Window *window, SDL_bool resizable);
 ...
 * \sa SDL_GetWindowFlags
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetWindowAlwaysOnTop(SDL_Window *window, SDL_bool on_top);
 ...
 * \sa SDL_RaiseWindow
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_ShowWindow(SDL_Window *window);
 ...
 * \sa SDL_ShowWindow
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_HideWindow(SDL_Window *window);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_RaiseWindow(SDL_Window *window);
 ...
 * \sa SDL_SyncWindow
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_MaximizeWindow(SDL_Window *window);
 ...
 * \sa SDL_SyncWindow
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_MinimizeWindow(SDL_Window *window);
 ...
 * \sa SDL_SyncWindow
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_RestoreWindow(SDL_Window *window);
 ...
 * \sa SDL_SyncWindow
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetWindowFullscreen(SDL_Window *window, SDL_bool fullscreen);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SyncWindow(SDL_Window *window);
 ...
 */
extern SDL_DECLSPEC_RETURN SDL_bool SDLCALL SDL_WindowHasSurface(SDL_Window *window);
 ...
 */
extern SDL_DECLSPEC_RETURN SDL_Surface *SDLCALL SDL_GetWindowSurface(SDL_Window *window);
 ...
 * \sa SDL_UpdateWindowSurfaceRects
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_UpdateWindowSurface(SDL_Window *window);
 ...
 * \sa SDL_UpdateWindowSurface
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_UpdateWindowSurfaceRects(SDL_Window *window, const SDL_Rect *rects, int numrects);
 ...
 * \sa SDL_WindowHasSurface
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_DestroyWindowSurface(SDL_Window *window);
 ...
 * \sa SDL_SetWindowMouseGrab
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetWindowKeyboardGrab(SDL_Window *window, SDL_bool grabbed);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetWindowMouseGrab(SDL_Window *window, SDL_bool grabbed);
 ...
 * \sa SDL_SetWindowKeyboardGrab
 */
extern SDL_DECLSPEC_RETURN SDL_bool SDLCALL SDL_GetWindowKeyboardGrab(SDL_Window *window);
 ...
 * \sa SDL_SetWindowKeyboardGrab
 */
extern SDL_DECLSPEC_RETURN SDL_bool SDLCALL SDL_GetWindowMouseGrab(SDL_Window *window);
 ...
 * \sa SDL_SetWindowKeyboardGrab
 */
extern SDL_DECLSPEC_RETURN SDL_Window *SDLCALL SDL_GetGrabbedWindow(void);
 ...
 * \sa SDL_SetWindowMouseGrab
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetWindowMouseRect(SDL_Window *window, const SDL_Rect *rect);
 ...
 */
extern SDL_DECLSPEC_RETURN const SDL_Rect *SDLCALL SDL_GetWindowMouseRect(SDL_Window *window);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetWindowOpacity(SDL_Window *window, float opacity);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetWindowOpacity(SDL_Window *window, float *out_opacity);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetWindowModalFor(SDL_Window *modal_window, SDL_Window *parent_window);
 ...
 * \sa SDL_RaiseWindow
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetWindowInputFocus(SDL_Window *window);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetWindowFocusable(SDL_Window *window, SDL_bool focusable);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_ShowWindowSystemMenu(SDL_Window *window, int x, int y);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetWindowHitTest(SDL_Window *window, SDL_HitTest callback, void *callback_data);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetWindowShape(SDL_Window *window, SDL_Surface *shape);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_FlashWindow(SDL_Window *window, SDL_FlashOperation operation);
 ...
 * \sa SDL_CreateWindowWithProperties
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_DestroyWindow(SDL_Window *window);
 ...
 */
extern SDL_DECLSPEC_RETURN SDL_bool SDLCALL SDL_ScreenSaverEnabled(void);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_EnableScreenSaver(void);
 ...
 * \sa SDL_ScreenSaverEnabled
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_DisableScreenSaver(void);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GL_LoadLibrary(const char *path);
 ...
 * \sa SDL_GL_UnloadLibrary
 */
extern SDL_DECLSPEC_RETURN SDL_FunctionPointer SDLCALL SDL_GL_GetProcAddress(const char *proc);
 ...
 */
extern SDL_DECLSPEC_RETURN SDL_FunctionPointer SDLCALL SDL_EGL_GetProcAddress(const char *proc);
 ...
 * \sa SDL_GL_LoadLibrary
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_GL_UnloadLibrary(void);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN SDL_bool SDLCALL SDL_GL_ExtensionSupported(const char *extension);
 ...
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_GL_ResetAttributes(void);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GL_SetAttribute(SDL_GLattr attr, int value);
 ...
 * \sa SDL_GL_SetAttribute
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GL_GetAttribute(SDL_GLattr attr, int *value);
 ...
 * \sa SDL_GL_CreateContext
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GL_MakeCurrent(SDL_Window *window, SDL_GLContext context);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN SDL_Window *SDLCALL SDL_GL_GetCurrentWindow(void);
 ...
 * \sa SDL_GL_MakeCurrent
 */
extern SDL_DECLSPEC_RETURN SDL_GLContext SDLCALL SDL_GL_GetCurrentContext(void);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN SDL_EGLDisplay SDLCALL SDL_EGL_GetCurrentEGLDisplay(void);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN SDL_EGLConfig SDLCALL SDL_EGL_GetCurrentEGLConfig(void);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN SDL_EGLSurface SDLCALL SDL_EGL_GetWindowEGLSurface(SDL_Window *window);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_EGL_SetEGLAttributeCallbacks(SDL_EGLAttribArrayCallback platformAttribCallback,
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GL_SetSwapInterval(int interval);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GL_GetSwapInterval(int *interval);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GL_SwapWindow(SDL_Window *window);
 ...
 * \sa SDL_GL_CreateContext
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GL_DeleteContext(SDL_GLContext context);
