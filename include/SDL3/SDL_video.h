 ...
 */
extern SDL_DECLSPEC SDL_MenuItem * SDLCALL SDL_GetWindowMenuBar(SDL_Window *window);
 ...
 * \since This function is available since SDL 3.6.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_SetWindowMenuBar(SDL_Window *window, SDL_MenuItem *menu_bar);
 ...
 * \since This function is available since SDL 3.6.0.
 */
extern SDL_DECLSPEC SDL_MenuItem * SDLCALL SDL_CreateMenuBar();
 ...
 * \since This function is available since SDL 3.6.0.
 */
extern SDL_DECLSPEC SDL_MenuItem * SDLCALL SDL_GetMenuBarAppMenu(SDL_MenuItem *menu_bar);
 ...
 * \since This function is available since SDL 3.6.0.
 */
extern SDL_DECLSPEC SDL_MenuItem * SDLCALL SDL_CreateMenuItemAt(SDL_MenuItem *menu_as_item, size_t index, const char *label, SDL_MenuItemType type, Uint16 event_type);
 ...
 * \since This function is available since SDL 3.6.0.
 */
extern SDL_DECLSPEC SDL_MenuItem * SDLCALL SDL_CreateMenuItem(SDL_MenuItem *menu_as_item, const char *label, SDL_MenuItemType type, Uint16 event_type);
 ...
 * \since This function is available since SDL 3.6.0.
 */
extern SDL_DECLSPEC Sint64 SDLCALL SDL_GetMenuChildItems(SDL_MenuItem *menu_as_item);
 ...
 * \since This function is available since SDL 3.6.0.
 */
extern SDL_DECLSPEC SDL_MenuItem * SDLCALL SDL_GetMenuChildItem(SDL_MenuItem *menu_as_item, size_t index);
 ...
 * \since This function is available since SDL 3.6.0.
 */
extern SDL_DECLSPEC const char * SDLCALL SDL_GetMenuItemLabel(SDL_MenuItem *menu_item);
 ...
 * \since This function is available since SDL 3.6.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_SetMenuItemLabel(SDL_MenuItem *menu_item, const char *label);
 ...
 * \since This function is available since SDL 3.6.0.
 */
extern SDL_DECLSPEC SDL_MenuItemType SDLCALL SDL_GetMenuItemType(SDL_MenuItem *menu_item);
 ...
 * \since This function is available since SDL 3.6.0.
 */
extern SDL_DECLSPEC Sint32 SDLCALL SDL_GetMenuItemEventType(SDL_MenuItem *menu_item);
 ...
 * \since This function is available since SDL 3.6.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_GetMenuItemChecked(SDL_MenuItem *menu_item, bool *checked);
 ...
 * \since This function is available since SDL 3.6.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_SetMenuItemChecked(SDL_MenuItem *menu_item, bool checked);
 ...
 * \since This function is available since SDL 3.6.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_GetMenuItemEnabled(SDL_MenuItem *menu_item, bool *enabled);
 ...
 * \since This function is available since SDL 3.6.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_DestroyMenuItem(SDL_MenuItem *menu_item);
