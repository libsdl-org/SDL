 ...
 * \sa SDL_SetHint
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_SetHintWithPriority([[in]] const char *name,
                                                             [[in]] const char *value,
 ...
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_SetHint([[in]] const char *name,
                                                 [[in]] const char *value);
 ...
 * \sa SDL_ResetHints
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_ResetHint([[in]] const char *name);
 ...
 * \sa SDL_SetHintWithPriority
 */
extern SDL_DECLSPEC const char *SDLCALL SDL_GetHint([[in]] const char *name);
 ...
 * \sa SDL_SetHint
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_GetHintBoolean([[in]] const char *name, SDL_bool default_value);
 ...
 */
extern SDL_DECLSPEC int SDLCALL SDL_AddHintCallback(
    [[in]] const char *name,
    [[in]] SDL_HintCallback callback, [[inout, opt]] void *userdata);
 ...
 */
extern SDL_DECLSPEC void SDLCALL SDL_DelHintCallback(
    [[in]] const char *name,
    [[in]] SDL_HintCallback callback, [[inout, opt]] void *userdata);
