 ...
 * \sa SDL_SetHint
 */
extern SDL_DECLSPEC_RETURN SDL_bool SDLCALL SDL_SetHintWithPriority(const char *name,
                                                         const char *value,
 ...
 */
extern SDL_DECLSPEC_RETURN SDL_bool SDLCALL SDL_SetHint(const char *name,
                                             const char *value);
 ...
 * \sa SDL_ResetHints
 */
extern SDL_DECLSPEC_RETURN SDL_bool SDLCALL SDL_ResetHint(const char *name);
 ...
 * \sa SDL_ResetHint
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_ResetHints(void);
 ...
 * \sa SDL_SetHintWithPriority
 */
extern SDL_DECLSPEC_RETURN const char * SDLCALL SDL_GetHint(const char *name);
 ...
 * \sa SDL_SetHint
 */
extern SDL_DECLSPEC_RETURN SDL_bool SDLCALL SDL_GetHintBoolean(const char *name, SDL_bool default_value);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_AddHintCallback(const char *name,
 ...
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_DelHintCallback(const char *name,
                                                 SDL_HintCallback callback,
                                                 void *userdata);
