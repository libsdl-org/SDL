 ...
 * \sa SDL_UnlockMutex
 */
extern SDL_DECLSPEC_NODISCARD SDL_Mutex *SDLCALL SDL_CreateMutex(void);
 ...
 * \sa SDL_UnlockMutex
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_LockMutex(SDL_Mutex *mutex) SDL_ACQUIRE(mutex);
 ...
 * \sa SDL_UnlockMutex
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_TryLockMutex(SDL_Mutex *mutex) SDL_TRY_ACQUIRE(0, mutex);
 ...
 * \sa SDL_TryLockMutex
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_UnlockMutex(SDL_Mutex *mutex) SDL_RELEASE(mutex);
 ...
 * \sa SDL_CreateMutex
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_DestroyMutex(SDL_Mutex *mutex);
 ...
 * \sa SDL_UnlockRWLock
 */
extern SDL_DECLSPEC_NODISCARD SDL_RWLock *SDLCALL SDL_CreateRWLock(void);
 ...
 * \sa SDL_UnlockRWLock
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_LockRWLockForReading(SDL_RWLock *rwlock) SDL_ACQUIRE_SHARED(rwlock);
 ...
 * \sa SDL_UnlockRWLock
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_LockRWLockForWriting(SDL_RWLock *rwlock) SDL_ACQUIRE(rwlock);
 ...
 * \sa SDL_UnlockRWLock
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_TryLockRWLockForReading(SDL_RWLock *rwlock) SDL_TRY_ACQUIRE_SHARED(0, rwlock);
 ...
 * \sa SDL_UnlockRWLock
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_TryLockRWLockForWriting(SDL_RWLock *rwlock) SDL_TRY_ACQUIRE(0, rwlock);
 ...
 * \sa SDL_TryLockRWLockForWriting
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_UnlockRWLock(SDL_RWLock *rwlock) SDL_RELEASE_GENERIC(rwlock);
 ...
 * \sa SDL_CreateRWLock
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_DestroyRWLock(SDL_RWLock *rwlock);
 ...
 */
extern SDL_DECLSPEC_NODISCARD SDL_Semaphore *SDLCALL SDL_CreateSemaphore(Uint32 initial_value);
 ...
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_DestroySemaphore(SDL_Semaphore *sem);
 ...
 * \sa SDL_WaitSemaphoreTimeout
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_WaitSemaphore(SDL_Semaphore *sem);
 ...
 * \sa SDL_WaitSemaphoreTimeout
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_TryWaitSemaphore(SDL_Semaphore *sem);
 ...
 * \sa SDL_WaitSemaphore
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_WaitSemaphoreTimeout(SDL_Semaphore *sem, Sint32 timeoutMS);
 ...
 * \sa SDL_WaitSemaphoreTimeout
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_PostSemaphore(SDL_Semaphore *sem);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN Uint32 SDLCALL SDL_GetSemaphoreValue(SDL_Semaphore *sem);
 ...
 */
extern SDL_DECLSPEC_NODISCARD SDL_Condition *SDLCALL SDL_CreateCondition(void);
 ...
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_DestroyCondition(SDL_Condition *cond);
 ...
 * \sa SDL_WaitConditionTimeout
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SignalCondition(SDL_Condition *cond);
 ...
 * \sa SDL_WaitConditionTimeout
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_BroadcastCondition(SDL_Condition *cond);
 ...
 * \sa SDL_WaitConditionTimeout
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_WaitCondition(SDL_Condition *cond, SDL_Mutex *mutex);
 ...
 * \sa SDL_WaitCondition
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_WaitConditionTimeout(SDL_Condition *cond,
