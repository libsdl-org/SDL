...
#define SDLK_SCANCODE_MASK          (SDL_Keycode)(1u<<30)
#define SDL_SCANCODE_TO_KEYCODE(X)  (SDL_Keycode)(X | SDLK_SCANCODE_MASK)
#define SDLK_UNKNOWN                (SDL_Keycode)0
#define SDLK_RETURN                 (SDL_Keycode)'\r'
#define SDLK_ESCAPE                 (SDL_Keycode)'\x1B'
#define SDLK_BACKSPACE              (SDL_Keycode)'\b'
#define SDLK_TAB                    (SDL_Keycode)'\t'
#define SDLK_SPACE                  (SDL_Keycode)' '
#define SDLK_EXCLAIM                (SDL_Keycode)'!'
#define SDLK_DBLAPOSTROPHE          (SDL_Keycode)'"'
#define SDLK_HASH                   (SDL_Keycode)'#'
#define SDLK_PERCENT                (SDL_Keycode)'%'
#define SDLK_DOLLAR                 (SDL_Keycode)'$'
#define SDLK_AMPERSAND              (SDL_Keycode)'&'
#define SDLK_APOSTROPHE             (SDL_Keycode)'\''
#define SDLK_LEFTPAREN              (SDL_Keycode)'('
#define SDLK_RIGHTPAREN             (SDL_Keycode)')'
#define SDLK_ASTERISK               (SDL_Keycode)'*'
#define SDLK_PLUS                   (SDL_Keycode)'+'
#define SDLK_COMMA                  (SDL_Keycode)','
#define SDLK_MINUS                  (SDL_Keycode)'-'
#define SDLK_PERIOD                 (SDL_Keycode)'.'
#define SDLK_SLASH                  (SDL_Keycode)'/'
#define SDLK_0                      (SDL_Keycode)'0'
#define SDLK_1                      (SDL_Keycode)'1'
#define SDLK_2                      (SDL_Keycode)'2'
#define SDLK_3                      (SDL_Keycode)'3'
#define SDLK_4                      (SDL_Keycode)'4'
#define SDLK_5                      (SDL_Keycode)'5'
#define SDLK_6                      (SDL_Keycode)'6'
#define SDLK_7                      (SDL_Keycode)'7'
#define SDLK_8                      (SDL_Keycode)'8'
#define SDLK_9                      (SDL_Keycode)'9'
#define SDLK_COLON                  (SDL_Keycode)':'
#define SDLK_SEMICOLON              (SDL_Keycode)';'
#define SDLK_LESS                   (SDL_Keycode)'<'
#define SDLK_EQUALS                 (SDL_Keycode)'='
#define SDLK_GREATER                (SDL_Keycode)'>'
#define SDLK_QUESTION               (SDL_Keycode)'?'
#define SDLK_AT                     (SDL_Keycode)'@'
#define SDLK_LEFTBRACKET            (SDL_Keycode)'['
#define SDLK_BACKSLASH              (SDL_Keycode)'\\'
#define SDLK_RIGHTBRACKET           (SDL_Keycode)']'
#define SDLK_CARET                  (SDL_Keycode)'^'
#define SDLK_UNDERSCORE             (SDL_Keycode)'_'
#define SDLK_GRAVE                  (SDL_Keycode)'`'
#define SDLK_a                      (SDL_Keycode)'a'
#define SDLK_b                      (SDL_Keycode)'b'
#define SDLK_c                      (SDL_Keycode)'c'
#define SDLK_d                      (SDL_Keycode)'d'
#define SDLK_e                      (SDL_Keycode)'e'
#define SDLK_f                      (SDL_Keycode)'f'
#define SDLK_g                      (SDL_Keycode)'g'
#define SDLK_h                      (SDL_Keycode)'h'
#define SDLK_i                      (SDL_Keycode)'i'
#define SDLK_j                      (SDL_Keycode)'j'
#define SDLK_k                      (SDL_Keycode)'k'
#define SDLK_l                      (SDL_Keycode)'l'
#define SDLK_m                      (SDL_Keycode)'m'
#define SDLK_n                      (SDL_Keycode)'n'
#define SDLK_o                      (SDL_Keycode)'o'
#define SDLK_p                      (SDL_Keycode)'p'
#define SDLK_q                      (SDL_Keycode)'q'
#define SDLK_r                      (SDL_Keycode)'r'
#define SDLK_s                      (SDL_Keycode)'s'
#define SDLK_t                      (SDL_Keycode)'t'
#define SDLK_u                      (SDL_Keycode)'u'
#define SDLK_v                      (SDL_Keycode)'v'
#define SDLK_w                      (SDL_Keycode)'w'
#define SDLK_x                      (SDL_Keycode)'x'
#define SDLK_y                      (SDL_Keycode)'y'
#define SDLK_z                      (SDL_Keycode)'z'
...
#define SDLK_DELETE                 (SDL_Keycode)'\x7F'
