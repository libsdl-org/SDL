 ...
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_TryLockSpinlock([[self]] SDL_SpinLock *lock);
 ...
 * \sa SDL_UnlockSpinlock
 */
extern SDL_DECLSPEC void SDLCALL SDL_LockSpinlock([[self]] SDL_SpinLock *lock);
 ...
 * \sa SDL_TryLockSpinlock
 */
extern SDL_DECLSPEC void SDLCALL SDL_UnlockSpinlock([[self]] SDL_SpinLock *lock);
 ...
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_AtomicCompareAndSwap([[self]] SDL_AtomicInt *a, int oldval, int newval);
 ...
 * \sa SDL_AtomicGet
 */
extern SDL_DECLSPEC int SDLCALL SDL_AtomicSet([[self]] SDL_AtomicInt *a, int v);
 ...
 * \sa SDL_AtomicSet
 */
extern SDL_DECLSPEC int SDLCALL SDL_AtomicGet([[self]] SDL_AtomicInt *a);
 ...
 * \sa SDL_AtomicIncRef
 */
extern SDL_DECLSPEC int SDLCALL SDL_AtomicAdd([[self]] SDL_AtomicInt *a, int v);
 ...
 * \sa SDL_AtomicSetPtr
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_AtomicCompareAndSwapPointer([[self]] void **a, [[inout]] void *oldval, [[inout]] void *newval);
 ...
 * \sa SDL_AtomicGetPtr
 */
extern SDL_DECLSPEC void* SDLCALL SDL_AtomicSetPtr([[self]] void **a, [[inout]] void* v);
 ...
 * \sa SDL_AtomicSetPtr
 */
extern SDL_DECLSPEC void* SDLCALL SDL_AtomicGetPtr([[inout]] void **a);
