...
extern SDL_DECLSPEC SDL_SensorID *SDLCALL SDL_GetSensors([[out]] int *count);
 ...
 * \sa SDL_SetProperty
 */
extern SDL_DECLSPEC SDL_PropertiesID SDLCALL SDL_GetSensorProperties([[self]] SDL_Sensor *sensor);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC const char *SDLCALL SDL_GetSensorName([[self]] SDL_Sensor *sensor);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC SDL_SensorType SDLCALL SDL_GetSensorType([[self]] SDL_Sensor *sensor);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC int SDLCALL SDL_GetSensorNonPortableType([[self]] SDL_Sensor *sensor);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC SDL_SensorID SDLCALL SDL_GetSensorInstanceID([[self]] SDL_Sensor *sensor);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC int SDLCALL SDL_GetSensorData(
   [[self]] SDL_Sensor *sensor,
   [[out, array(num_values)]] float *data, int num_values);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC void SDLCALL SDL_CloseSensor([[self]] SDL_Sensor *sensor);
