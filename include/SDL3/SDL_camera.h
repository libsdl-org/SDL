 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetNumCameraDrivers(void);
 ...
 */
extern SDL_DECLSPEC_RETURN const char *SDLCALL SDL_GetCameraDriver(int index);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN const char *SDLCALL SDL_GetCurrentCameraDriver(void);
 ...
 * \sa SDL_GetCameraDevices
 */
extern SDL_DECLSPEC_RETURN SDL_CameraPosition SDLCALL SDL_GetCameraDevicePosition(SDL_CameraDeviceID instance_id);
 ...
 * \sa SDL_CloseCamera
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetCameraPermissionState(SDL_Camera *camera);
 ...
 * \sa SDL_OpenCameraDevice
 */
extern SDL_DECLSPEC_RETURN SDL_CameraDeviceID SDLCALL SDL_GetCameraInstanceID(SDL_Camera *camera);
 ...
 * \sa SDL_SetProperty
 */
extern SDL_DECLSPEC_RETURN SDL_PropertiesID SDLCALL SDL_GetCameraProperties(SDL_Camera *camera);
 ...
 * \sa SDL_OpenCameraDevice
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetCameraFormat(SDL_Camera *camera, SDL_CameraSpec *spec);
 ...
 */
extern SDL_DECLSPEC_RETURN SDL_Surface * SDLCALL SDL_AcquireCameraFrame(SDL_Camera *camera, Uint64 *timestampNS);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_ReleaseCameraFrame(SDL_Camera *camera, SDL_Surface *frame);
 ...
 * \sa SDL_OpenCamera
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_CloseCamera(SDL_Camera *camera);
