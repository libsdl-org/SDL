...
extern SDL_DECLSPEC SDL_CameraDeviceID *SDLCALL SDL_GetCameraDevices([[out]] int *count);
 ...
 * \sa SDL_GetCameraFormat
 */
[[free(SDL_CloseCamera)]]
extern SDL_DECLSPEC SDL_Camera *SDLCALL SDL_OpenCameraDevice(
    SDL_CameraDeviceID instance_id,
    [[in, opt]] const SDL_CameraSpec *spec);
 ...
 * \sa SDL_CloseCamera
 */
extern SDL_DECLSPEC int SDLCALL SDL_GetCameraPermissionState([[self]] SDL_Camera *camera);
 ...
 * \sa SDL_OpenCameraDevice
 */
extern SDL_DECLSPEC SDL_CameraDeviceID SDLCALL SDL_GetCameraInstanceID([[self]] SDL_Camera *camera);
 ...
 * \sa SDL_SetProperty
 */
extern SDL_DECLSPEC SDL_PropertiesID SDLCALL SDL_GetCameraProperties([[self]] SDL_Camera *camera);
 ...
 * \sa SDL_OpenCameraDevice
 */
extern SDL_DECLSPEC int SDLCALL SDL_GetCameraFormat(
    [[self]] SDL_Camera *camera,
    [[out]] SDL_CameraSpec *spec);
 ...
 */
[[free(SDL_ReleaseCameraFrame)]]
extern SDL_DECLSPEC SDL_Surface *SDLCALL SDL_AcquireCameraFrame(
    [[self]] SDL_Camera *camera,
 ...
 */
extern SDL_DECLSPEC int SDLCALL SDL_ReleaseCameraFrame(
    [[self]] SDL_Camera *camera, [[inout]] SDL_Surface *frame);
 ...
 * \sa SDL_OpenCamera
 */
extern SDL_DECLSPEC void SDLCALL SDL_CloseCamera([[self]] SDL_Camera *camera);
