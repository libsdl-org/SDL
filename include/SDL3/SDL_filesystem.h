 ...
 * \sa SDL_GetPrefPath
 */
extern SDL_DECLSPEC_RETURN char *SDLCALL SDL_GetBasePath(void);
 ...
 * \sa SDL_GetBasePath
 */
extern SDL_DECLSPEC_RETURN char *SDLCALL SDL_GetPrefPath(const char *org, const char *app);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_CreateDirectory(const char *path);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_EnumerateDirectory(const char *path, SDL_EnumerateDirectoryCallback callback, void *userdata);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_RemovePath(const char *path);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_RenamePath(const char *oldpath, const char *newpath);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetPathInfo(const char *path, SDL_PathInfo *info);
