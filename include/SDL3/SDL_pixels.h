 ...
 */
extern SDL_DECLSPEC_RETURN const char* SDLCALL SDL_GetPixelFormatName(SDL_PixelFormatEnum format);
 ...
 */
extern SDL_DECLSPEC_RETURN SDL_bool SDLCALL SDL_GetMasksForPixelFormatEnum(SDL_PixelFormatEnum format,
                                                            int *bpp,
                                                            Uint32 * Rmask,
                                                            Uint32 * Gmask,
                                                            Uint32 * Bmask,
 ...
 */
extern SDL_DECLSPEC_RETURN SDL_PixelFormatEnum SDLCALL SDL_GetPixelFormatEnumForMasks(int bpp,
                                                          Uint32 Rmask,
                                                          Uint32 Gmask,
                                                          Uint32 Bmask,
                                                          Uint32 Amask);
 ...
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_DestroyPixelFormat(SDL_PixelFormat *format);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetPixelFormatPalette(SDL_PixelFormat * format,
                                                      SDL_Palette *palette);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetPaletteColors(SDL_Palette * palette,
 ...
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_DestroyPalette(SDL_Palette * palette);
 ...
 * \sa SDL_MapRGBA
 */
extern SDL_DECLSPEC_RETURN Uint32 SDLCALL SDL_MapRGB(const SDL_PixelFormat * format,
 ...
 * \sa SDL_MapRGB
 */
extern SDL_DECLSPEC_RETURN Uint32 SDLCALL SDL_MapRGBA(const SDL_PixelFormat * format,
                                           Uint8 r, Uint8 g, Uint8 b,
                                           Uint8 a);
 ...
 * \sa SDL_MapRGBA
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_GetRGB(Uint32 pixel,
 ...
 * \sa SDL_MapRGBA
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_GetRGBA(Uint32 pixel,
                                         const SDL_PixelFormat * format,
                                         Uint8 * r, Uint8 * g, Uint8 * b,
                                         Uint8 * a);
