 ...
 * \sa SDL_WaitEvent
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_PumpEvents(void);
 ...
 * \sa SDL_PushEvent
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_PeepEvents(SDL_Event *events, int numevents, SDL_EventAction action, Uint32 minType, Uint32 maxType);
/* @} */
 ...
 * \sa SDL_HasEvents
 */
extern SDL_DECLSPEC_RETURN SDL_bool SDLCALL SDL_HasEvent(Uint32 type);
 ...
 * \sa SDL_HasEvents
 */
extern SDL_DECLSPEC_RETURN SDL_bool SDLCALL SDL_HasEvents(Uint32 minType, Uint32 maxType);
 ...
 * \sa SDL_FlushEvents
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_FlushEvent(Uint32 type);
 ...
 * \sa SDL_FlushEvent
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_FlushEvents(Uint32 minType, Uint32 maxType);
 ...
 */
extern SDL_DECLSPEC_RETURN SDL_bool SDLCALL SDL_PollEvent(SDL_Event *event);
 ...
 * \sa SDL_WaitEventTimeout
 */
extern SDL_DECLSPEC_RETURN SDL_bool SDLCALL SDL_WaitEvent(SDL_Event *event);
 ...
 * \sa SDL_WaitEvent
 */
extern SDL_DECLSPEC_RETURN SDL_bool SDLCALL SDL_WaitEventTimeout(SDL_Event *event, Sint32 timeoutMS);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_PushEvent(SDL_Event *event);
 ...
 * \sa SDL_PushEvent
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_SetEventFilter(SDL_EventFilter filter, void *userdata);
 ...
 * \sa SDL_SetEventFilter
 */
extern SDL_DECLSPEC_RETURN SDL_bool SDLCALL SDL_GetEventFilter(SDL_EventFilter *filter, void **userdata);
 ...
 * \sa SDL_SetEventFilter
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_AddEventWatch(SDL_EventFilter filter, void *userdata);
 ...
 * \sa SDL_AddEventWatch
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_DelEventWatch(SDL_EventFilter filter, void *userdata);
 ...
 * \sa SDL_SetEventFilter
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_FilterEvents(SDL_EventFilter filter, void *userdata);
 ...
 * \sa SDL_EventEnabled
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_SetEventEnabled(Uint32 type, SDL_bool enabled);
 ...
 * \sa SDL_SetEventEnabled
 */
extern SDL_DECLSPEC_RETURN SDL_bool SDLCALL SDL_EventEnabled(Uint32 type);
 ...
 * \sa SDL_PushEvent
 */
extern SDL_DECLSPEC_RETURN Uint32 SDLCALL SDL_RegisterEvents(int numevents);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN void * SDLCALL SDL_AllocateEventMemory(size_t size);
