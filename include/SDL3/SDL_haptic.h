 ...
 * \sa SDL_OpenHaptic
 */
extern SDL_DECLSPEC_RETURN const char *SDLCALL SDL_GetHapticInstanceName(SDL_HapticID instance_id);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN SDL_Haptic *SDLCALL SDL_GetHapticFromInstanceID(SDL_HapticID instance_id);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN SDL_HapticID SDLCALL SDL_GetHapticInstanceID(SDL_Haptic *haptic);
 ...
 */
extern SDL_DECLSPEC_RETURN const char *SDLCALL SDL_GetHapticName(SDL_Haptic *haptic);
 ...
 * \sa SDL_OpenHapticFromMouse
 */
extern SDL_DECLSPEC_RETURN SDL_bool SDLCALL SDL_IsMouseHaptic(void);
 ...
 * \sa SDL_OpenHapticFromJoystick
 */
extern SDL_DECLSPEC_RETURN SDL_bool SDLCALL SDL_IsJoystickHaptic(SDL_Joystick *joystick);
 ...
 * \sa SDL_OpenHaptic
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_CloseHaptic(SDL_Haptic *haptic);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetMaxHapticEffects(SDL_Haptic *haptic);
 ...
 * \sa SDL_GetHapticFeatures
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetMaxHapticEffectsPlaying(SDL_Haptic *haptic);
 ...
 * \sa SDL_GetMaxHapticEffects
 */
extern SDL_DECLSPEC_RETURN Uint32 SDLCALL SDL_GetHapticFeatures(SDL_Haptic *haptic);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetNumHapticAxes(SDL_Haptic *haptic);
 ...
 * \sa SDL_GetHapticFeatures
 */
extern SDL_DECLSPEC_RETURN SDL_bool SDLCALL SDL_HapticEffectSupported(SDL_Haptic *haptic, const SDL_HapticEffect *effect);
 ...
 * \sa SDL_RunHapticEffect
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_UpdateHapticEffect(SDL_Haptic *haptic, int effect, const SDL_HapticEffect *data);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_RunHapticEffect(SDL_Haptic *haptic, int effect, Uint32 iterations);
 ...
 * \sa SDL_StopHapticEffects
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_StopHapticEffect(SDL_Haptic *haptic, int effect);
 ...
 * \sa SDL_CreateHapticEffect
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_DestroyHapticEffect(SDL_Haptic *haptic, int effect);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetHapticEffectStatus(SDL_Haptic *haptic, int effect);
 ...
 * \sa SDL_GetHapticFeatures
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetHapticGain(SDL_Haptic *haptic, int gain);
 ...
 * \sa SDL_GetHapticFeatures
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetHapticAutocenter(SDL_Haptic *haptic, int autocenter);
 ...
 * \sa SDL_ResumeHaptic
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_PauseHaptic(SDL_Haptic *haptic);
 ...
 * \sa SDL_PauseHaptic
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_ResumeHaptic(SDL_Haptic *haptic);
 ...
 * \sa SDL_StopHapticEffects
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_StopHapticEffects(SDL_Haptic *haptic);
 ...
 */
extern SDL_DECLSPEC_RETURN SDL_bool SDLCALL SDL_HapticRumbleSupported(SDL_Haptic *haptic);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_InitHapticRumble(SDL_Haptic *haptic);
 ...
 * \sa SDL_StopHapticRumble
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_PlayHapticRumble(SDL_Haptic *haptic, float strength, Uint32 length);
 ...
 * \sa SDL_PlayHapticRumble
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_StopHapticRumble(SDL_Haptic *haptic);
