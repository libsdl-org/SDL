 ...
 * \sa SDL_GetMice
 */
extern SDL_DECLSPEC_RETURN SDL_bool SDLCALL SDL_HasMouse(void);
 ...
 * \sa SDL_GetMice
 */
extern SDL_DECLSPEC_RETURN const char *SDLCALL SDL_GetMouseInstanceName(SDL_MouseID instance_id);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN SDL_Window * SDLCALL SDL_GetMouseFocus(void);
 ...
 */
extern SDL_DECLSPEC_RETURN Uint32 SDLCALL SDL_GetMouseState(float *x, float *y);
 ...
 */
extern SDL_DECLSPEC_RETURN Uint32 SDLCALL SDL_GetGlobalMouseState(float *x, float *y);
 ...
 * \sa SDL_GetMouseState
 */
extern SDL_DECLSPEC_RETURN Uint32 SDLCALL SDL_GetRelativeMouseState(float *x, float *y);
 ...
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_WarpMouseInWindow(SDL_Window * window,
                                                   float x, float y);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_WarpMouseGlobal(float x, float y);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetRelativeMouseMode(SDL_bool enabled);
 ...
 * \sa SDL_GetGlobalMouseState
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_CaptureMouse(SDL_bool enabled);
 ...
 */
extern SDL_DECLSPEC_RETURN SDL_bool SDLCALL SDL_GetRelativeMouseMode(void);
 ...
 * \sa SDL_GetCursor
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetCursor(SDL_Cursor * cursor);
 ...
 * \sa SDL_SetCursor
 */
extern SDL_DECLSPEC_RETURN SDL_Cursor *SDLCALL SDL_GetCursor(void);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN SDL_Cursor *SDLCALL SDL_GetDefaultCursor(void);
 ...
 * \sa SDL_CreateSystemCursor
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_DestroyCursor(SDL_Cursor * cursor);
 ...
 * \sa SDL_HideCursor
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_ShowCursor(void);
 ...
 * \sa SDL_ShowCursor
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_HideCursor(void);
 ...
 * \sa SDL_ShowCursor
 */
extern SDL_DECLSPEC_RETURN SDL_bool SDLCALL SDL_CursorVisible(void);
