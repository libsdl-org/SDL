 ...
 *                 or -1 if no filter was chosen or if the platform does not
 *                 support detecting the selected filter.
 ...
 *                it may allow the user to ignore the filters. The pointer must
 ...
 *   selections. Ignored if the dialog is an "Open Folder" dialog.
