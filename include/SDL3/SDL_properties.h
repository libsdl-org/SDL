...
extern SDL_DECLSPEC int SDLCALL SDL_SetPropertyWithCleanup(
    ...
    [[in]] const char *name,
    [[inout, opt]] void *value,
    [[in]] SDL_CleanupPropertyCallback cleanup, [[inout, opt]] void *userdata);
 ...
 */
extern SDL_DECLSPEC int SDLCALL SDL_SetProperty(
    SDL_PropertiesID props,
    [[in]] const char *name, [[inout, opt]] void *value);
 ...
 * \param props the properties to modify.
 * \param name the name of the property to modify.
 * \param[in,opt] value the new value of the property, or NULL to delete the property.
 * \returns 0 on success or a negative error code on failure; call
 *          SDL_GetError() for more information.
 *
 * \threadsafety It is safe to call this function from any thread.
 ...
 */
extern SDL_DECLSPEC int SDLCALL SDL_SetStringProperty(
    SDL_PropertiesID props,
    [[in]] const char *name, [[in, opt]] const char *value);
 ...
 */
extern SDL_DECLSPEC int SDLCALL SDL_SetNumberProperty(
    SDL_PropertiesID props,
    [[in]] const char *name, Sint64 value);
 ...
 */
extern SDL_DECLSPEC int SDLCALL SDL_SetFloatProperty(
    SDL_PropertiesID props,
    [[in]] const char *name, float value);
 ...
 */
extern SDL_DECLSPEC int SDLCALL SDL_SetBooleanProperty(
    SDL_PropertiesID props,
    [[in]] const char *name, SDL_bool value);
 ...
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_HasProperty(SDL_PropertiesID props, [[in]] const char *name);
 ...
 * \sa SDL_HasProperty
 */
extern SDL_DECLSPEC SDL_PropertyType SDLCALL SDL_GetPropertyType(SDL_PropertiesID props, [[in]] const char *name);
 ...
 * \sa SDL_SetProperty
 */
extern SDL_DECLSPEC void *SDLCALL SDL_GetProperty(
    SDL_PropertiesID props,
    [[in]] const char *name,
    [[inout]] void *default_value);
 ...
 * \sa SDL_SetStringProperty
 */
extern SDL_DECLSPEC const char *SDLCALL SDL_GetStringProperty(
    SDL_PropertiesID props,
    [[in]] const char *name, [[in]] const char *default_value);
 ...
 * \sa SDL_SetNumberProperty
 */
extern SDL_DECLSPEC Sint64 SDLCALL SDL_GetNumberProperty(
    SDL_PropertiesID props,
    [[in]] const char *name, Sint64 default_value);
 ...
 * \sa SDL_SetFloatProperty
 */
extern SDL_DECLSPEC float SDLCALL SDL_GetFloatProperty(
    SDL_PropertiesID props,
    [[in]] const char *name, float default_value);
 ...
 * \sa SDL_SetBooleanProperty
 */
extern SDL_DECLSPEC SDL_bool SDLCALL SDL_GetBooleanProperty(
    SDL_PropertiesID props,
    [[in]] const char *name, SDL_bool default_value);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC int SDLCALL SDL_ClearProperty(SDL_PropertiesID props, [[in]] const char *name);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC int SDLCALL SDL_EnumerateProperties(
    SDL_PropertiesID props,
    [[in]] SDL_EnumeratePropertiesCallback callback, [[inout, opt]] void *userdata);
