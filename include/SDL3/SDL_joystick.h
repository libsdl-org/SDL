 ...
 * \returns 0 on success, or a negative error code if an error occurred.
 *
 * \since This function is available since SDL 3.0.0.
 */
 ...
 * \returns 0, or a negative error code if rumble isn't supported on this joystick
 *
 * \since This function is available since SDL 3.0.0.
 *
 ...
 *                     to 0xFFFF
 * \param duration_ms The duration of the rumble effect, in milliseconds
 * \returns 0, or a negative error code if trigger rumble isn't supported on this joystick
 *
 * \since This function is available since SDL 3.0.0.
 *
 ...
 * \returns 0 on success, negative error code if this joystick does not have a modifiable LED
 *
 * \since This function is available since SDL 3.0.0.
 */
 ...
 * \returns 0, or a negative error code if this joystick or driver doesn't support effect packets
 *
 * \since This function is available since SDL 3.0.0.
 */
