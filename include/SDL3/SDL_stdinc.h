...
extern DECLSPEC int SDLCALL SDL_utf16casecmp(const Uint16 *str1, const Uint16 *str2);
extern DECLSPEC int SDLCALL SDL_utf32casecmp(const Uint32 *str1, const Uint32 *str2);
