 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetNumRenderDrivers(void);
 ...
 */
extern SDL_DECLSPEC_RETURN const char *SDLCALL SDL_GetRenderDriver(int index);
 ...
 * \sa SDL_CreateWindow
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_CreateWindowAndRenderer(const char *title, int width, int height, SDL_WindowFlags window_flags, SDL_Window **window, SDL_Renderer **renderer);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN SDL_Renderer *SDLCALL SDL_GetRenderer(SDL_Window *window);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN SDL_Window *SDLCALL SDL_GetRenderWindow(SDL_Renderer *renderer);
 ...
 * \sa SDL_CreateRendererWithProperties
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetRendererInfo(SDL_Renderer *renderer, SDL_RendererInfo *info);
 ...
 * \sa SDL_SetProperty
 */
extern SDL_DECLSPEC_RETURN SDL_PropertiesID SDLCALL SDL_GetRendererProperties(SDL_Renderer *renderer);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetRenderOutputSize(SDL_Renderer *renderer, int *w, int *h);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetCurrentRenderOutputSize(SDL_Renderer *renderer, int *w, int *h);
 ...
 * \sa SDL_SetProperty
 */
extern SDL_DECLSPEC_RETURN SDL_PropertiesID SDLCALL SDL_GetTextureProperties(SDL_Texture *texture);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN SDL_Renderer *SDLCALL SDL_GetRendererFromTexture(SDL_Texture *texture);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_QueryTexture(SDL_Texture *texture, SDL_PixelFormatEnum *format, int *access, int *w, int *h);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetTextureColorMod(SDL_Texture *texture, Uint8 r, Uint8 g, Uint8 b);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetTextureColorModFloat(SDL_Texture *texture, float r, float g, float b);
 ...
 * \sa SDL_SetTextureColorMod
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetTextureColorMod(SDL_Texture *texture, Uint8 *r, Uint8 *g, Uint8 *b);
 ...
 * \sa SDL_SetTextureColorModFloat
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetTextureColorModFloat(SDL_Texture *texture, float *r, float *g, float *b);
 ...
 * \sa SDL_SetTextureColorMod
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetTextureAlphaMod(SDL_Texture *texture, Uint8 alpha);
 ...
 * \sa SDL_SetTextureColorModFloat
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetTextureAlphaModFloat(SDL_Texture *texture, float alpha);
 ...
 * \sa SDL_SetTextureAlphaMod
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetTextureAlphaMod(SDL_Texture *texture, Uint8 *alpha);
 ...
 * \sa SDL_SetTextureAlphaModFloat
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetTextureAlphaModFloat(SDL_Texture *texture, float *alpha);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetTextureBlendMode(SDL_Texture *texture, SDL_BlendMode blendMode);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetTextureBlendMode(SDL_Texture *texture, SDL_BlendMode *blendMode);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetTextureScaleMode(SDL_Texture *texture, SDL_ScaleMode scaleMode);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetTextureScaleMode(SDL_Texture *texture, SDL_ScaleMode *scaleMode);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_UpdateTexture(SDL_Texture *texture, const SDL_Rect *rect, const void *pixels, int pitch);
 ...
 * \sa SDL_UpdateTexture
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_UpdateYUVTexture(SDL_Texture *texture,
                                                 const SDL_Rect *rect,
 ...
 * \sa SDL_UpdateYUVTexture
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_UpdateNVTexture(SDL_Texture *texture,
                                                 const SDL_Rect *rect,
                                                 const Uint8 *Yplane, int Ypitch,
 ...
 * \sa SDL_UnlockTexture
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_LockTexture(SDL_Texture *texture,
                                            const SDL_Rect *rect,
 ...
 * \sa SDL_UnlockTexture
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_LockTextureToSurface(SDL_Texture *texture,
                                            const SDL_Rect *rect,
                                            SDL_Surface **surface);
 ...
 * \sa SDL_LockTexture
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_UnlockTexture(SDL_Texture *texture);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetRenderTarget(SDL_Renderer *renderer, SDL_Texture *texture);
 ...
 */
extern SDL_DECLSPEC_RETURN SDL_Texture *SDLCALL SDL_GetRenderTarget(SDL_Renderer *renderer);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetRenderLogicalPresentation(SDL_Renderer *renderer, int w, int h, SDL_RendererLogicalPresentation mode, SDL_ScaleMode scale_mode);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetRenderLogicalPresentation(SDL_Renderer *renderer, int *w, int *h, SDL_RendererLogicalPresentation *mode, SDL_ScaleMode *scale_mode);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_RenderCoordinatesFromWindow(SDL_Renderer *renderer, float window_x, float window_y, float *x, float *y);
 ...
 * \sa SDL_SetRenderScale
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_RenderCoordinatesToWindow(SDL_Renderer *renderer, float x, float y, float *window_x, float *window_y);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_ConvertEventToRenderCoordinates(SDL_Renderer *renderer, SDL_Event *event);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetRenderViewport(SDL_Renderer *renderer, const SDL_Rect *rect);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetRenderViewport(SDL_Renderer *renderer, SDL_Rect *rect);
 ...
 * \sa SDL_SetRenderViewport
 */
extern SDL_DECLSPEC_RETURN SDL_bool SDLCALL SDL_RenderViewportSet(SDL_Renderer *renderer);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetRenderClipRect(SDL_Renderer *renderer, const SDL_Rect *rect);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetRenderClipRect(SDL_Renderer *renderer, SDL_Rect *rect);
 ...
 * \sa SDL_SetRenderClipRect
 */
extern SDL_DECLSPEC_RETURN SDL_bool SDLCALL SDL_RenderClipEnabled(SDL_Renderer *renderer);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetRenderScale(SDL_Renderer *renderer, float scaleX, float scaleY);
 ...
 * \sa SDL_SetRenderScale
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetRenderScale(SDL_Renderer *renderer, float *scaleX, float *scaleY);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetRenderDrawColor(SDL_Renderer *renderer, Uint8 r, Uint8 g, Uint8 b, Uint8 a);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetRenderDrawColorFloat(SDL_Renderer *renderer, float r, float g, float b, float a);
 ...
 * \sa SDL_SetRenderDrawColor
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetRenderDrawColor(SDL_Renderer *renderer, Uint8 *r, Uint8 *g, Uint8 *b, Uint8 *a);
 ...
 * \sa SDL_GetRenderDrawColor
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetRenderDrawColorFloat(SDL_Renderer *renderer, float *r, float *g, float *b, float *a);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetRenderColorScale(SDL_Renderer *renderer, float scale);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetRenderColorScale(SDL_Renderer *renderer, float *scale);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetRenderDrawBlendMode(SDL_Renderer *renderer, SDL_BlendMode blendMode);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetRenderDrawBlendMode(SDL_Renderer *renderer, SDL_BlendMode *blendMode);
 ...
 * \sa SDL_SetRenderDrawColor
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_RenderClear(SDL_Renderer *renderer);
 ...
 * \sa SDL_RenderPoints
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_RenderPoint(SDL_Renderer *renderer, float x, float y);
 ...
 * \sa SDL_RenderPoint
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_RenderPoints(SDL_Renderer *renderer, const SDL_FPoint *points, int count);
 ...
 * \sa SDL_RenderLines
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_RenderLine(SDL_Renderer *renderer, float x1, float y1, float x2, float y2);
 ...
 * \sa SDL_RenderLine
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_RenderLines(SDL_Renderer *renderer, const SDL_FPoint *points, int count);
 ...
 * \sa SDL_RenderRects
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_RenderRect(SDL_Renderer *renderer, const SDL_FRect *rect);
 ...
 * \sa SDL_RenderRect
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_RenderRects(SDL_Renderer *renderer, const SDL_FRect *rects, int count);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_RenderFillRect(SDL_Renderer *renderer, const SDL_FRect *rect);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_RenderFillRects(SDL_Renderer *renderer, const SDL_FRect *rects, int count);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_RenderTexture(SDL_Renderer *renderer, SDL_Texture *texture, const SDL_FRect *srcrect, const SDL_FRect *dstrect);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_RenderTextureRotated(SDL_Renderer *renderer, SDL_Texture *texture,
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_RenderGeometry(SDL_Renderer *renderer,
                                               SDL_Texture *texture,
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_RenderGeometryRaw(SDL_Renderer *renderer,
                                               SDL_Texture *texture,
 ...
 * \sa SDL_RenderGeometryRaw
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_RenderGeometryRawFloat(SDL_Renderer *renderer,
                                               SDL_Texture *texture,
                                               const float *xy, int xy_stride,
 ...
 * \sa SDL_SetRenderDrawColor
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_RenderPresent(SDL_Renderer *renderer);
 ...
 * \sa SDL_CreateTextureFromSurface
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_DestroyTexture(SDL_Texture *texture);
 ...
 * \sa SDL_CreateRenderer
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_DestroyRenderer(SDL_Renderer *renderer);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_FlushRenderer(SDL_Renderer *renderer);
 ...
 */
extern SDL_DECLSPEC_RETURN void *SDLCALL SDL_GetRenderMetalLayer(SDL_Renderer *renderer);
 ...
 */
extern SDL_DECLSPEC_RETURN void *SDLCALL SDL_GetRenderMetalCommandEncoder(SDL_Renderer *renderer);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_AddVulkanRenderSemaphores(SDL_Renderer *renderer, Uint32 wait_stage_mask, Sint64 wait_semaphore, Sint64 signal_semaphore);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetRenderVSync(SDL_Renderer *renderer, int vsync);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetRenderVSync(SDL_Renderer *renderer, int *vsync);
