 ...
 *               plane
 * \returns 0 on success or a negative error code if the texture is not valid; call
 *          SDL_GetError() for more information.
 *
 * \since This function is available since SDL 3.0.0.
 *
 ...
 *                locked area
 * \returns 0 on success, or a negative error code if the texture is not valid or was not created
 ...
 * \returns 0 on success, or a negative error code if the operation is not supported
 *
 * \since This function is available since SDL 3.0.0.
 *
