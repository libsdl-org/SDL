 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetNumAudioDrivers(void);
 ...
 */
extern SDL_DECLSPEC_RETURN const char *SDLCALL SDL_GetAudioDriver(int index);
/* @} */
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN const char *SDLCALL SDL_GetCurrentAudioDriver(void);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetAudioDeviceFormat(SDL_AudioDeviceID devid, SDL_AudioSpec *spec, int *sample_frames);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_PauseAudioDevice(SDL_AudioDeviceID dev);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_ResumeAudioDevice(SDL_AudioDeviceID dev);
 ...
 * \sa SDL_ResumeAudioDevice
 */
extern SDL_DECLSPEC_RETURN SDL_bool SDLCALL SDL_AudioDevicePaused(SDL_AudioDeviceID dev);
 ...
 * \sa SDL_OpenAudioDevice
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_CloseAudioDevice(SDL_AudioDeviceID devid);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_BindAudioStreams(SDL_AudioDeviceID devid, SDL_AudioStream **streams, int num_streams);
 ...
 * \sa SDL_GetAudioStreamDevice
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_BindAudioStream(SDL_AudioDeviceID devid, SDL_AudioStream *stream);
 ...
 * \sa SDL_BindAudioStreams
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_UnbindAudioStreams(SDL_AudioStream **streams, int num_streams);
 ...
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_UnbindAudioStream(SDL_AudioStream *stream);
 ...
 * \sa SDL_BindAudioStreams
 */
extern SDL_DECLSPEC_RETURN SDL_AudioDeviceID SDLCALL SDL_GetAudioStreamDevice(SDL_AudioStream *stream);
 ...
 * \sa SDL_SetProperty
 */
extern SDL_DECLSPEC_RETURN SDL_PropertiesID SDLCALL SDL_GetAudioStreamProperties(SDL_AudioStream *stream);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetAudioStreamFormat(SDL_AudioStream *stream,
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetAudioStreamFormat(SDL_AudioStream *stream,
 ...
 * \sa SDL_SetAudioStreamFrequencyRatio
 */
extern SDL_DECLSPEC_RETURN float SDLCALL SDL_GetAudioStreamFrequencyRatio(SDL_AudioStream *stream);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetAudioStreamFrequencyRatio(SDL_AudioStream *stream, float ratio);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_PutAudioStreamData(SDL_AudioStream *stream, const void *buf, int len);
 ...
 * \sa SDL_PutAudioStreamData
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetAudioStreamData(SDL_AudioStream *stream, void *buf, int len);
 ...
 * \sa SDL_PutAudioStreamData
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetAudioStreamAvailable(SDL_AudioStream *stream);
 ...
 * \sa SDL_ClearAudioStream
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetAudioStreamQueued(SDL_AudioStream *stream);
 ...
 * \sa SDL_PutAudioStreamData
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_FlushAudioStream(SDL_AudioStream *stream);
 ...
 * \sa SDL_PutAudioStreamData
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_ClearAudioStream(SDL_AudioStream *stream);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_LockAudioStream(SDL_AudioStream *stream);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_UnlockAudioStream(SDL_AudioStream *stream);
 ...
 * \sa SDL_SetAudioStreamPutCallback
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetAudioStreamGetCallback(SDL_AudioStream *stream, SDL_AudioStreamCallback callback, void *userdata);
 ...
 * \sa SDL_SetAudioStreamGetCallback
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetAudioStreamPutCallback(SDL_AudioStream *stream, SDL_AudioStreamCallback callback, void *userdata);
 ...
 * \sa SDL_CreateAudioStream
 */
extern SDL_DECLSPEC_VOID void SDLCALL SDL_DestroyAudioStream(SDL_AudioStream *stream);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_SetAudioPostmixCallback(SDL_AudioDeviceID devid, SDL_AudioPostmixCallback callback, void *userdata);
 ...
 * \sa SDL_LoadWAV
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_LoadWAV_IO(SDL_IOStream * src, SDL_bool closeio,
 ...
 * \sa SDL_LoadWAV_IO
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_LoadWAV(const char *path, SDL_AudioSpec * spec,
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_MixAudioFormat(Uint8 * dst,
                                               const Uint8 * src,
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_ConvertAudioSamples(const SDL_AudioSpec *src_spec,
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetSilenceValueForFormat(SDL_AudioFormat format);
