 ...
 */
/* @{ */
#define SDL_AUDIO_U8        ((SDL_AudioFormat) 0x0008)  /**< Unsigned 8-bit samples */
#define SDL_AUDIO_S8        ((SDL_AudioFormat) 0x8008)  /**< Signed 8-bit samples */
#define SDL_AUDIO_S16LE     ((SDL_AudioFormat) 0x8010)  /**< Signed 16-bit samples */
#define SDL_AUDIO_S16BE     ((SDL_AudioFormat) 0x9010)  /**< As above, but big-endian byte order */
/* @} */
 ...
 */
/* @{ */
#define SDL_AUDIO_S32LE     ((SDL_AudioFormat) 0x8020)  /**< 32-bit integer samples */
#define SDL_AUDIO_S32BE     ((SDL_AudioFormat) 0x9020)  /**< As above, but big-endian byte order */
/* @} */
 ...
 */
/* @{ */
#define SDL_AUDIO_F32LE     ((SDL_AudioFormat) 0x8120)  /**< 32-bit floating point samples */
#define SDL_AUDIO_F32BE     ((SDL_AudioFormat) 0x9120)  /**< As above, but big-endian byte order */
/* @} */
