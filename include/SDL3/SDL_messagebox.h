 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_ShowMessageBox(const SDL_MessageBoxData *messageboxdata, int *buttonid);
 ...
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_ShowSimpleMessageBox(SDL_MessageBoxFlags flags, const char *title, const char *message, SDL_Window *window);
