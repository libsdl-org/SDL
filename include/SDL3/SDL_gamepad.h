 ...
 * that has adjustable brightness - `SDL_PROP_GAMEPAD_CAP_RGB_LED_BOOLEAN`:
 ...
 * player LED - `SDL_PROP_GAMEPAD_CAP_RUMBLE_BOOLEAN`: true if this gamepad
 * has left/right rumble - `SDL_PROP_GAMEPAD_CAP_TRIGGER_RUMBLE_BOOLEAN`: true
 * if this gamepad has simple trigger rumble
 *
