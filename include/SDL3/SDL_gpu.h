 ...
 *
 * - `SDL_PROP_GPU_DEVICE_CREATE_D3D12_ALLOWTIER1RESOURCEBINDING_BOOLEAN`:
 *   Allows Feature Level 11_0 with Resource Binding, normally Tier 2 is
 *   required. Only should be used when the application uses 8 or fewer storage
 *   resources across all shader stages. Defaults to false.
...
#define SDL_PROP_GPU_DEVICE_CREATE_D3D12_ALLOWTIER1RESOURCEBINDING_BOOLEAN    "SDL.gpu.device.create.d3d12.allowtier1resourcebinding"
