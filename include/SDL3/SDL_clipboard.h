 ...
 * than text. Not only can the system clipboard contain data of any type, but in
 ...
 * and offer it in .BMP, .JPG, or .PNG format for other apps to consume.
 *
 ...
 * \param mime_types a list of mime-types that are being offered. The offered mime_types are copied by SDL and not retained by SDL after this function returns.
 ...
 * \returns true if there exists data in the clipboard for the provided mime type,
