 ...
 */
extern SDL_DECLSPEC_RETURN SDL_Storage *SDLCALL SDL_OpenTitleStorage(const char *override, SDL_PropertiesID props);
 ...
 */
extern SDL_DECLSPEC_RETURN SDL_Storage *SDLCALL SDL_OpenUserStorage(const char *org, const char *app, SDL_PropertiesID props);
 ...
 * \sa SDL_WriteStorageFile
 */
extern SDL_DECLSPEC_RETURN SDL_Storage *SDLCALL SDL_OpenFileStorage(const char *path);
 ...
 * \sa SDL_WriteStorageFile
 */
extern SDL_DECLSPEC_RETURN SDL_Storage *SDLCALL SDL_OpenStorage(const SDL_StorageInterface *iface, void *userdata);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN char **SDLCALL SDL_GlobStorageDirectory(SDL_Storage *storage, const char *path, const char *pattern, SDL_GlobFlags flags, int *count);
