 ...
 */
extern SDL_DECLSPEC_NODISCARD SDL_Storage *SDLCALL SDL_OpenTitleStorage(const char *override, SDL_PropertiesID props);
 ...
 */
extern SDL_DECLSPEC_NODISCARD SDL_Storage *SDLCALL SDL_OpenUserStorage(const char *org, const char *app, SDL_PropertiesID props);
 ...
 * \sa SDL_WriteStorageFile
 */
extern SDL_DECLSPEC_NODISCARD SDL_Storage *SDLCALL SDL_OpenFileStorage(const char *path);
 ...
 * \sa SDL_WriteStorageFile
 */
extern SDL_DECLSPEC_NODISCARD SDL_Storage *SDLCALL SDL_OpenStorage(const SDL_StorageInterface *iface, void *userdata);
 ...
 * \sa SDL_OpenUserStorage
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_CloseStorage(SDL_Storage *storage);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_RETURN SDL_bool SDLCALL SDL_StorageReady(SDL_Storage *storage);
 ...
 * \sa SDL_StorageReady
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetStorageFileSize(SDL_Storage *storage, const char *path, Uint64 *length);
 ...
 * \sa SDL_WriteStorageFile
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_ReadStorageFile(SDL_Storage *storage, const char *path, void *destination, Uint64 length);
 ...
 * \sa SDL_StorageReady
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_WriteStorageFile(SDL_Storage *storage, const char *path, const void *source, Uint64 length);
 ...
 * \sa SDL_StorageReady
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_CreateStorageDirectory(SDL_Storage *storage, const char *path);
 ...
 * \sa SDL_StorageReady
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_EnumerateStorageDirectory(SDL_Storage *storage, const char *path, SDL_EnumerateDirectoryCallback callback, void *userdata);
 ...
 * \sa SDL_StorageReady
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_RemoveStoragePath(SDL_Storage *storage, const char *path);
 ...
 * \sa SDL_StorageReady
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_RenameStoragePath(SDL_Storage *storage, const char *oldpath, const char *newpath);
 ...
 * \sa SDL_StorageReady
 */
extern SDL_DECLSPEC_RETURN int SDLCALL SDL_GetStoragePathInfo(SDL_Storage *storage, const char *path, SDL_PathInfo *info);
 ...
 * \sa SDL_WriteStorageFile
 */
extern SDL_DECLSPEC_RETURN Uint64 SDLCALL SDL_GetStorageSpaceRemaining(SDL_Storage *storage);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern SDL_DECLSPEC_NODISCARD char **SDLCALL SDL_GlobStorageDirectory(SDL_Storage *storage, const char *path, const char *pattern, SDL_GlobFlags flags, int *count);
