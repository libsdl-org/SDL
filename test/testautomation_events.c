 ...
 *
 * @sa http://github.com/libsdl-org/SDL/wiki/moin.cgi/SDL_PumpEvents
 * @sa http://github.com/libsdl-org/SDL/wiki/moin.cgi/SDL_PollEvent
 */
int
 ...
 *
 * @sa http://github.com/libsdl-org/SDL/wiki/moin.cgi/SDL_AddEventWatch
 * @sa http://github.com/libsdl-org/SDL/wiki/moin.cgi/SDL_DelEventWatch
 *
 */
int
