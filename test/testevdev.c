...
typedef struct
{
    ...
    int expected;
    const char *todo;
    const char *hid_report_descriptor_file; /* basename inside test/data/, e.g. "xbox_one_elite_2_hid_report_descriptor.bin" */
...
static const GuessTest guess_tests[] =
{
    ...
    { /* Reference: https://github.com/libsdl-org/SDL/issues/7814 */
      ...
      .hid_report_descriptor_file = "xbox_one_elite_2_hid_report_descriptor.bin",
    ...
    },
    {
      ...
      .hid_report_descriptor_file = "xpadneo09_xb1s_hid_report_descriptor.bin",
    ...
    },
    {
      ...
      .hid_report_descriptor_file = "ps3_hid_report_descriptor.bin",
      .hid_report_descriptor_length = 149,
    },
    {
    ...
    },
    {
      ...
      .hid_report_descriptor_file = "steam_deck_mouse_hid_report_descriptor.bin",
    ...
    },
    {
      ...
      /* Same for Steam Deck LCD (jupiter) and OLED (galileo) */
      .hid_report_descriptor_file = "steam_deck_kb_hid_report_descriptor.bin",
    ...
    },
    {
      ...
      .hid_report_descriptor_file = "steam_deck_lcd_js_hid_report_descriptor.bin",
    ...
    },
    {
      ...
      .expected = SDL_UDEV_DEVICE_JOYSTICK,
      .hid_report_descriptor_file = "steam_deck_oled_js_hid_report_descriptor.bin",
    ...
    },
    {
      ...
      .hid_report_descriptor_file = "thinkpad_usb_keyboard_hid_report_descriptor.bin",
      .hid_report_descriptor_length = 65,
    },
    {
      ...
      .hid_report_descriptor_file = "thinkpad_usb_trackpoint_hid_report_descriptor.bin",
    ...
    { /* https://github.com/ValveSoftware/Proton/issues/5126 */
      ...
      .abs = { 0x07 },
      /* Generic Desktop / Joystick */
      .hid_report_descriptor_file = "vrs_pedals_hid_report_descriptor.bin",
    ...
    { /* https://github.com/ValveSoftware/Proton/issues/5126 */
      ...
      .abs = { 0x38 },
      /* Generic Desktop / Joystick */
      .hid_report_descriptor_file = "heusinkveld_pedals_hid_report_descriptor.bin",
    ...
    { /* https://github.com/ValveSoftware/Proton/issues/5126 */
      ...
      .abs = { 0x01 },
      /* Generic Desktop / Joystick */
      .hid_report_descriptor_file = "fanatec_handbrake_hid_report_descriptor.bin",
      .hid_report_descriptor_length = 38,
    },
