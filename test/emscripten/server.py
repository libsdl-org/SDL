...
class MyHTTPRequestHandler(SimpleHTTPRequestHandler):
    ...
    def translate_path(self, path):
        for map_prefix, map_path in self.maps:
...
def main():
    ...
    parser.add_argument("--map", dest="maps", nargs="+", type=str, help="Mappings, used as e.g. \"/sdl:$HOME/projects/SDL\"")
