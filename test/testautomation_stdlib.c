...
#define STRTOX_TEST_CASE(func_name, type, format_spec, str, base, expected_result, expected_endp_offset) do {                    \
    ...
    if (sizeof(long long) == 8) {
        ...
        STRTOX_TEST_CASE(SDL_strtoull, unsigned long long, FMT_PRILLu, "18446744073709551615", 10, 18446744073709551615ULL, 20);
        STRTOX_TEST_CASE(SDL_strtoull, unsigned long long, FMT_PRILLu, "18446744073709551616", 10, 18446744073709551615ULL, 20);
        STRTOX_TEST_CASE(SDL_strtoull, unsigned long long, FMT_PRILLu, "-18446744073709551615", 10, 1, 21);
    }
