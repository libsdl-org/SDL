...
typedef struct SDL_CommonEvent_pack8 {
    Uint32 type;        
    Uint32 reserved;
    Uint64 timestamp;   
} SDL_CommonEvent_pack8;

typedef struct SDL_DisplayEvent_pack8 {
    SDL_EventType type; 
    Uint32 reserved;
    Uint64 timestamp;   
...
typedef struct SDL_TextEditingEvent_pack8 {
    SDL_EventType type;         
    Uint32 reserved;
    Uint64 timestamp;           
    SDL_WindowID windowID;      
    ...
    Sint32 start;               
    Sint32 length;              
} SDL_TextEditingEvent_pack8;

typedef struct SDL_TextEditingCandidatesEvent_pack8 {
    SDL_EventType type;         
    Uint32 reserved;
    Uint64 timestamp;           
    SDL_WindowID windowID;      
...
typedef struct SDL_MouseDeviceEvent_pack8 {
    SDL_EventType type; 
    Uint32 reserved;
    Uint64 timestamp;   
    SDL_MouseID which;  
...
typedef struct SDL_GamepadTouchpadEvent_pack8 {
    ...
    float y;            
    float pressure;     
} SDL_GamepadTouchpadEvent_pack8;

typedef struct SDL_GamepadSensorEvent_pack8 {
    SDL_EventType type; 
    Uint32 reserved;
    Uint64 timestamp;   
    SDL_JoystickID which; 
...
typedef struct SDL_AudioDeviceEvent_pack8 {
    SDL_EventType type; 
    Uint32 reserved;
    Uint64 timestamp;   
...
typedef struct SDL_TouchFingerEvent_pack8 {
    ...
    float pressure;     
    SDL_WindowID windowID; 
} SDL_TouchFingerEvent_pack8;

typedef struct SDL_PenProximityEvent_pack8 {
    SDL_EventType type; 
    Uint32 reserved;
    Uint64 timestamp;   
    SDL_WindowID windowID; 
    SDL_PenID which;        
} SDL_PenProximityEvent_pack8;

typedef struct SDL_PenMotionEvent_pack8 {
    SDL_EventType type; 
    Uint32 reserved;
    Uint64 timestamp;   
    SDL_WindowID windowID; 
...
typedef struct SDL_ClipboardEvent_pack8 {
    SDL_EventType type; 
    Uint32 reserved;
    Uint64 timestamp;   
} SDL_ClipboardEvent_pack8;

typedef struct SDL_SensorEvent_pack8 {
    SDL_EventType type; 
    Uint32 reserved;
    Uint64 timestamp;   
    SDL_SensorID which; 
...
typedef struct SDL_QuitEvent_pack8 {
    SDL_EventType type; 
    Uint32 reserved;
    Uint64 timestamp;   
} SDL_QuitEvent_pack8;

typedef struct SDL_UserEvent_pack8 {
    Uint32 type;        
    Uint32 reserved;
    Uint64 timestamp;   
    SDL_WindowID windowID; 
...
typedef struct SDL_CameraSpec_pack8 {
...
} SDL_StorageInterface_pack8;

typedef struct SDL_DateTime_pack8 {
    int year;                  
    int month;                 
    int day;                   
    int hour;                  
...
typedef struct SDL_Finger_pack8 {
    SDL_FingerID id;  
    float x;  
    float y;  
    float pressure; 
...
} SDL_GamepadBinding_pack8;

typedef struct SDL_Locale_pack8 {
    const char *language;  
    const char *country;  
} SDL_Locale_pack8;

typedef struct SDL_AudioSpec_pack8 {
    SDL_AudioFormat format;     
    int channels;               
    int freq;                   
} SDL_AudioSpec_pack8;

typedef struct SDL_DialogFileFilter_pack8 {
    const char *name;
    const char *pattern;
} SDL_DialogFileFilter_pack8;

typedef struct SDL_IOStreamInterface_pack8 {
    /**
...
typedef struct SDL_GPUViewport_pack8 {
    ...
    float minDepth;
    float maxDepth;
} SDL_GPUViewport_pack8;

typedef struct SDL_GPUTextureTransferInfo_pack8 {
...
typedef struct SDL_GPUTextureRegion_pack8 {
    ...
    Uint32 h;
    Uint32 d;
} SDL_GPUTextureRegion_pack8;

typedef struct SDL_GPUBlitRegion_pack8 {
    SDL_GPUTexture *texture;
    Uint32 mipLevel;
...
typedef struct SDL_GPUBufferRegion_pack8 {
    ...
    Uint32 offset;
    Uint32 size;
} SDL_GPUBufferRegion_pack8;

typedef struct SDL_GPUIndirectDrawCommand_pack8 {
    Uint32 vertexCount;   
    Uint32 instanceCount; 
    Uint32 firstVertex;   
    Uint32 firstInstance; 
} SDL_GPUIndirectDrawCommand_pack8;

typedef struct SDL_GPUIndexedIndirectDrawCommand_pack8 {
    Uint32 indexCount;    
    Uint32 instanceCount; 
    Uint32 firstIndex;    
    Sint32 vertexOffset;  
    Uint32 firstInstance; 
} SDL_GPUIndexedIndirectDrawCommand_pack8;

typedef struct SDL_GPUIndirectDispatchCommand_pack8 {
    Uint32 groupCountX;
    Uint32 groupCountY;
    Uint32 groupCountZ;
} SDL_GPUIndirectDispatchCommand_pack8;

typedef struct SDL_GPUSamplerCreateInfo_pack8 {
...
} SDL_GPUSamplerCreateInfo_pack8;

typedef struct SDL_GPUVertexBinding_pack8 {
    Uint32 binding;
    Uint32 stride;
    SDL_GPUVertexInputRate inputRate;
    Uint32 instanceStepRate; 
} SDL_GPUVertexBinding_pack8;

typedef struct SDL_GPUVertexAttribute_pack8 {
    Uint32 location;
    Uint32 binding;
    SDL_GPUVertexElementFormat format;
    Uint32 offset;
} SDL_GPUVertexAttribute_pack8;
...
typedef struct SDL_GPUTextureCreateInfo_pack8 {
    ...
    SDL_PropertiesID props;
} SDL_GPUTextureCreateInfo_pack8;

typedef struct SDL_GPUBufferCreateInfo_pack8 {
    SDL_GPUBufferUsageFlags usageFlags;
    Uint32 sizeInBytes;

    SDL_PropertiesID props;
} SDL_GPUBufferCreateInfo_pack8;

typedef struct SDL_GPUTransferBufferCreateInfo_pack8 {
    SDL_GPUTransferBufferUsage usage;
    Uint32 sizeInBytes;

    SDL_PropertiesID props;
} SDL_GPUTransferBufferCreateInfo_pack8;

typedef struct SDL_GPURasterizerState_pack8 {
...
} SDL_GPURasterizerState_pack8;

typedef struct SDL_GPUMultisampleState_pack8 {
    SDL_GPUSampleCount sampleCount;
    Uint32 sampleMask;
} SDL_GPUMultisampleState_pack8;

typedef struct SDL_GPUDepthStencilState_pack8 {
...
} SDL_GPUColorAttachmentDescription_pack8;

typedef struct SDL_GPUGraphicsPipelineAttachmentInfo_pack8 {
...
typedef struct SDL_GPUComputePipelineCreateInfo_pack8 {
    ...
    SDL_PropertiesID props;
} SDL_GPUComputePipelineCreateInfo_pack8;

typedef struct SDL_GPUColorAttachmentInfo_pack8 {
...
} SDL_GPUTextureSamplerBinding_pack8;

typedef struct SDL_GPUStorageBufferWriteOnlyBinding_pack8 {
    SDL_GPUBuffer *buffer;
...
typedef struct SDL_Vertex_pack8 {
    SDL_FPoint position;        
    SDL_FColor color;           
    SDL_FPoint tex_coord;       
} SDL_Vertex_pack8;

typedef struct SDL_DisplayMode_pack8 {
    SDL_DisplayID displayID;        
    SDL_PixelFormat format;         
    int w;                          
    int h;                          
...
} SDL_hid_device_info_pack8;

typedef struct SDL_Point_pack8 {
    int x;
    int y;
} SDL_Point_pack8;

typedef struct SDL_FPoint_pack8 {
    float x;
    float y;
} SDL_FPoint_pack8;

typedef struct SDL_Rect_pack8 {
    int x, y;
    int w, h;
} SDL_Rect_pack8;

typedef struct SDL_FRect_pack8 {
    float x;
    float y;
    float w;
    float h;
...
typedef struct SDL_VirtualJoystickTouchpadDesc_pack8 {
    Uint16 nfingers;    
    Uint16 padding[3];
} SDL_VirtualJoystickTouchpadDesc_pack8;

typedef struct SDL_VirtualJoystickSensorDesc_pack8 {
    SDL_SensorType type;    
    float rate;             
} SDL_VirtualJoystickSensorDesc_pack8;

typedef struct SDL_VirtualJoystickDesc_pack8 {
    Uint16 type;        
    Uint16 padding;     
    Uint16 vendor_id;   
    Uint16 product_id;  
...
typedef struct SDL_MessageBoxButtonData_pack8 {
    SDL_MessageBoxButtonFlags flags;
    int buttonID;       
    const char *text;   
} SDL_MessageBoxButtonData_pack8;

typedef struct SDL_MessageBoxColor_pack8 {
    Uint8 r, g, b;
} SDL_MessageBoxColor_pack8;

typedef struct SDL_MessageBoxColorScheme_pack8 {
...
typedef struct SDL_FColor_pack8 {
    float r;
    float g;
    float b;
    float a;
