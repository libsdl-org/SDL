...
static int SDLCALL joystick_testGamepadMappingForCraftedGUID(void *arg)
{
    static const struct {
        ...
        { "SInput sony face style", 0x03, USB_VENDOR_RASPBERRYPI_TEST, USB_PRODUCT_HANDHELDLEGEND_SINPUT_GENERIC_TEST, SINPUT_TEST_VERSION, 'h', 4 << 5, SDL_GAMEPAD_TYPE_PS3, 0, SDL_GAMEPAD_BUTTON_LABEL_CROSS },
        { "SInput sony face style", 0x03, USB_VENDOR_RASPBERRYPI_TEST, USB_PRODUCT_HANDHELDLEGEND_SINPUT_GENERIC_TEST, SINPUT_TEST_VERSION, 'h', 4 << 5, SDL_GAMEPAD_TYPE_PS3, 1, SDL_GAMEPAD_BUTTON_LABEL_CIRCLE },
        { "SInput sony face style", 0x03, USB_VENDOR_RASPBERRYPI_TEST, USB_PRODUCT_HANDHELDLEGEND_SINPUT_GENERIC_TEST, SINPUT_TEST_VERSION, 'h', 4 << 5, SDL_GAMEPAD_TYPE_PS3, 2, SDL_GAMEPAD_BUTTON_LABEL_SQUARE },
        { "SInput sony face style", 0x03, USB_VENDOR_RASPBERRYPI_TEST, USB_PRODUCT_HANDHELDLEGEND_SINPUT_GENERIC_TEST, SINPUT_TEST_VERSION, 'h', 4 << 5, SDL_GAMEPAD_TYPE_PS3, 3, SDL_GAMEPAD_BUTTON_LABEL_TRIANGLE },
