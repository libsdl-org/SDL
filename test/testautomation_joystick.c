...
static int TestVirtualJoystick(void *arg)
{
    ...
    if (device_id > 0) {
        ...
        if (joystick) {
            ...
            gamepad = SDL_OpenGamepad(SDL_GetJoystickDeviceID(joystick));
            ...
            if (gamepad) {
                ...
                SDL_SetGamepadMapping(SDL_GetJoystickDeviceID(joystick), "ff0013db5669727475616c2043007601,Virtual PS4 Gamepad,type:ps4,a:b0,b:b1,x:b2,y:b3,back:b4,guide:b5,start:b6,leftstick:b7,rightstick:b8,leftshoulder:b9,rightshoulder:b10,dpup:b11,dpdown:b12,dpleft:b13,dpright:b14,misc1:b15,paddle1:b16,paddle2:b17,paddle3:b18,paddle4:b19,leftx:a0,lefty:a1,rightx:a2,righty:a3,lefttrigger:a4,righttrigger:a5,");
