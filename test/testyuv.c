...
{
    SDL_Surface *pattern = SDL_CreateRGBSurface(pattern_size, pattern_size, SDL_PIXELFORMAT_RGB24);
...
main(int argc, char **argv)
{
    ...
    converted = SDL_CreateRGBSurface(original->w, original->h, rgb_format);
    if (converted == NULL) {
