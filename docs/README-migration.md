...
SDL_VideoInit() and SDL_VideoQuit() have been removed. Instead you can call SDL_InitSubSytem() and SDL_QuitSubSytem() with SDL_VIDEO_AUDIO, which will properly refcount the subsystems.
  Also the hint SDL_VIDEO_DRIVER can help to choose a specific driver.
