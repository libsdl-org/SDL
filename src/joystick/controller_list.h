...
static const ControllerDescription_t arrControllers[] = {
	...
	{ MAKE_CONTROLLER_ID( 0x054c, 0x042f ), k_eControllerType_PS3Controller, NULL },	// Sony PSMove Navigation Controller
...
//	{ MAKE_CONTROLLER_ID( 0x7545, 0x1122 ), k_eControllerType_PS4Controller, NULL },	// Giotek VX4 - trackpad/gyro don't work. Had to not filter on interface info. Light bar is flaky, but works.
    ...
    { MAKE_CONTROLLER_ID( 0x054c, 0x03d5 ), k_eControllerType_PSMoveController, NULL },	// Sony PSMove
	{ MAKE_CONTROLLER_ID( 0x054c, 0x0c5e ), k_eControllerType_PSMoveController, NULL },	// Sony PSMove v2
