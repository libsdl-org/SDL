...
#define USB_PRODUCT_8BITDO_ULTIMATE2C_WIRELESS            0x301C
#define USB_PRODUCT_8BITDO_ULTIMATE2C_WIRELESS_BT         0x301B
...
#define USB_PRODUCT_XBOX360_BIGBUTTON_RECEIVER            0x02a0
