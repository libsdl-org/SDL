...
/* WinRT headers contain only declarations, and we have to define these GUIDs ourselves.
 * https://stackoverflow.com/a/55605485/1795050
 */
static const IID IID___FIEventHandler_1_Windows__CGaming__CInput__CRawGameController = { 0x00621c22, 0x42e8, 0x529f, { 0x92, 0x70, 0x83, 0x6b, 0x32, 0x93, 0x1d, 0x72 } };
static const IID IID___x_ABI_CWindows_CGaming_CInput_CIArcadeStickStatics = { 0x5C37B8C8, 0x37B1, 0x4AD8, { 0x94, 0x58, 0x20, 0x0F, 0x1A, 0x30, 0x01, 0x8E } };
static const IID IID___x_ABI_CWindows_CGaming_CInput_CIArcadeStickStatics2 = { 0x52B5D744, 0xBB86, 0x445A, { 0xB5, 0x9C, 0x59, 0x6F, 0x0E, 0x2A, 0x49, 0xDF } };
static const IID IID___x_ABI_CWindows_CGaming_CInput_CIFlightStickStatics = { 0x5514924A, 0xFECC, 0x435E, { 0x83, 0xDC, 0x5C, 0xEC, 0x8A, 0x18, 0xA5, 0x20 } };
static const IID IID___x_ABI_CWindows_CGaming_CInput_CIGameController = { 0x1BAF6522, 0x5F64, 0x42C5, { 0x82, 0x67, 0xB9, 0xFE, 0x22, 0x15, 0xBF, 0xBD } };
static const IID IID___x_ABI_CWindows_CGaming_CInput_CIGameControllerBatteryInfo = { 0xDCECC681, 0x3963, 0x4DA6, { 0x95, 0x5D, 0x55, 0x3F, 0x3B, 0x6F, 0x61, 0x61 } };
static const IID IID___x_ABI_CWindows_CGaming_CInput_CIGamepadStatics = { 0x8BBCE529, 0xD49C, 0x39E9, { 0x95, 0x60, 0xE4, 0x7D, 0xDE, 0x96, 0xB7, 0xC8 } };
static const IID IID___x_ABI_CWindows_CGaming_CInput_CIGamepadStatics2 = { 0x42676DC5, 0x0856, 0x47C4, { 0x92, 0x13, 0xB3, 0x95, 0x50, 0x4C, 0x3A, 0x3C } };
static const IID IID___x_ABI_CWindows_CGaming_CInput_CIRacingWheelStatics = { 0x3AC12CD5, 0x581B, 0x4936, { 0x9F, 0x94, 0x69, 0xF1, 0xE6, 0x51, 0x4C, 0x7D } };
static const IID IID___x_ABI_CWindows_CGaming_CInput_CIRacingWheelStatics2 = { 0xE666BCAA, 0xEDFD, 0x4323, { 0xA9, 0xF6, 0x3C, 0x38, 0x40, 0x48, 0xD1, 0xED } };
static const IID IID___x_ABI_CWindows_CGaming_CInput_CIRawGameController = { 0x7CAD6D91, 0xA7E1, 0x4F71, { 0x9A, 0x78, 0x33, 0xE9, 0xC5, 0xDF, 0xEA, 0x62 } };
static const IID IID___x_ABI_CWindows_CGaming_CInput_CIRawGameController2 = { 0x43C0C035, 0xBB73, 0x4756, { 0xA7, 0x87, 0x3E, 0xD6, 0xBE, 0xA6, 0x17, 0xBD } };
static const IID IID___x_ABI_CWindows_CGaming_CInput_CIRawGameControllerStatics = { 0xEB8D0792, 0xE95A, 0x4B19, { 0xAF, 0xC7, 0x0A, 0x59, 0xF8, 0xBF, 0x75, 0x9E } };
...
static void WGI_LoadRawGameControllerStatics()
{
    ...
    if (SUCCEEDED(hr)) {
        ...
        if (!SUCCEEDED(hr)) {
            SDL_SetError("Couldn't find Windows.Gaming.Input.IRawGameControllerStatics: 0x%lx", hr);
        }
    }
}
...
static void WGI_LoadOtherControllerStatics()
{
    ...
    if (!wgi.arcade_stick_statics) {
        ...
        if (SUCCEEDED(hr)) {
            ...
            if (SUCCEEDED(hr)) {
                ...
                SDL_SetError("Couldn't find Windows.Gaming.Input.IArcadeStickStatics: 0x%lx", hr);
            }
        }
    }
    ...
    if (!wgi.flight_stick_statics) {
        ...
        if (SUCCEEDED(hr)) {
            ...
            if (!SUCCEEDED(hr)) {
                SDL_SetError("Couldn't find Windows.Gaming.Input.IFlightStickStatics: 0x%lx", hr);
            }
        }
    }
    ...
    if (!wgi.gamepad_statics) {
        ...
        if (SUCCEEDED(hr)) {
            ...
            if (SUCCEEDED(hr)) {
                ...
                SDL_SetError("Couldn't find Windows.Gaming.Input.IGamepadStatics: 0x%lx", hr);
            }
        }
    }
    ...
    if (!wgi.racing_wheel_statics) {
        ...
        if (SUCCEEDED(hr)) {
            ...
            if (SUCCEEDED(hr)) {
                ...
                SDL_SetError("Couldn't find Windows_CGaming_CInput_CIRacingWheelStatics: 0x%lx", hr);
            }
        }
    }
}
...
static int WGI_JoystickInit(void)
{
...
#else
    wgi.CoIncrementMTAUsage = (CoIncrementMTAUsage_t)WIN_LoadComBaseFunction("CoIncrementMTAUsage");
    wgi.RoGetActivationFactory = (RoGetActivationFactory_t)WIN_LoadComBaseFunction("RoGetActivationFactory");
    wgi.WindowsCreateStringReference = (WindowsCreateStringReference_t)WIN_LoadComBaseFunction("WindowsCreateStringReference");
    wgi.WindowsDeleteString = (WindowsDeleteString_t)WIN_LoadComBaseFunction("WindowsDeleteString");
    wgi.WindowsGetStringRawBuffer = (WindowsGetStringRawBuffer_t)WIN_LoadComBaseFunction("WindowsGetStringRawBuffer");
#endif /* __WINRT__ */
...
#ifndef __WINRT__
    {
        ...
        if (!cookie) {
            if (FAILED(wgi.CoIncrementMTAUsage(&cookie))) {
