...
int SDL_DBus_StartLocation(void)
{
    ...
    /* Call Location.CreateSession() */
    {
        ...
        if (SDL_DBus_CallWithBasicReply(dbus.session_conn, NULL, msg, DBUS_TYPE_OBJECT_PATH, &session_path)) {
    ...
    /* Call Location.Start() */
    {
        ...
        if (SDL_DBus_CallWithBasicReply(dbus.session_conn, NULL, msg, DBUS_TYPE_OBJECT_PATH, &request_path)) {
