...
#pragma clang diagnostic pop
        case UIInterfaceOrientationPortrait:
            hidden.last_device_orientation = UIDeviceOrientationPortrait;
            break;
        case UIInterfaceOrientationPortraitUpsideDown:
            hidden.last_device_orientation = UIDeviceOrientationPortraitUpsideDown;
            break;
        case UIInterfaceOrientationLandscapeLeft:
            hidden.last_device_orientation = UIDeviceOrientationLandscapeRight;
            break; // Apple docs say UI and device orientations are reversed in landscape.
        case UIInterfaceOrientationLandscapeRight:
            hidden.last_device_orientation = UIDeviceOrientationLandscapeLeft;
            break;
        default:
            hidden.last_device_orientation = UIDeviceOrientationPortrait;
            break; // oh well.
