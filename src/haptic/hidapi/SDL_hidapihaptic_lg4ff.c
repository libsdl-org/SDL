...
#define sin_deg(in) (double)(SDL_sin((double)(in) * (double)M_PI / 180.0))
...
static SDL_INLINE SDL_bool effect_is_periodic(SDL_HapticEffect *effect)
{
...
static SDL_INLINE SDL_bool effect_is_condition(SDL_HapticEffect *effect)
{
