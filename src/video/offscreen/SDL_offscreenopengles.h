...
extern int OFFSCREEN_GLES_LoadLibrary(THIS, const char *path);
extern SDL_GLContext OFFSCREEN_GLES_CreateContext(THIS, SDL_Window *window);
extern int OFFSCREEN_GLES_MakeCurrent(THIS, SDL_Window *window, SDL_GLContext context);
extern int OFFSCREEN_GLES_SwapWindow(THIS, SDL_Window *window);
