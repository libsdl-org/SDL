...
int VITA_CreateWindowFramebuffer(THIS, SDL_Window *window, Uint32 *format, void **pixels, int *pitch)
{
...
int VITA_UpdateWindowFramebuffer(THIS, SDL_Window *window, const SDL_Rect *rects, int numrects)
{
    // do nothing
    return 0;
}

void VITA_DestroyWindowFramebuffer(THIS, SDL_Window *window)
{
    SDL_WindowData *data = (SDL_WindowData *)window->driverdata;
