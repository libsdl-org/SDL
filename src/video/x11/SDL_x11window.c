...
X11_GetWindowICCProfile(_THIS, SDL_Window * window, size_t * size)
{
    ...
    char* icc_atom_string = "_ICC_PROFILE";
    void* ret_icc_profile_data = SDL_calloc(1, 1024 * 1024 * 4);
