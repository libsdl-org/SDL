...
extern int X11_GLES_LoadLibrary(THIS, const char *path);
extern XVisualInfo *X11_GLES_GetVisual(THIS, Display *display, int screen);
extern SDL_GLContext X11_GLES_CreateContext(THIS, SDL_Window *window);
extern int X11_GLES_SwapWindow(THIS, SDL_Window *window);
extern int X11_GLES_MakeCurrent(THIS, SDL_Window *window, SDL_GLContext context);
extern SDL_EGLSurface X11_GLES_GetEGLSurface(THIS, SDL_Window *window);
