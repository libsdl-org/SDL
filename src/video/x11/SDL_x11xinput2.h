...
extern void X11_InitXinput2(THIS);
extern void X11_InitXinput2Multitouch(THIS);
...
extern void X11_Xinput2SelectTouch(THIS, SDL_Window *window);
extern void X11_Xinput2GrabTouch(THIS, SDL_Window *window);
extern void X11_Xinput2UngrabTouch(THIS, SDL_Window *window);
