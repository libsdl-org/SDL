...
int SDL_DUMMY_CreateWindowFramebuffer(THIS, SDL_Window *window, Uint32 *format, void **pixels, int *pitch)
{
    SDL_Surface *surface;
...
int SDL_DUMMY_UpdateWindowFramebuffer(THIS, SDL_Window *window, const SDL_Rect *rects, int numrects)
{
...
void SDL_DUMMY_DestroyWindowFramebuffer(THIS, SDL_Window *window)
{
    SDL_Surface *surface;
