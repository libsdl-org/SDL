...
int Android_CreateWindow(THIS, SDL_Window *window)
{
    SDL_WindowData *data;
    int retval = 0;
...
void Android_SetWindowTitle(THIS, SDL_Window *window)
{
    Android_JNI_SetActivityTitle(window->title);
}

void Android_SetWindowFullscreen(THIS, SDL_Window *window, SDL_VideoDisplay *display, SDL_bool fullscreen)
{
...
void Android_MinimizeWindow(THIS, SDL_Window *window)
{
    Android_JNI_MinizeWindow();
}

void Android_SetWindowResizable(THIS, SDL_Window *window, SDL_bool resizable)
{
    /* Set orientation */
    Android_JNI_SetOrientation(window->w, window->h, window->flags & SDL_WINDOW_RESIZABLE, SDL_GetHint(SDL_HINT_ORIENTATIONS));
}

void Android_DestroyWindow(THIS, SDL_Window *window)
{
    SDL_LockMutex(Android_ActivityMutex);
...
int Android_GetWindowWMInfo(THIS, SDL_Window *window, SDL_SysWMinfo *info)
{
    SDL_WindowData *data = (SDL_WindowData *)window->driverdata;
