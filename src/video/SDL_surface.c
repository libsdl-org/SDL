...
int SDL_BlitSurfaceScaledLinear(SDL_Surface *src, const SDL_Rect *srcrect,
                        SDL_Surface *dst, SDL_Rect *dstrect)
{
    return SDL_PrivateBlitSurfaceScaled(src, srcrect, dst, dstrect, SDL_SCALEMODE_LINEAR);
}
 ...
 *  scaled blitting only.
 */
int SDL_BlitSurfaceUncheckedScaledLinear(SDL_Surface *src, const SDL_Rect *srcrect,
                                   SDL_Surface *dst, const SDL_Rect *dstrect)
{
    return SDL_PrivateBlitSurfaceUncheckedScaled(src, srcrect, dst, dstrect, SDL_SCALEMODE_LINEAR);
}
    ...
    if (scaleMode == SDL_SCALEMODE_NEAREST) {
        ...
        if (!(src->map->info.flags & complex_copy_flags) &&
            ...
            if (is_complex_copy_flags || src->format->format != dst->format->format) {
                ...
                SDL_UpperSoftStretch(src, &srcrect2, tmp2, NULL, SDL_SCALEMODE_LINEAR);
                ...
                ret = SDL_UpperSoftStretch(src, &srcrect2, dst, dstrect, SDL_SCALEMODE_LINEAR);
            }
