...
{
    SDL_BlitSurface9GridComplex(src, srcrect, corner_size, corner_size, corner_size, corner_size, scale, scaleMode, dst, dstrect);
}

int SDL_BlitSurface9GridComplex(SDL_Surface *src, const SDL_Rect *srcrect, int left_width, int right_width, int top_height, int bottom_height, float scale, SDL_ScaleMode scaleMode, SDL_Surface *dst, const SDL_Rect *dstrect)
{
