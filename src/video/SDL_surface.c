 ...
 */
SDL_bool SDL_BlitSurfaceUnchecked(SDL_Surface *src, const SDL_Rect *srcrect,
...
SDL_bool SDL_ConvertPixelsAndColorspace(int width, int height,
...
SDL_bool SDL_PremultiplyAlpha(int width, int height,
