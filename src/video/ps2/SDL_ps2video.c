...
static int PS2_SetDisplayMode(THIS, SDL_VideoDisplay *display, SDL_DisplayMode *mode)
{
    return 0;
}
...
static int PS2_CreateWindow(THIS, SDL_Window *window)
{
...
static void PS2_VideoQuit(THIS)
{
}

static void PS2_PumpEvents(THIS)
{
    /* do nothing. */
}
