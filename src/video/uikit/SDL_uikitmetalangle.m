...
@property (nonatomic, strong) SDL_uikitmetalangleview *sdlView;
...
UIKit_GL_GetDrawableSize(_THIS, SDL_Window * window, int * w, int * h)
{
    @autoreleasepool {
        ...
        if ([view isKindOfClass:[SDL_uikitmetalangleview class]]) {
            SDL_uikitmetalangleview *glview = (SDL_uikitmetalangleview *) view;
            if (w) {
...
UIKit_GL_CreateContext(_THIS, SDL_Window * window)
{
    @autoreleasepool {
        ...
        view = [[SDL_uikitmetalangleview alloc] initWithFrame:frame
                                                    scale:scale
