...
extern void WINRT_InitTouch(THIS);
extern void WINRT_PumpEvents(THIS);
...
extern void WINTRT_InitialiseInputPaneEvents(THIS);
extern SDL_bool WINRT_HasScreenKeyboardSupport(THIS);
extern void WINRT_ShowScreenKeyboard(THIS, SDL_Window *window);
extern void WINRT_HideScreenKeyboard(THIS, SDL_Window *window);
extern SDL_bool WINRT_IsScreenKeyboardShown(THIS, SDL_Window *window);
#endif // NTDDI_VERSION >= ...
