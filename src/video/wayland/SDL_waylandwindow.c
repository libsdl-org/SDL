...
static const struct xx_color_management_feedback_surface_v4_listener color_management_feedback_surface_listener = {
...
bool Wayland_CreateWindow(SDL_VideoDevice *_this, SDL_Window *window, SDL_PropertiesID create_props)
{
    ...
    if (!custom_surface_role) {
        if (c->xx_color_manager_v4) {
            data->xx_color_management_feedback_surface = xx_color_manager_v4_get_feedback_surface(c->xx_color_manager_v4, data->surface);
            xx_color_management_feedback_surface_v4_add_listener(data->xx_color_management_feedback_surface, &color_management_feedback_surface_listener, data);
...
void Wayland_DestroyWindow(SDL_VideoDevice *_this, SDL_Window *window)
{
    ...
    if (data && wind) {
        ...
        if (wind->xx_color_management_feedback_surface) {
            xx_color_management_feedback_surface_v4_destroy(wind->xx_color_management_feedback_surface);
        }
