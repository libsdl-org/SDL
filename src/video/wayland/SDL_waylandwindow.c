...
static void feedback_surface_preferred_changed(void *data,
                                               struct wp_color_management_feedback_surface_v1 *wp_color_management_feedback_surface_v1,
                                               uint32_t identity)
{
    SDL_WindowData *wind = (SDL_WindowData *)data;
...
static const struct wp_color_management_feedback_surface_v1_listener color_management_feedback_surface_listener = {
...
bool Wayland_CreateWindow(SDL_VideoDevice *_this, SDL_Window *window, SDL_PropertiesID create_props)
{
    ...
    if (!custom_surface_role) {
        if (c->wp_color_manager_v1) {
            data->wp_color_management_feedback_surface = wp_color_manager_v1_get_feedback_surface(c->wp_color_manager_v1, data->surface);
            wp_color_management_feedback_surface_v1_add_listener(data->wp_color_management_feedback_surface, &color_management_feedback_surface_listener, data);
...
void Wayland_DestroyWindow(SDL_VideoDevice *_this, SDL_Window *window)
{
    ...
    if (data && wind) {
        ...
        if (wind->wp_color_management_feedback_surface) {
            wp_color_management_feedback_surface_v1_destroy(wind->wp_color_management_feedback_surface);
        }
