...
int Wayland_GetWindowWMInfo(THIS, SDL_Window *window, SDL_SysWMinfo *info)
{
...
int Wayland_SetWindowModalFor(THIS, SDL_Window *modal_window, SDL_Window *parent_window)
{
    SDL_VideoData *viddata = (SDL_VideoData *)_this->driverdata;
...
void Wayland_ShowWindow(THIS, SDL_Window *window)
{
...
static void Wayland_ReleasePopup(THIS, SDL_Window *popup)
{
...
void Wayland_HideWindow(THIS, SDL_Window *window)
{
...
void Wayland_RaiseWindow(THIS, SDL_Window *window)
{
    SDL_WindowData *wind = window->driverdata;
...
int Wayland_FlashWindow(THIS, SDL_Window *window, SDL_FlashOperation operation)
{
    Wayland_activate_window(_this->driverdata,
                            window->driverdata,
                            NULL,
...
void Wayland_SetWindowFullscreen(THIS, SDL_Window *window,
...
void Wayland_RestoreWindow(THIS, SDL_Window *window)
{
    SDL_WindowData *wind = window->driverdata;
    SDL_VideoData *viddata = (SDL_VideoData *)_this->driverdata;
...
void Wayland_SetWindowBordered(THIS, SDL_Window *window, SDL_bool bordered)
{
    SDL_WindowData *wind = window->driverdata;
...
void Wayland_SetWindowResizable(THIS, SDL_Window *window, SDL_bool resizable)
{
#ifdef HAVE_LIBDECOR_H
...
void Wayland_MaximizeWindow(THIS, SDL_Window *window)
{
    SDL_WindowData *wind = window->driverdata;
    SDL_VideoData *viddata = (SDL_VideoData *)_this->driverdata;
...
void Wayland_MinimizeWindow(THIS, SDL_Window *window)
{
    SDL_WindowData *wind = window->driverdata;
    SDL_VideoData *viddata = (SDL_VideoData *)_this->driverdata;
...
void Wayland_SetWindowMouseRect(THIS, SDL_Window *window)
{
...
void Wayland_SetWindowMouseGrab(THIS, SDL_Window *window, SDL_bool grabbed)
{
    SDL_VideoData *data = (SDL_VideoData *)_this->driverdata;
...
void Wayland_SetWindowKeyboardGrab(THIS, SDL_Window *window, SDL_bool grabbed)
{
    SDL_VideoData *data = (SDL_VideoData *)_this->driverdata;
...
int Wayland_CreateWindow(THIS, SDL_Window *window)
{
    SDL_WindowData *data;
    SDL_VideoData *c;
...
void Wayland_SetWindowMinimumSize(THIS, SDL_Window *window)
{
    SetMinMaxDimensions(window, SDL_TRUE);
}

void Wayland_SetWindowMaximumSize(THIS, SDL_Window *window)
{
    SetMinMaxDimensions(window, SDL_TRUE);
}

void Wayland_SetWindowSize(THIS, SDL_Window *window)
{
    SDL_WindowData *wind = window->driverdata;
...
void Wayland_GetWindowSizeInPixels(THIS, SDL_Window *window, int *w, int *h)
{
    SDL_WindowData *data;
...
void Wayland_SetWindowTitle(THIS, SDL_Window *window)
{
    SDL_WindowData *wind = window->driverdata;
...
void Wayland_SuspendScreenSaver(THIS)
{
    SDL_VideoData *data = (SDL_VideoData *)_this->driverdata;
...
void Wayland_DestroyWindow(THIS, SDL_Window *window)
{
    SDL_VideoData *data = _this->driverdata;
    SDL_WindowData *wind = window->driverdata;
