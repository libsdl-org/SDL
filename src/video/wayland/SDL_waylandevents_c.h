...
extern void Wayland_PumpEvents(THIS);
extern void Wayland_SendWakeupEvent(THIS, SDL_Window *window);
extern int Wayland_WaitEventTimeout(THIS, Sint64 timeoutNS);
