...
static void Wayland_SetOutputZone(SDL_DisplayData *disp, bool run_queue)
{
        ...
        while (entry) {
            ...
            if (end) {
                ...
                *end = '=';
                ...
                if (cmp) {
                    disp->ext_zone_v1 = ext_zone_manager_v1_get_zone_from_handle(disp->videodata->ext_zone_manager_v1, end);
                    break;
                }
            }
    ...
    if (!disp->ext_zone_v1) {
        disp->ext_zone_v1 = ext_zone_manager_v1_get_zone(disp->videodata->ext_zone_manager_v1, disp->output);
    }

    ext_zone_v1_set_user_data(disp->ext_zone_v1, disp);
    ext_zone_v1_add_listener(disp->ext_zone_v1, &zone_listener, disp);
}
