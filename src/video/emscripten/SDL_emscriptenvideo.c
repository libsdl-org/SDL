...
static int Emscripten_VideoInit(THIS);
static int Emscripten_SetDisplayMode(THIS, SDL_VideoDisplay *display, SDL_DisplayMode *mode);
static void Emscripten_VideoQuit(THIS);
static int Emscripten_GetDisplayUsableBounds(THIS, SDL_VideoDisplay *display, SDL_Rect *rect);
static int Emscripten_GetDisplayDPI(THIS, SDL_VideoDisplay *display, float *ddpi, float *hdpi, float *vdpi);

static int Emscripten_CreateWindow(THIS, SDL_Window *window);
static void Emscripten_SetWindowSize(THIS, SDL_Window *window);
static void Emscripten_GetWindowSizeInPixels(THIS, SDL_Window *window, int *w, int *h);
static void Emscripten_DestroyWindow(THIS, SDL_Window *window);
static void Emscripten_SetWindowFullscreen(THIS, SDL_Window *window, SDL_VideoDisplay *display, SDL_bool fullscreen);
static void Emscripten_PumpEvents(THIS);
static void Emscripten_SetWindowTitle(THIS, SDL_Window *window);
...
static int Emscripten_GetDisplayDPI(THIS, SDL_VideoDisplay *display, float *ddpi_out, float *hdpi_out, float *vdpi_out)
{
