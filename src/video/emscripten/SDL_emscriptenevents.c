...
static Uint32 Emscripten_DecodeUTF8(const char *str)
{
    Uint8 octet = (Uint8)*str;
    if (octet == 0) {
        return 0;
    }
    if ((octet & 0x80) == 0) {
        ...
        Uint8 str1 = (Uint8)str[1];
        if ((str1 & 0xC0) == 0x80) {
            return ((octet & 0x1F) << 6) | (str1 & 0x3F);
        }
    } else if ((octet & 0xF0) == 0xE0) {
        Uint8 str1 = (Uint8)str[1];
        Uint8 str2 = (Uint8)str[2];
        if (((str1 & 0xC0) == 0x80) && ((str2 & 0xC0) == 0x80)) {
            return (((Uint32)(octet & 0x0F)) << 12) | (((Uint32)(str1 & 0x3F)) << 6) | ((Uint32)(str2 & 0x3F));
        }
    } else if ((octet & 0xF8) == 0xF0) {
        Uint8 str1 = (Uint8)str[1];
        Uint8 str2 = (Uint8)str[2];
        Uint8 str3 = (Uint8)str[3];
        if (((str1 & 0xC0) == 0x80) && ((str2 & 0xC0) == 0x80) && ((str3 & 0xC0) == 0x80)) {
            return (((Uint32)(octet & 0x07)) << 18) | (((Uint32)(str1 & 0x3F)) << 12) | (((Uint32)(str2 & 0x3F)) << 6) | ((Uint32)(str3 & 0x3F));
        }
    }
    return 0;
}
...
static EM_BOOL Emscripten_HandleKey(int eventType, const EmscriptenKeyboardEvent *keyEvent, void *userData)
{
    ...
    if (keyEvent->location == 0 && SDL_utf8strlen(keyEvent->key) == 1) {
        keycode = Emscripten_DecodeUTF8(keyEvent->key);
        if (keycode >= 'A' && keycode <= 'Z') {
            keycode = SDL_tolower(keycode);
        }
    }
