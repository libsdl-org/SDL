...
struct SDL_VideoDevice
{
    ...
    void (*Vulkan_DestroySurface)(SDL_VideoDevice *_this, SDL_Window *window, VkInstance instance, VkSurfaceKHR surface, const struct VkAllocationCallbacks *allocator);
