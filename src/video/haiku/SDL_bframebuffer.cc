...
int HAIKU_CreateWindowFramebuffer(THIS, SDL_Window * window,
                                       Uint32 * format,
...
int HAIKU_UpdateWindowFramebuffer(THIS, SDL_Window * window,
...
void HAIKU_DestroyWindowFramebuffer(THIS, SDL_Window * window) {
    SDL_BWin *bwin = _ToBeWin(window);
