...
int HAIKU_GL_LoadLibrary(THIS, const char *path)
{
...
void *HAIKU_GL_GetProcAddress(THIS, const char *proc)
{
...
int HAIKU_GL_SwapWindow(THIS, SDL_Window * window) {
    _ToBeWin(window)->SwapBuffers();
    return 0;
}

int HAIKU_GL_MakeCurrent(THIS, SDL_Window * window, SDL_GLContext context) {
...
SDL_GLContext HAIKU_GL_CreateContext(THIS, SDL_Window * window) {
...
void HAIKU_GL_DeleteContext(THIS, SDL_GLContext context) {
...
int HAIKU_GL_SetSwapInterval(THIS, int interval) {
    /* TODO: Implement this, if necessary? */
    return SDL_Unsupported();
}

int HAIKU_GL_GetSwapInterval(THIS) {
    /* TODO: Implement this, if necessary? */
    return 0;
}


void HAIKU_GL_UnloadLibrary(THIS) {
    /* TODO: Implement this, if necessary? */
}
...
/* FIXME: This function is meant to clear the OpenGL context when the video
   ...
   currently in use. */
void HAIKU_GL_RebootContexts(THIS) {
