...
extern int VIVANTE_SetupPlatform(THIS);
extern char *VIVANTE_GetDisplayName(THIS);
extern void VIVANTE_UpdateDisplayScale(THIS);
extern void VIVANTE_CleanupPlatform(THIS);
