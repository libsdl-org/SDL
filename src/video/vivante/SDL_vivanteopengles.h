...
extern int VIVANTE_GLES_LoadLibrary(THIS, const char *path);
extern SDL_GLContext VIVANTE_GLES_CreateContext(THIS, SDL_Window *window);
extern int VIVANTE_GLES_SwapWindow(THIS, SDL_Window *window);
extern int VIVANTE_GLES_MakeCurrent(THIS, SDL_Window *window, SDL_GLContext context);
