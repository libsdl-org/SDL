...
extern int SDL_UpdateMouseCapture(bool force_release);
...
extern int SDL_SendMouseMotion(Uint64 timestamp, SDL_Window *window, SDL_MouseID mouseID, bool relative, float x, float y);
