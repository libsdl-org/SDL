...
typedef enum
{
    ...
    GLES2_SHADER_FRAGMENT_TEXTURE_OPAQUE_COLORSWAP,
    GLES2_SHADER_FRAGMENT_TEXTURE_OPAQUE_PIXELART_COLORSWAP,
    GLES2_SHADER_FRAGMENT_TEXTURE_OPAQUE,
    GLES2_SHADER_FRAGMENT_TEXTURE_OPAQUE_PIXELART,
    GLES2_SHADER_FRAGMENT_TEXTURE_COLORSWAP,
    GLES2_SHADER_FRAGMENT_TEXTURE_PIXELART_COLORSWAP,
    GLES2_SHADER_FRAGMENT_TEXTURE,
    GLES2_SHADER_FRAGMENT_TEXTURE_PIXELART,
#ifdef SDL_HAVE_YUV
