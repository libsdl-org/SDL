...
glslangValidator -D --sep main -e main -S frag --target-env vulkan1.0 --auto-sampled-textures --vn VULKAN_PixelShader_Colors_PQ -o VULKAN_PixelShader_Colors_PQ.h VULKAN_PixelShader_Colors_PQ.hlsl
...
glslangValidator -D --sep main -e main -S frag --target-env vulkan1.0 --auto-sampled-textures --vn VULKAN_PixelShader_Textures_PQ -o VULKAN_PixelShader_Textures_PQ.h VULKAN_PixelShader_Textures_PQ.hlsl
glslangValidator -D --sep main -e main -S frag --target-env vulkan1.0 --auto-sampled-textures --vn VULKAN_PixelShader_Textures_Simple -o VULKAN_PixelShader_Textures_Simple.h VULKAN_PixelShader_Textures_Simple.hlsl
