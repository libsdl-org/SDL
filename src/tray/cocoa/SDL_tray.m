...
void SDL_RemoveTrayEntryAt(SDL_TrayMenu *menu, int pos)
{
    ...
    for (int i = pos; i < menu->nEntries - 1; i++) {
        menu->entries[i] = menu->entries[i + 1];
    }
...
SDL_TrayEntry *SDL_InsertTrayEntryAt(SDL_TrayMenu *menu, int pos, const char *label, SDL_TrayEntryFlags flags)
{
    ...
    NSMenuItem *nsitem = [[NSMenuItem alloc] initWithTitle:[NSString stringWithUTF8String:label] action:@selector(menu:) keyEquivalent:@""];
