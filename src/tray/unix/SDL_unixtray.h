...
typedef struct SDL_TrayDriver
{
    ...
    SDL_TrayStatus (*SetTrayStatus)(SDL_Tray *, SDL_TrayStatus);
    SDL_TrayStatus (*GetTrayStatus)(SDL_Tray *);
    bool (*SetMiscProp)(SDL_Tray *, Uint32, va_list);
    bool (*GetMiscProp)(SDL_Tray *, Uint32, va_list);
