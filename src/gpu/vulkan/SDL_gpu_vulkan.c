...
static Uint32 VULKAN_INTERNAL_GraphicsPipelineResourceLayoutHashFunction(void *userdata, const void *key)
{
...
static bool VULKAN_INTERNAL_GraphicsPipelineResourceLayoutHashKeyMatch(void *userdata, const void *aKey, const void *bKey)
{
    return SDL_memcmp(aKey, bKey, sizeof(GraphicsPipelineResourceLayoutHashTableKey)) == 0;
}
static void VULKAN_INTERNAL_GraphicsPipelineResourceLayoutHashDestroy(void *userdata, const void *key, const void *value)
{
...
static Uint32 VULKAN_INTERNAL_ComputePipelineResourceLayoutHashFunction(void *userdata, const void *key)
{
...
static bool VULKAN_INTERNAL_ComputePipelineResourceLayoutHashKeyMatch(void *userdata, const void *aKey, const void *bKey)
{
    return SDL_memcmp(aKey, bKey, sizeof(ComputePipelineResourceLayoutHashTableKey)) == 0;
}

static void VULKAN_INTERNAL_ComputePipelineResourceLayoutHashDestroy(void *userdata, const void *key, const void *value)
{
    VulkanRenderer *renderer = (VulkanRenderer *)userdata;
...
static Uint32 VULKAN_INTERNAL_DescriptorSetLayoutHashFunction(void *userdata, const void *key)
{
...
static bool VULKAN_INTERNAL_DescriptorSetLayoutHashKeyMatch(void *userdata, const void *aKey, const void *bKey)
{
    return SDL_memcmp(aKey, bKey, sizeof(DescriptorSetLayoutHashTableKey)) == 0;
}

static void VULKAN_INTERNAL_DescriptorSetLayoutHashDestroy(void *userdata, const void *key, const void *value)
{
    VulkanRenderer *renderer = (VulkanRenderer *)userdata;
...
static Uint32 VULKAN_INTERNAL_CommandPoolHashFunction(void *userdata, const void *key)
{
    return (Uint32)((CommandPoolHashTableKey *)key)->threadID;
}

static bool VULKAN_INTERNAL_CommandPoolHashKeyMatch(void *userdata, const void *aKey, const void *bKey)
{
...
static void VULKAN_INTERNAL_CommandPoolHashDestroy(void *userdata, const void *key, const void *value)
{
    VulkanRenderer *renderer = (VulkanRenderer *)userdata;
...
static Uint32 VULKAN_INTERNAL_RenderPassHashFunction(void *userdata, const void *key)
{
...
static bool VULKAN_INTERNAL_RenderPassHashKeyMatch(void *userdata, const void *aKey, const void *bKey)
{
...
static void VULKAN_INTERNAL_RenderPassHashDestroy(void *userdata, const void *key, const void *value)
{
    VulkanRenderer *renderer = (VulkanRenderer *)userdata;
...
static Uint32 VULKAN_INTERNAL_FramebufferHashFunction(void *userdata, const void *key)
{
...
static bool VULKAN_INTERNAL_FramebufferHashKeyMatch(void *userdata, const void *aKey, const void *bKey)
{
...
static void VULKAN_INTERNAL_FramebufferHashDestroy(void *userdata, const void *key, const void *value)
{
    VulkanRenderer *renderer = (VulkanRenderer *)userdata;
...
static SDL_GPUDevice *VULKAN_CreateDevice(bool debugMode, bool preferLowPower, SDL_PropertiesID props)
{
    ...
    // !!! FIXME: has a RWlock now, check the below comment.
