...
#define SDL_CreateOrGetTrayMenu SDL_CreateOrGetTrayMenu_REAL
#define SDL_GetTraySubmenu SDL_GetTraySubmenu_REAL
#define SDL_CreateOrGetTraySubmenu SDL_CreateOrGetTraySubmenu_REAL
#define SDL_GetTrayEntries SDL_GetTrayEntries_REAL
#define SDL_GetTrayEntryAt SDL_GetTrayEntryAt_REAL
#define SDL_RemoveTrayEntry SDL_RemoveTrayEntry_REAL
#define SDL_RemoveTrayEntryAt SDL_RemoveTrayEntryAt_REAL
