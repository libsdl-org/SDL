...
SDL_DYNAPI_PROC(int,SDL_GetPenInfo,(SDL_PenID a, SDL_PenInfo *b),(a,b),return)
SDL_DYNAPI_PROC(const char*,SDL_GetPenName,(SDL_PenID a),(a),return)
SDL_DYNAPI_PROC(SDL_PenInputFlags,SDL_GetPenStatus,(SDL_PenID a, float *b, float *c, float *d, size_t e),(a,b,c,d,e),return)
