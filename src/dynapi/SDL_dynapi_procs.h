...
SDL_DYNAPI_PROC(bool,SDL_AddPathWatch,(const char *a,SDL_FileWatchCallback b,void *c),(a,b,c),return)
SDL_DYNAPI_PROC(void,SDL_RemovePathWatch,(const char *a,SDL_FileWatchCallback b,void *c),(a,b,c),)
