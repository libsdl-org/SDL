...
SDL_DYNAPI_PROC(SDL_Window*,SDL_CreateWindow,(const char *a, int b, int c, int d, int e, Uint64 f),(a,b,c,d,e,f),return)
...
SDL_DYNAPI_PROC(Uint64,SDL_GetWindowFlags,(SDL_Window *a),(a),return)
