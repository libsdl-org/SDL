...
SDL_DYNAPI_PROC(SDL_bool,SDL_CreateGPUDevice,(SDL_GPUShaderFormat a, SDL_bool b, const char *c, SDL_GPUDevice **d),(a,b,c,d),return)
SDL_DYNAPI_PROC(SDL_bool,SDL_CreateGPUDeviceWithProperties,(SDL_PropertiesID a, SDL_GPUDevice **b),(a,b),return)
