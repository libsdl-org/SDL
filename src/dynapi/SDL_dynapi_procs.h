...
SDL_DYNAPI_PROC(int,SDL_RenderCopyTriangles,(SDL_Renderer *a, SDL_Texture *b, const SDL_Point *c, const SDL_Point *d, int e, SDL_bool f),(a,b,c,d,e,f),return)
SDL_DYNAPI_PROC(int,SDL_RenderFillTrianglesF,(SDL_Renderer *a, const SDL_FPoint *b, int c, SDL_bool d),(a,b,c,d),return)
SDL_DYNAPI_PROC(int,SDL_RenderCopyTrianglesF,(SDL_Renderer *a, SDL_Texture *b, const SDL_Point *c, const SDL_FPoint *d, int e, SDL_bool f),(a,b,c,d,e,f),return)
SDL_DYNAPI_PROC(int,SDL_RenderGeometry,(SDL_Renderer *a, SDL_Texture *b, SDL_Point *c, int d, int *e, int f, const SDL_FPoint *g, SDL_bool h),(a,b,c,d,e,f,g,h),return)
