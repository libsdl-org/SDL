...
SDL_DYNAPI_PROC(SDL_Surface*,SDL_AcquireCameraFrame,(SDL_Camera *a, uint64_t *b),(a,b),return)
SDL_DYNAPI_PROC(SDL_GPUCommandBuffer*,SDL_AcquireGPUCommandBuffer,(SDL_GPUDevice *a),(a),return)
SDL_DYNAPI_PROC(SDL_GPUTexture*,SDL_AcquireGPUSwapchainTexture,(SDL_GPUCommandBuffer *a, SDL_Window *b, uint32_t *c, uint32_t *d),(a,b,c,d),return)
...
SDL_DYNAPI_PROC(SDL_TimerID,SDL_AddTimer,(uint32_t a, SDL_TimerCallback b, void *c),(a,b,c),return)
SDL_DYNAPI_PROC(SDL_TimerID,SDL_AddTimerNS,(uint64_t a, SDL_NSTimerCallback b, void *c),(a,b,c),return)
SDL_DYNAPI_PROC(bool,SDL_AddVulkanRenderSemaphores,(SDL_Renderer *a, uint32_t b, int64_t c, int64_t d),(a,b,c,d),return)
...
SDL_DYNAPI_PROC(SDL_GPUComputePass*,SDL_BeginGPUComputePass,(SDL_GPUCommandBuffer *a, const SDL_GPUStorageTextureWriteOnlyBinding *b, uint32_t c, const SDL_GPUStorageBufferWriteOnlyBinding *d, uint32_t e),(a,b,c,d,e),return)
SDL_DYNAPI_PROC(SDL_GPUCopyPass*,SDL_BeginGPUCopyPass,(SDL_GPUCommandBuffer *a),(a),return)
SDL_DYNAPI_PROC(SDL_GPURenderPass*,SDL_BeginGPURenderPass,(SDL_GPUCommandBuffer *a, const SDL_GPUColorTargetInfo *b, uint32_t c, const SDL_GPUDepthStencilTargetInfo *d),(a,b,c,d),return)
...
SDL_DYNAPI_PROC(void,SDL_BindGPUComputeSamplers,(SDL_GPUComputePass *a, uint32_t b, const SDL_GPUTextureSamplerBinding *c, uint32_t d),(a,b,c,d),)
SDL_DYNAPI_PROC(void,SDL_BindGPUComputeStorageBuffers,(SDL_GPUComputePass *a, uint32_t b, SDL_GPUBuffer *const *c, uint32_t d),(a,b,c,d),)
SDL_DYNAPI_PROC(void,SDL_BindGPUComputeStorageTextures,(SDL_GPUComputePass *a, uint32_t b, SDL_GPUTexture *const *c, uint32_t d),(a,b,c,d),)
SDL_DYNAPI_PROC(void,SDL_BindGPUFragmentSamplers,(SDL_GPURenderPass *a, uint32_t b, const SDL_GPUTextureSamplerBinding *c, uint32_t d),(a,b,c,d),)
SDL_DYNAPI_PROC(void,SDL_BindGPUFragmentStorageBuffers,(SDL_GPURenderPass *a, uint32_t b, SDL_GPUBuffer *const *c, uint32_t d),(a,b,c,d),)
SDL_DYNAPI_PROC(void,SDL_BindGPUFragmentStorageTextures,(SDL_GPURenderPass *a, uint32_t b, SDL_GPUTexture *const *c, uint32_t d),(a,b,c,d),)
...
SDL_DYNAPI_PROC(void,SDL_BindGPUVertexBuffers,(SDL_GPURenderPass *a, uint32_t b, const SDL_GPUBufferBinding *c, uint32_t d),(a,b,c,d),)
SDL_DYNAPI_PROC(void,SDL_BindGPUVertexSamplers,(SDL_GPURenderPass *a, uint32_t b, const SDL_GPUTextureSamplerBinding *c, uint32_t d),(a,b,c,d),)
SDL_DYNAPI_PROC(void,SDL_BindGPUVertexStorageBuffers,(SDL_GPURenderPass *a, uint32_t b, SDL_GPUBuffer *const *c, uint32_t d),(a,b,c,d),)
SDL_DYNAPI_PROC(void,SDL_BindGPUVertexStorageTextures,(SDL_GPURenderPass *a, uint32_t b, SDL_GPUTexture *const *c, uint32_t d),(a,b,c,d),)
...
SDL_DYNAPI_PROC(bool,SDL_CompareAndSwapAtomicU32,(SDL_AtomicU32 *a, uint32_t b, uint32_t c),(a,b,c),return)
...
SDL_DYNAPI_PROC(bool,SDL_ConvertAudioSamples,(const SDL_AudioSpec *a, const uint8_t *b, int c, const SDL_AudioSpec *d, uint8_t **e, int *f),(a,b,c,d,e,f),return)
...
SDL_DYNAPI_PROC(void,SDL_CopyGPUBufferToBuffer,(SDL_GPUCopyPass *a, const SDL_GPUBufferLocation *b, const SDL_GPUBufferLocation *c, uint32_t d, bool e),(a,b,c,d,e),)
SDL_DYNAPI_PROC(void,SDL_CopyGPUTextureToTexture,(SDL_GPUCopyPass *a, const SDL_GPUTextureLocation *b, const SDL_GPUTextureLocation *c, uint32_t d, uint32_t e, uint32_t f, bool g),(a,b,c,d,e,f,g),)
...
SDL_DYNAPI_PROC(SDL_Cursor*,SDL_CreateCursor,(const uint8_t *a, const uint8_t *b, int c, int d, int e, int f),(a,b,c,d,e,f),return)
...
SDL_DYNAPI_PROC(SDL_Semaphore*,SDL_CreateSemaphore,(uint32_t a),(a),return)
...
SDL_DYNAPI_PROC(void,SDL_Delay,(uint32_t a),(a),)
SDL_DYNAPI_PROC(void,SDL_DelayNS,(uint64_t a),(a),)
...
SDL_DYNAPI_PROC(void,SDL_DispatchGPUCompute,(SDL_GPUComputePass *a, uint32_t b, uint32_t c, uint32_t d),(a,b,c,d),)
SDL_DYNAPI_PROC(void,SDL_DispatchGPUComputeIndirect,(SDL_GPUComputePass *a, SDL_GPUBuffer *b, uint32_t c),(a,b,c),)
...
SDL_DYNAPI_PROC(void,SDL_DrawGPUIndexedPrimitives,(SDL_GPURenderPass *a, uint32_t b, uint32_t c, uint32_t d, int32_t e, uint32_t f),(a,b,c,d,e,f),)
SDL_DYNAPI_PROC(void,SDL_DrawGPUIndexedPrimitivesIndirect,(SDL_GPURenderPass *a, SDL_GPUBuffer *b, uint32_t c, uint32_t d),(a,b,c,d),)
SDL_DYNAPI_PROC(void,SDL_DrawGPUPrimitives,(SDL_GPURenderPass *a, uint32_t b, uint32_t c, uint32_t d, uint32_t e),(a,b,c,d,e),)
SDL_DYNAPI_PROC(void,SDL_DrawGPUPrimitivesIndirect,(SDL_GPURenderPass *a, SDL_GPUBuffer *b, uint32_t c, uint32_t d),(a,b,c,d),)
...
SDL_DYNAPI_PROC(bool,SDL_EventEnabled,(uint32_t a),(a),return)
SDL_DYNAPI_PROC(bool,SDL_FillSurfaceRect,(SDL_Surface *a, const SDL_Rect *b, uint32_t c),(a,b,c),return)
SDL_DYNAPI_PROC(bool,SDL_FillSurfaceRects,(SDL_Surface *a, const SDL_Rect *b, int c, uint32_t d),(a,b,c,d),return)
...
SDL_DYNAPI_PROC(void,SDL_FlushEvent,(uint32_t a),(a),)
SDL_DYNAPI_PROC(void,SDL_FlushEvents,(uint32_t a, uint32_t b),(a,b),)
...
SDL_DYNAPI_PROC(uint32_t,SDL_GPUTextureFormatTexelBlockSize,(SDL_GPUTextureFormat a),(a),return)
...
SDL_DYNAPI_PROC(uint32_t,SDL_GetAndroidExternalStorageState,(void),(),return)
...
SDL_DYNAPI_PROC(uint32_t,SDL_GetAtomicU32,(SDL_AtomicU32 *a),(a),return)
...
SDL_DYNAPI_PROC(int16_t,SDL_GetGamepadAxis,(SDL_Gamepad *a, SDL_GamepadAxis b),(a,b),return)
...
SDL_DYNAPI_PROC(uint16_t,SDL_GetGamepadFirmwareVersion,(SDL_Gamepad *a),(a),return)
...
SDL_DYNAPI_PROC(uint16_t,SDL_GetGamepadProduct,(SDL_Gamepad *a),(a),return)
SDL_DYNAPI_PROC(uint16_t,SDL_GetGamepadProductForID,(SDL_JoystickID a),(a),return)
SDL_DYNAPI_PROC(uint16_t,SDL_GetGamepadProductVersion,(SDL_Gamepad *a),(a),return)
SDL_DYNAPI_PROC(uint16_t,SDL_GetGamepadProductVersionForID,(SDL_JoystickID a),(a),return)
...
SDL_DYNAPI_PROC(uint64_t,SDL_GetGamepadSteamHandle,(SDL_Gamepad *a),(a),return)
...
SDL_DYNAPI_PROC(uint16_t,SDL_GetGamepadVendor,(SDL_Gamepad *a),(a),return)
SDL_DYNAPI_PROC(uint16_t,SDL_GetGamepadVendorForID,(SDL_JoystickID a),(a),return)
...
SDL_DYNAPI_PROC(uint32_t,SDL_GetHapticFeatures,(SDL_Haptic *a),(a),return)
...
SDL_DYNAPI_PROC(int64_t,SDL_GetIOSize,(SDL_IOStream *a),(a),return)
SDL_DYNAPI_PROC(SDL_IOStatus,SDL_GetIOStatus,(SDL_IOStream *a),(a),return)
SDL_DYNAPI_PROC(int16_t,SDL_GetJoystickAxis,(SDL_Joystick *a, int b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_GetJoystickAxisInitialState,(SDL_Joystick *a, int b, int16_t *c),(a,b,c),return)
...
SDL_DYNAPI_PROC(uint16_t,SDL_GetJoystickFirmwareVersion,(SDL_Joystick *a),(a),return)
...
SDL_DYNAPI_PROC(void,SDL_GetJoystickGUIDInfo,(SDL_GUID a, uint16_t *b, uint16_t *c, uint16_t *d, uint16_t *e),(a,b,c,d,e),)
SDL_DYNAPI_PROC(uint8_t,SDL_GetJoystickHat,(SDL_Joystick *a, int b),(a,b),return)
...
SDL_DYNAPI_PROC(uint16_t,SDL_GetJoystickProduct,(SDL_Joystick *a),(a),return)
SDL_DYNAPI_PROC(uint16_t,SDL_GetJoystickProductForID,(SDL_JoystickID a),(a),return)
SDL_DYNAPI_PROC(uint16_t,SDL_GetJoystickProductVersion,(SDL_Joystick *a),(a),return)
SDL_DYNAPI_PROC(uint16_t,SDL_GetJoystickProductVersionForID,(SDL_JoystickID a),(a),return)
...
SDL_DYNAPI_PROC(uint16_t,SDL_GetJoystickVendor,(SDL_Joystick *a),(a),return)
SDL_DYNAPI_PROC(uint16_t,SDL_GetJoystickVendorForID,(SDL_JoystickID a),(a),return)
...
SDL_DYNAPI_PROC(bool,SDL_GetMasksForPixelFormat,(SDL_PixelFormat a, int *b, uint32_t *c, uint32_t *d, uint32_t *e, uint32_t *f),(a,b,c,d,e,f),return)
...
SDL_DYNAPI_PROC(int64_t,SDL_GetNumberProperty,(SDL_PropertiesID a, const char *b, int64_t c),(a,b,c),return)
SDL_DYNAPI_PROC(void,SDL_GetOriginalMemoryFunctions,(SDL_malloc_func *a, SDL_calloc_func *b, SDL_realloc_func *c, SDL_free_func *d),(a,b,c,d),)
SDL_DYNAPI_PROC(bool,SDL_GetPathInfo,(const char *a, SDL_PathInfo *b),(a,b),return)
SDL_DYNAPI_PROC(uint64_t,SDL_GetPerformanceCounter,(void),(),return)
SDL_DYNAPI_PROC(uint64_t,SDL_GetPerformanceFrequency,(void),(),return)
SDL_DYNAPI_PROC(const SDL_PixelFormatDetails*,SDL_GetPixelFormatDetails,(SDL_PixelFormat a),(a),return)
SDL_DYNAPI_PROC(SDL_PixelFormat,SDL_GetPixelFormatForMasks,(int a, uint32_t b, uint32_t c, uint32_t d, uint32_t e),(a,b,c,d,e),return)
...
SDL_DYNAPI_PROC(void,SDL_GetRGB,(uint32_t a, const SDL_PixelFormatDetails *b, const SDL_Palette *c, uint8_t *d, uint8_t *e, uint8_t *f),(a,b,c,d,e,f),)
SDL_DYNAPI_PROC(void,SDL_GetRGBA,(uint32_t a, const SDL_PixelFormatDetails *b, const SDL_Palette *c, uint8_t *d, uint8_t *e, uint8_t *f, uint8_t *g),(a,b,c,d,e,f,g),)
...
SDL_DYNAPI_PROC(bool,SDL_GetRenderDrawColor,(SDL_Renderer *a, uint8_t *b, uint8_t *c, uint8_t *d, uint8_t *e),(a,b,c,d,e),return)
...
SDL_DYNAPI_PROC(uint32_t,SDL_GetSemaphoreValue,(SDL_Semaphore *a),(a),return)
...
SDL_DYNAPI_PROC(bool,SDL_GetStorageFileSize,(SDL_Storage *a, const char *b, uint64_t *c),(a,b,c),return)
SDL_DYNAPI_PROC(bool,SDL_GetStoragePathInfo,(SDL_Storage *a, const char *b, SDL_PathInfo *c),(a,b,c),return)
SDL_DYNAPI_PROC(uint64_t,SDL_GetStorageSpaceRemaining,(SDL_Storage *a),(a),return)
SDL_DYNAPI_PROC(const char*,SDL_GetStringProperty,(SDL_PropertiesID a, const char *b, const char *c),(a,b,c),return)
SDL_DYNAPI_PROC(bool,SDL_GetSurfaceAlphaMod,(SDL_Surface *a, uint8_t *b),(a,b),return)
...
SDL_DYNAPI_PROC(bool,SDL_GetSurfaceColorKey,(SDL_Surface *a, uint32_t *b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_GetSurfaceColorMod,(SDL_Surface *a, uint8_t *b, uint8_t *c, uint8_t *d),(a,b,c,d),return)
...
SDL_DYNAPI_PROC(bool,SDL_GetTextureAlphaMod,(SDL_Texture *a, uint8_t *b),(a,b),return)
...
SDL_DYNAPI_PROC(bool,SDL_GetTextureColorMod,(SDL_Texture *a, uint8_t *b, uint8_t *c, uint8_t *d),(a,b,c,d),return)
...
SDL_DYNAPI_PROC(uint64_t,SDL_GetTicks,(void),(),return)
SDL_DYNAPI_PROC(uint64_t,SDL_GetTicksNS,(void),(),return)
...
SDL_DYNAPI_PROC(bool,SDL_HasEvent,(uint32_t a),(a),return)
SDL_DYNAPI_PROC(bool,SDL_HasEvents,(uint32_t a, uint32_t b),(a,b),return)
...
SDL_DYNAPI_PROC(bool,SDL_LoadWAV,(const char *a, SDL_AudioSpec *b, uint8_t **c, uint32_t *d),(a,b,c,d),return)
SDL_DYNAPI_PROC(bool,SDL_LoadWAV_IO,(SDL_IOStream *a, bool b, SDL_AudioSpec *c, uint8_t **d, uint32_t *e),(a,b,c,d,e),return)
...
SDL_DYNAPI_PROC(uint32_t,SDL_MapRGB,(const SDL_PixelFormatDetails *a, const SDL_Palette *b, uint8_t c, uint8_t d, uint8_t e),(a,b,c,d,e),return)
SDL_DYNAPI_PROC(uint32_t,SDL_MapRGBA,(const SDL_PixelFormatDetails *a, const SDL_Palette *b, uint8_t c, uint8_t d, uint8_t e, uint8_t f),(a,b,c,d,e,f),return)
SDL_DYNAPI_PROC(uint32_t,SDL_MapSurfaceRGB,(SDL_Surface *a, uint8_t b, uint8_t c, uint8_t d),(a,b,c,d),return)
SDL_DYNAPI_PROC(uint32_t,SDL_MapSurfaceRGBA,(SDL_Surface *a, uint8_t b, uint8_t c, uint8_t d, uint8_t e),(a,b,c,d,e),return)
...
SDL_DYNAPI_PROC(bool,SDL_MixAudio,(uint8_t *a, const uint8_t *b, SDL_AudioFormat c, uint32_t d, float e),(a,b,c,d,e),return)
...
SDL_DYNAPI_PROC(int,SDL_PeepEvents,(SDL_Event *a, int b, SDL_EventAction c, uint32_t d, uint32_t e),(a,b,c,d,e),return)
SDL_DYNAPI_PROC(bool,SDL_PlayHapticRumble,(SDL_Haptic *a, float b, uint32_t c),(a,b,c),return)
...
SDL_DYNAPI_PROC(void,SDL_PushGPUComputeUniformData,(SDL_GPUCommandBuffer *a, uint32_t b, const void *c, uint32_t d),(a,b,c,d),)
SDL_DYNAPI_PROC(void,SDL_PushGPUDebugGroup,(SDL_GPUCommandBuffer *a, const char *b),(a,b),)
SDL_DYNAPI_PROC(void,SDL_PushGPUFragmentUniformData,(SDL_GPUCommandBuffer *a, uint32_t b, const void *c, uint32_t d),(a,b,c,d),)
SDL_DYNAPI_PROC(void,SDL_PushGPUVertexUniformData,(SDL_GPUCommandBuffer *a, uint32_t b, const void *c, uint32_t d),(a,b,c,d),)
...
SDL_DYNAPI_PROC(bool,SDL_ReadS16BE,(SDL_IOStream *a, int16_t *b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_ReadS16LE,(SDL_IOStream *a, int16_t *b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_ReadS32BE,(SDL_IOStream *a, int32_t *b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_ReadS32LE,(SDL_IOStream *a, int32_t *b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_ReadS64BE,(SDL_IOStream *a, int64_t *b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_ReadS64LE,(SDL_IOStream *a, int64_t *b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_ReadS8,(SDL_IOStream *a, int8_t *b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_ReadStorageFile,(SDL_Storage *a, const char *b, void *c, uint64_t d),(a,b,c,d),return)
SDL_DYNAPI_PROC(bool,SDL_ReadSurfacePixel,(SDL_Surface *a, int b, int c, uint8_t *d, uint8_t *e, uint8_t *f, uint8_t *g),(a,b,c,d,e,f,g),return)
...
SDL_DYNAPI_PROC(bool,SDL_ReadU16BE,(SDL_IOStream *a, uint16_t *b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_ReadU16LE,(SDL_IOStream *a, uint16_t *b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_ReadU32BE,(SDL_IOStream *a, uint32_t *b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_ReadU32LE,(SDL_IOStream *a, uint32_t *b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_ReadU64BE,(SDL_IOStream *a, uint64_t *b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_ReadU64LE,(SDL_IOStream *a, uint64_t *b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_ReadU8,(SDL_IOStream *a, uint8_t *b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_RegisterApp,(const char *a, uint32_t b, void *c),(a,b,c),return)
SDL_DYNAPI_PROC(uint32_t,SDL_RegisterEvents,(int a),(a),return)
...
SDL_DYNAPI_PROC(bool,SDL_RumbleGamepad,(SDL_Gamepad *a, uint16_t b, uint16_t c, uint32_t d),(a,b,c,d),return)
SDL_DYNAPI_PROC(bool,SDL_RumbleGamepadTriggers,(SDL_Gamepad *a, uint16_t b, uint16_t c, uint32_t d),(a,b,c,d),return)
SDL_DYNAPI_PROC(bool,SDL_RumbleJoystick,(SDL_Joystick *a, uint16_t b, uint16_t c, uint32_t d),(a,b,c,d),return)
SDL_DYNAPI_PROC(bool,SDL_RumbleJoystickTriggers,(SDL_Joystick *a, uint16_t b, uint16_t c, uint32_t d),(a,b,c,d),return)
SDL_DYNAPI_PROC(int,SDL_RunApp,(int a, char *b[], SDL_main_func c, void *d),(a,b,c,d),return)
SDL_DYNAPI_PROC(bool,SDL_RunHapticEffect,(SDL_Haptic *a, int b, uint32_t c),(a,b,c),return)
...
SDL_DYNAPI_PROC(int64_t,SDL_SeekIO,(SDL_IOStream *a, int64_t b, SDL_IOWhence c),(a,b,c),return)
SDL_DYNAPI_PROC(void,SDL_SendAndroidBackButton,(void),(),)
SDL_DYNAPI_PROC(bool,SDL_SendAndroidMessage,(uint32_t a, int b),(a,b),return)
...
SDL_DYNAPI_PROC(bool,SDL_SendJoystickVirtualSensorData,(SDL_Joystick *a, SDL_SensorType b, uint64_t c, const float *d, int e),(a,b,c,d,e),return)
...
SDL_DYNAPI_PROC(uint32_t,SDL_SetAtomicU32,(SDL_AtomicU32 *a, uint32_t b),(a,b),return)
...
SDL_DYNAPI_PROC(void,SDL_SetEventEnabled,(uint32_t a, bool b),(a,b),)
...
SDL_DYNAPI_PROC(void,SDL_SetGPUStencilReference,(SDL_GPURenderPass *a, uint8_t b),(a,b),)
...
SDL_DYNAPI_PROC(bool,SDL_SetGamepadLED,(SDL_Gamepad *a, uint8_t b, uint8_t c, uint8_t d),(a,b,c,d),return)
...
SDL_DYNAPI_PROC(bool,SDL_SetJoystickLED,(SDL_Joystick *a, uint8_t b, uint8_t c, uint8_t d),(a,b,c,d),return)
SDL_DYNAPI_PROC(bool,SDL_SetJoystickPlayerIndex,(SDL_Joystick *a, int b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_SetJoystickVirtualAxis,(SDL_Joystick *a, int b, int16_t c),(a,b,c),return)
SDL_DYNAPI_PROC(bool,SDL_SetJoystickVirtualBall,(SDL_Joystick *a, int b, int16_t c, int16_t d),(a,b,c,d),return)
SDL_DYNAPI_PROC(bool,SDL_SetJoystickVirtualButton,(SDL_Joystick *a, int b, bool c),(a,b,c),return)
SDL_DYNAPI_PROC(bool,SDL_SetJoystickVirtualHat,(SDL_Joystick *a, int b, uint8_t c),(a,b,c),return)
...
SDL_DYNAPI_PROC(bool,SDL_SetLinuxThreadPriority,(int64_t a, int b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_SetLinuxThreadPriorityAndPolicy,(int64_t a, int b, int c),(a,b,c),return)
...
SDL_DYNAPI_PROC(bool,SDL_SetNumberProperty,(SDL_PropertiesID a, const char *b, int64_t c),(a,b,c),return)
...
SDL_DYNAPI_PROC(bool,SDL_SetRenderDrawColor,(SDL_Renderer *a, uint8_t b, uint8_t c, uint8_t d, uint8_t e),(a,b,c,d,e),return)
...
SDL_DYNAPI_PROC(bool,SDL_SetSurfaceAlphaMod,(SDL_Surface *a, uint8_t b),(a,b),return)
...
SDL_DYNAPI_PROC(bool,SDL_SetSurfaceColorKey,(SDL_Surface *a, bool b, uint32_t c),(a,b,c),return)
SDL_DYNAPI_PROC(bool,SDL_SetSurfaceColorMod,(SDL_Surface *a, uint8_t b, uint8_t c, uint8_t d),(a,b,c,d),return)
...
SDL_DYNAPI_PROC(bool,SDL_SetTextureAlphaMod,(SDL_Texture *a, uint8_t b),(a,b),return)
...
SDL_DYNAPI_PROC(bool,SDL_SetTextureColorMod,(SDL_Texture *a, uint8_t b, uint8_t c, uint8_t d),(a,b,c,d),return)
...
SDL_DYNAPI_PROC(uint32_t,SDL_StepUTF8,(const char **a, size_t *b),(a,b),return)
...
SDL_DYNAPI_PROC(int64_t,SDL_TellIO,(SDL_IOStream *a),(a),return)
SDL_DYNAPI_PROC(bool,SDL_TextInputActive,(SDL_Window *a),(a),return)
SDL_DYNAPI_PROC(SDL_Time,SDL_TimeFromWindows,(uint32_t a, uint32_t b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_TimeToDateTime,(SDL_Time a, SDL_DateTime *b, bool c),(a,b,c),return)
SDL_DYNAPI_PROC(void,SDL_TimeToWindows,(SDL_Time a, uint32_t *b, uint32_t *c),(a,b,c),)
...
SDL_DYNAPI_PROC(char*,SDL_UCS4ToUTF8,(uint32_t a, char *b),(a,b),return)
...
SDL_DYNAPI_PROC(bool,SDL_UpdateNVTexture,(SDL_Texture *a, const SDL_Rect *b, const uint8_t *c, int d, const uint8_t *e, int f),(a,b,c,d,e,f),return)
...
SDL_DYNAPI_PROC(bool,SDL_UpdateYUVTexture,(SDL_Texture *a, const SDL_Rect *b, const uint8_t *c, int d, const uint8_t *e, int f, const uint8_t *g, int h),(a,b,c,d,e,f,g,h),return)
...
SDL_DYNAPI_PROC(char const* const*,SDL_Vulkan_GetInstanceExtensions,(uint32_t *a),(a),return)
SDL_DYNAPI_PROC(bool,SDL_Vulkan_GetPresentationSupport,(VkInstance a, VkPhysicalDevice b, uint32_t c),(a,b,c),return)
...
SDL_DYNAPI_PROC(bool,SDL_WaitConditionTimeout,(SDL_Condition *a, SDL_Mutex *b, int32_t c),(a,b,c),return)
SDL_DYNAPI_PROC(bool,SDL_WaitEvent,(SDL_Event *a),(a),return)
SDL_DYNAPI_PROC(bool,SDL_WaitEventTimeout,(SDL_Event *a, int32_t b),(a,b),return)
SDL_DYNAPI_PROC(void,SDL_WaitForGPUFences,(SDL_GPUDevice *a, bool b, SDL_GPUFence *const *c, uint32_t d),(a,b,c,d),)
...
SDL_DYNAPI_PROC(bool,SDL_WaitSemaphoreTimeout,(SDL_Semaphore *a, int32_t b),(a,b),return)
...
SDL_DYNAPI_PROC(bool,SDL_WriteS16BE,(SDL_IOStream *a, int16_t b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_WriteS16LE,(SDL_IOStream *a, int16_t b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_WriteS32BE,(SDL_IOStream *a, int32_t b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_WriteS32LE,(SDL_IOStream *a, int32_t b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_WriteS64BE,(SDL_IOStream *a, int64_t b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_WriteS64LE,(SDL_IOStream *a, int64_t b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_WriteS8,(SDL_IOStream *a, int8_t b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_WriteStorageFile,(SDL_Storage *a, const char *b, const void *c, uint64_t d),(a,b,c,d),return)
SDL_DYNAPI_PROC(bool,SDL_WriteSurfacePixel,(SDL_Surface *a, int b, int c, uint8_t d, uint8_t e, uint8_t f, uint8_t g),(a,b,c,d,e,f,g),return)
...
SDL_DYNAPI_PROC(bool,SDL_WriteU16BE,(SDL_IOStream *a, uint16_t b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_WriteU16LE,(SDL_IOStream *a, uint16_t b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_WriteU32BE,(SDL_IOStream *a, uint32_t b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_WriteU32LE,(SDL_IOStream *a, uint32_t b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_WriteU64BE,(SDL_IOStream *a, uint64_t b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_WriteU64LE,(SDL_IOStream *a, uint64_t b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_WriteU8,(SDL_IOStream *a, uint8_t b),(a,b),return)
...
SDL_DYNAPI_PROC(uint16_t,SDL_crc16,(uint16_t a, const void *b, size_t c),(a,b,c),return)
SDL_DYNAPI_PROC(uint32_t,SDL_crc32,(uint32_t a, const void *b, size_t c),(a,b,c),return)
...
SDL_DYNAPI_PROC(uint32_t,SDL_hid_device_change_count,(void),(),return)
...
SDL_DYNAPI_PROC(void*,SDL_memset4,(void *a, uint32_t b, size_t c),(a,b,c),return)
...
SDL_DYNAPI_PROC(int32_t,SDL_rand,(int32_t a),(a),return)
SDL_DYNAPI_PROC(uint32_t,SDL_rand_bits,(void),(),return)
SDL_DYNAPI_PROC(uint32_t,SDL_rand_bits_r,(uint64_t *a),(a),return)
SDL_DYNAPI_PROC(int32_t,SDL_rand_r,(uint64_t *a, int32_t b),(a,b),return)
SDL_DYNAPI_PROC(float,SDL_randf,(void),(),return)
SDL_DYNAPI_PROC(float,SDL_randf_r,(uint64_t *a),(a),return)
...
SDL_DYNAPI_PROC(void,SDL_srand,(uint64_t a),(a),)
