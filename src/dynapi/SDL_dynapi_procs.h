...
SDL_DYNAPI_PROC(int,SDL_utf16casecmp,(const Uint16 *a, const Uint16 *b),(a,b),return)
SDL_DYNAPI_PROC(int,SDL_utf32casecmp,(const Uint32 *a, const Uint32 *b),(a,b),return)
SDL_DYNAPI_PROC(int,SDL_utf8casecmp,(const char *a, const char *b),(a,b),return)
