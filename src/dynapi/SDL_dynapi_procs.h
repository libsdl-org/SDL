...
SDL_DYNAPI_PROC(int,SDL_FillTriangle,(SDL_Surface *a, const SDL_Point b[3], Uint32 c),(a,b,c),return)
SDL_DYNAPI_PROC(int,SDL_BlitTriangle,(SDL_Surface *a, const SDL_Point b[3], SDL_Surface *c, const SDL_Point d[3]),(a,b,c,d),return)
SDL_DYNAPI_PROC(int,SDL_RenderFillTriangles,(SDL_Renderer *a, const SDL_Point *b, int c, SDL_TriangleMode d),(a,b,c,d),return)
SDL_DYNAPI_PROC(int,SDL_RenderCopyTriangles,(SDL_Renderer *a, SDL_Texture *b, const SDL_Point *c, const SDL_Point *d, int e, SDL_TriangleMode f),(a,b,c,d,e,f),return)
SDL_DYNAPI_PROC(int,SDL_RenderFillTrianglesF,(SDL_Renderer *a, const SDL_FPoint *b, int c, SDL_TriangleMode d),(a,b,c,d),return)
SDL_DYNAPI_PROC(int,SDL_RenderCopyTrianglesF,(SDL_Renderer *a, SDL_Texture *b, const SDL_Point *c, const SDL_FPoint *d, int e, SDL_TriangleMode f),(a,b,c,d,e,f),return)
SDL_DYNAPI_PROC(int,SDL_RenderGeometry,(SDL_Renderer *a, SDL_Texture *b, SDL_Point *c, int d, int *e, int f, const SDL_FPoint *g, SDL_TriangleMode h),(a,b,c,d,e,f,g,h),return)
