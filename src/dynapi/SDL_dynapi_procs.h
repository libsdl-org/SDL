...
SDL_DYNAPI_PROC(SDL_FSops*,SDL_CreateFilesystem,(const char *a),(a),return)
SDL_DYNAPI_PROC(SDL_RWops*,SDL_FSopen,(SDL_FSops *a, const char *b, const char *c),(a,b,c),return)
SDL_DYNAPI_PROC(int,SDL_FSenumerate,(SDL_FSops *a, const char *b, SDL_EnumerateCallback c, void *d),(a,b,c,d),return)
SDL_DYNAPI_PROC(int,SDL_FSremove,(SDL_FSops *a, const char *b),(a,b),return)
SDL_DYNAPI_PROC(int,SDL_FSrename,(SDL_FSops *a, const char *b, const char *c),(a,b,c),return)
SDL_DYNAPI_PROC(int,SDL_FSmkdir,(SDL_FSops *a, const char *b),(a,b),return)
SDL_DYNAPI_PROC(int,SDL_FSstat,(SDL_FSops *a, const char *b, SDL_Stat *c),(a,b,c),return)
...
SDL_DYNAPI_PROC(int,SDL_MakeFilesystemDirectory,(const char *a),(a),return)
SDL_DYNAPI_PROC(int,SDL_StatFilesystemPath,(const char *a, SDL_Stat *b),(a,b),return)
