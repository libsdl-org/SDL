...
SDL_DYNAPI_PROC(void,SDL_GpuSetTransferData,(SDL_GpuDevice *a, void *b, SDL_GpuTransferBuffer *c, SDL_GpuBufferCopy *d, SDL_GpuTransferOptions e),(a,b,c,d,e),)
...
SDL_DYNAPI_PROC(void,SDL_GpuUploadToTexture,(SDL_GpuDevice *a, SDL_GpuCommandBuffer *b, SDL_GpuTransferBuffer *c, SDL_GpuTextureRegion *d, SDL_GpuBufferImageCopy *e, SDL_GpuTextureWriteOptions f),(a,b,c,d,e,f),)
SDL_DYNAPI_PROC(void,SDL_GpuUploadToBuffer,(SDL_GpuDevice *a, SDL_GpuCommandBuffer *b, SDL_GpuTransferBuffer *c, SDL_GpuBuffer *d, SDL_GpuBufferCopy *e, SDL_GpuBufferWriteOptions f),(a,b,c,d,e,f),)
SDL_DYNAPI_PROC(void,SDL_GpuCopyTextureToTexture,(SDL_GpuDevice *a, SDL_GpuCommandBuffer *b, SDL_GpuTextureRegion *c, SDL_GpuTextureRegion *d, SDL_GpuTextureWriteOptions e),(a,b,c,d,e),)
SDL_DYNAPI_PROC(void,SDL_GpuCopyBufferToBuffer,(SDL_GpuDevice *a, SDL_GpuCommandBuffer *b, SDL_GpuBuffer *c, SDL_GpuBuffer *d, SDL_GpuBufferCopy *e, SDL_GpuBufferWriteOptions f),(a,b,c,d,e,f),)
...
SDL_DYNAPI_PROC(Uint8,SDL_GpuClaimWindow,(SDL_GpuDevice *a, void *b, SDL_GpuPresentMode c),(a,b,c),return)
SDL_DYNAPI_PROC(void,SDL_GpuUnclaimWindow,(SDL_GpuDevice *a, void *b),(a,b),)
SDL_DYNAPI_PROC(void,SDL_GpuSetSwapchainPresentMode,(SDL_GpuDevice *a, void *b, SDL_GpuPresentMode c),(a,b,c),)
SDL_DYNAPI_PROC(SDL_GpuTextureFormat,SDL_GpuGetSwapchainFormat,(SDL_GpuDevice *a, void *b),(a,b),return)
SDL_DYNAPI_PROC(SDL_GpuCommandBuffer*,SDL_GpuAcquireCommandBuffer,(SDL_GpuDevice *a),(a),return)
SDL_DYNAPI_PROC(SDL_GpuTexture*,SDL_GpuAcquireSwapchainTexture,(SDL_GpuDevice *a, SDL_GpuCommandBuffer *b, void *c, Uint32 *d, Uint32 *e),(a,b,c,d,e),return)
...
SDL_DYNAPI_PROC(void,SDL_GpuDownloadFromTexture,(SDL_GpuDevice *a, SDL_GpuTextureRegion *b, SDL_GpuTransferBuffer *c, SDL_GpuBufferImageCopy *d, SDL_GpuTransferOptions e),(a,b,c,d,e),)
SDL_DYNAPI_PROC(void,SDL_GpuDownloadFromBuffer,(SDL_GpuDevice *a, SDL_GpuBuffer *b, SDL_GpuTransferBuffer *c, SDL_GpuBufferCopy *d, SDL_GpuTransferOptions e),(a,b,c,d,e),)
