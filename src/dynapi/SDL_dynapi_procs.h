...
SDL_DYNAPI_PROC(int,SDL_GetRenderTextureAddressMode,(SDL_Renderer *a, SDL_TextureAddressMode *b),(a,b),return)
...
SDL_DYNAPI_PROC(int,SDL_SetRenderTextureAddressMode,(SDL_Renderer *a, SDL_TextureAddressMode b),(a,b),return)
