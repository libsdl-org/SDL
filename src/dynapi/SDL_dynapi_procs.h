...
SDL_DYNAPI_PROC(bool,SDL_GetRenderDrawColorRGBA,(SDL_Renderer *a, SDL_Color *b),(a,b),return)
...
SDL_DYNAPI_PROC(bool,SDL_SetRenderDrawColorRGBA,(SDL_Renderer *a, SDL_Color b),(a,b),return)
