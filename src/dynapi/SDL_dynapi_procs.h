...
SDL_DYNAPI_PROC_NORET(void,SDL_Log,(SDL_PRINTF_FORMAT_STRING const char *a, ...),(a))
SDL_DYNAPI_PROC_NORET(void,SDL_LogVerbose,(int a, SDL_PRINTF_FORMAT_STRING const char *b, ...),(a,b))
SDL_DYNAPI_PROC_NORET(void,SDL_LogDebug,(int a, SDL_PRINTF_FORMAT_STRING const char *b, ...),(a,b))
SDL_DYNAPI_PROC_NORET(void,SDL_LogInfo,(int a, SDL_PRINTF_FORMAT_STRING const char *b, ...),(a,b))
SDL_DYNAPI_PROC_NORET(void,SDL_LogWarn,(int a, SDL_PRINTF_FORMAT_STRING const char *b, ...),(a,b))
SDL_DYNAPI_PROC_NORET(void,SDL_LogError,(int a, SDL_PRINTF_FORMAT_STRING const char *b, ...),(a,b))
SDL_DYNAPI_PROC_NORET(void,SDL_LogCritical,(int a, SDL_PRINTF_FORMAT_STRING const char *b, ...),(a,b))
SDL_DYNAPI_PROC_NORET(void,SDL_LogMessage,(int a, SDL_LogPriority b, SDL_PRINTF_FORMAT_STRING const char *c, ...),(a,b,c))
...
SDL_DYNAPI_PROC_NORET(void,SDL_UnregisterApp,(void),())
#endif
...
SDL_DYNAPI_PROC_NORET(void,SDL_iPhoneSetEventPump,(SDL_bool a),(a))
#endif
...
SDL_DYNAPI_PROC_NORET(void,SDL_QuitSubSystem,(Uint32 a),(a))
SDL_DYNAPI_PROC(Uint32,SDL_WasInit,(Uint32 a),(a),return)
SDL_DYNAPI_PROC_NORET(void,SDL_Quit,(void),())
SDL_DYNAPI_PROC(SDL_AssertState,SDL_ReportAssertion,(SDL_AssertData *a, const char *b, const char *c, int d),(a,b,c,d),return)
SDL_DYNAPI_PROC_NORET(void,SDL_SetAssertionHandler,(SDL_AssertionHandler a, void *b),(a,b))
SDL_DYNAPI_PROC(const SDL_AssertData*,SDL_GetAssertionReport,(void),(),return)
SDL_DYNAPI_PROC_NORET(void,SDL_ResetAssertionReport,(void),())
SDL_DYNAPI_PROC(SDL_bool,SDL_AtomicTryLock,(SDL_SpinLock *a),(a),return)
SDL_DYNAPI_PROC_NORET(void,SDL_AtomicLock,(SDL_SpinLock *a),(a))
SDL_DYNAPI_PROC_NORET(void,SDL_AtomicUnlock,(SDL_SpinLock *a),(a))
...
SDL_DYNAPI_PROC_NORET(void,SDL_AudioQuit,(void),())
...
SDL_DYNAPI_PROC_NORET(void,SDL_PauseAudio,(int a),(a))
SDL_DYNAPI_PROC_NORET(void,SDL_PauseAudioDevice,(SDL_AudioDeviceID a, int b),(a,b))
SDL_DYNAPI_PROC(SDL_AudioSpec*,SDL_LoadWAV_RW,(SDL_RWops *a, int b, SDL_AudioSpec *c, Uint8 **d, Uint32 *e),(a,b,c,d,e),return)
SDL_DYNAPI_PROC_NORET(void,SDL_FreeWAV,(Uint8 *a),(a))
...
SDL_DYNAPI_PROC_NORET(void,SDL_MixAudio,(Uint8 *a, const Uint8 *b, Uint32 c, int d),(a,b,c,d))
SDL_DYNAPI_PROC_NORET(void,SDL_MixAudioFormat,(Uint8 *a, const Uint8 *b, SDL_AudioFormat c, Uint32 d, int e),(a,b,c,d,e))
SDL_DYNAPI_PROC_NORET(void,SDL_LockAudio,(void),())
SDL_DYNAPI_PROC_NORET(void,SDL_LockAudioDevice,(SDL_AudioDeviceID a),(a))
SDL_DYNAPI_PROC_NORET(void,SDL_UnlockAudio,(void),())
SDL_DYNAPI_PROC_NORET(void,SDL_UnlockAudioDevice,(SDL_AudioDeviceID a),(a))
SDL_DYNAPI_PROC_NORET(void,SDL_CloseAudio,(void),())
SDL_DYNAPI_PROC_NORET(void,SDL_CloseAudioDevice,(SDL_AudioDeviceID a),(a))
...
SDL_DYNAPI_PROC_NORET(void,SDL_ClearError,(void),())
SDL_DYNAPI_PROC(int,SDL_Error,(SDL_errorcode a),(a),return)
SDL_DYNAPI_PROC_NORET(void,SDL_PumpEvents,(void),())
...
SDL_DYNAPI_PROC_NORET(void,SDL_FlushEvent,(Uint32 a),(a))
SDL_DYNAPI_PROC_NORET(void,SDL_FlushEvents,(Uint32 a, Uint32 b),(a,b))
...
SDL_DYNAPI_PROC_NORET(void,SDL_SetEventFilter,(SDL_EventFilter a, void *b),(a,b))
SDL_DYNAPI_PROC(SDL_bool,SDL_GetEventFilter,(SDL_EventFilter *a, void **b),(a,b),return)
SDL_DYNAPI_PROC_NORET(void,SDL_AddEventWatch,(SDL_EventFilter a, void *b),(a,b))
SDL_DYNAPI_PROC_NORET(void,SDL_DelEventWatch,(SDL_EventFilter a, void *b),(a,b))
SDL_DYNAPI_PROC_NORET(void,SDL_FilterEvents,(SDL_EventFilter a, void *b),(a,b))
...
SDL_DYNAPI_PROC_NORET(void,SDL_GameControllerUpdate,(void),())
...
SDL_DYNAPI_PROC_NORET(void,SDL_GameControllerClose,(SDL_GameController *a),(a))
...
SDL_DYNAPI_PROC_NORET(void,SDL_HapticClose,(SDL_Haptic *a),(a))
...
SDL_DYNAPI_PROC_NORET(void,SDL_HapticDestroyEffect,(SDL_Haptic *a, int b),(a,b))
...
SDL_DYNAPI_PROC_NORET(void,SDL_AddHintCallback,(const char *a, SDL_HintCallback b, void *c),(a,b,c))
SDL_DYNAPI_PROC_NORET(void,SDL_DelHintCallback,(const char *a, SDL_HintCallback b, void *c),(a,b,c))
SDL_DYNAPI_PROC_NORET(void,SDL_ClearHints,(void),())
...
SDL_DYNAPI_PROC_NORET(void,SDL_JoystickGetGUIDString,(SDL_JoystickGUID a, char *b, int c),(a,b,c))
...
SDL_DYNAPI_PROC_NORET(void,SDL_JoystickUpdate,(void),())
...
SDL_DYNAPI_PROC_NORET(void,SDL_JoystickClose,(SDL_Joystick *a),(a))
...
SDL_DYNAPI_PROC_NORET(void,SDL_SetModState,(SDL_Keymod a),(a))
...
SDL_DYNAPI_PROC_NORET(void,SDL_StartTextInput,(void),())
SDL_DYNAPI_PROC(SDL_bool,SDL_IsTextInputActive,(void),(),return)
SDL_DYNAPI_PROC_NORET(void,SDL_StopTextInput,(void),())
SDL_DYNAPI_PROC_NORET(void,SDL_SetTextInputRect,(const SDL_Rect *a),(a))
...
SDL_DYNAPI_PROC_NORET(void,SDL_UnloadObject,(void *a),(a))
SDL_DYNAPI_PROC_NORET(void,SDL_LogSetAllPriority,(SDL_LogPriority a),(a))
SDL_DYNAPI_PROC_NORET(void,SDL_LogSetPriority,(int a, SDL_LogPriority b),(a,b))
SDL_DYNAPI_PROC(SDL_LogPriority,SDL_LogGetPriority,(int a),(a),return)
SDL_DYNAPI_PROC_NORET(void,SDL_LogResetPriorities,(void),())
SDL_DYNAPI_PROC_NORET(void,SDL_LogMessageV,(int a, SDL_LogPriority b, const char *c, va_list d),(a,b,c,d))
SDL_DYNAPI_PROC_NORET(void,SDL_LogGetOutputFunction,(SDL_LogOutputFunction *a, void **b),(a,b))
SDL_DYNAPI_PROC_NORET(void,SDL_LogSetOutputFunction,(SDL_LogOutputFunction a, void *b),(a,b))
SDL_DYNAPI_PROC_NORET(void,SDL_SetMainReady,(void),())
...
SDL_DYNAPI_PROC_NORET(void,SDL_WarpMouseInWindow,(SDL_Window *a, int b, int c),(a,b,c))
...
SDL_DYNAPI_PROC_NORET(void,SDL_SetCursor,(SDL_Cursor *a),(a))
SDL_DYNAPI_PROC(SDL_Cursor*,SDL_GetCursor,(void),(),return)
SDL_DYNAPI_PROC(SDL_Cursor*,SDL_GetDefaultCursor,(void),(),return)
SDL_DYNAPI_PROC_NORET(void,SDL_FreeCursor,(SDL_Cursor *a),(a))
...
SDL_DYNAPI_PROC_NORET(void,SDL_DestroyMutex,(SDL_mutex *a),(a))
SDL_DYNAPI_PROC(SDL_sem*,SDL_CreateSemaphore,(Uint32 a),(a),return)
SDL_DYNAPI_PROC_NORET(void,SDL_DestroySemaphore,(SDL_sem *a),(a))
...
SDL_DYNAPI_PROC_NORET(void,SDL_DestroyCond,(SDL_cond *a),(a))
...
SDL_DYNAPI_PROC_NORET(void,SDL_FreeFormat,(SDL_PixelFormat *a),(a))
...
SDL_DYNAPI_PROC_NORET(void,SDL_FreePalette,(SDL_Palette *a),(a))
...
SDL_DYNAPI_PROC_NORET(void,SDL_GetRGB,(Uint32 a, const SDL_PixelFormat *b, Uint8 *c, Uint8 *d, Uint8 *e),(a,b,c,d,e))
SDL_DYNAPI_PROC_NORET(void,SDL_GetRGBA,(Uint32 a, const SDL_PixelFormat *b, Uint8 *c, Uint8 *d, Uint8 *e, Uint8 *f),(a,b,c,d,e,f))
...
SDL_DYNAPI_PROC_NORET(void,SDL_UnionRect,(const SDL_Rect *a, const SDL_Rect *b, SDL_Rect *c),(a,b,c))
...
SDL_DYNAPI_PROC_NORET(void,SDL_UnlockTexture,(SDL_Texture *a),(a))
...
SDL_DYNAPI_PROC_NORET(void,SDL_RenderGetLogicalSize,(SDL_Renderer *a, int *b, int *c),(a,b,c))
SDL_DYNAPI_PROC(int,SDL_RenderSetViewport,(SDL_Renderer *a, const SDL_Rect *b),(a,b),return)
SDL_DYNAPI_PROC_NORET(void,SDL_RenderGetViewport,(SDL_Renderer *a, SDL_Rect *b),(a,b))
SDL_DYNAPI_PROC(int,SDL_RenderSetClipRect,(SDL_Renderer *a, const SDL_Rect *b),(a,b),return)
SDL_DYNAPI_PROC_NORET(void,SDL_RenderGetClipRect,(SDL_Renderer *a, SDL_Rect *b),(a,b))
SDL_DYNAPI_PROC(int,SDL_RenderSetScale,(SDL_Renderer *a, float b, float c),(a,b,c),return)
SDL_DYNAPI_PROC_NORET(void,SDL_RenderGetScale,(SDL_Renderer *a, float *b, float *c),(a,b,c))
...
SDL_DYNAPI_PROC_NORET(void,SDL_RenderPresent,(SDL_Renderer *a),(a))
SDL_DYNAPI_PROC_NORET(void,SDL_DestroyTexture,(SDL_Texture *a),(a))
SDL_DYNAPI_PROC_NORET(void,SDL_DestroyRenderer,(SDL_Renderer *a),(a))
...
SDL_DYNAPI_PROC_NORET(void,SDL_FreeRW,(SDL_RWops *a),(a))
...
SDL_DYNAPI_PROC_NORET(void,SDL_free,(void *a),(a))
...
SDL_DYNAPI_PROC_NORET(void,SDL_qsort,(void *a, size_t b, size_t c, int (SDLCALL *d)(const void *, const void *)),(a,b,c,d))
...
SDL_DYNAPI_PROC_NORET(void,SDL_FreeSurface,(SDL_Surface *a),(a))
...
SDL_DYNAPI_PROC_NORET(void,SDL_UnlockSurface,(SDL_Surface *a),(a))
...
SDL_DYNAPI_PROC_NORET(void,SDL_GetClipRect,(SDL_Surface *a, SDL_Rect *b),(a,b))
...
SDL_DYNAPI_PROC_NORET(void,SDL_WaitThread,(SDL_Thread *a, int *b),(a,b))
SDL_DYNAPI_PROC_NORET(void,SDL_DetachThread,(SDL_Thread *a),(a))
...
SDL_DYNAPI_PROC_NORET(void,SDL_Delay,(Uint32 a),(a))
...
SDL_DYNAPI_PROC_NORET(void,SDL_GetVersion,(SDL_version *a),(a))
...
SDL_DYNAPI_PROC_NORET(void,SDL_VideoQuit,(void),())
...
SDL_DYNAPI_PROC_NORET(void,SDL_SetWindowTitle,(SDL_Window *a, const char *b),(a,b))
SDL_DYNAPI_PROC(const char*,SDL_GetWindowTitle,(SDL_Window *a),(a),return)
SDL_DYNAPI_PROC_NORET(void,SDL_SetWindowIcon,(SDL_Window *a, SDL_Surface *b),(a,b))
...
SDL_DYNAPI_PROC_NORET(void,SDL_SetWindowPosition,(SDL_Window *a, int b, int c),(a,b,c))
SDL_DYNAPI_PROC_NORET(void,SDL_GetWindowPosition,(SDL_Window *a, int *b, int *c),(a,b,c))
SDL_DYNAPI_PROC_NORET(void,SDL_SetWindowSize,(SDL_Window *a, int b, int c),(a,b,c))
SDL_DYNAPI_PROC_NORET(void,SDL_GetWindowSize,(SDL_Window *a, int *b, int *c),(a,b,c))
SDL_DYNAPI_PROC_NORET(void,SDL_SetWindowMinimumSize,(SDL_Window *a, int b, int c),(a,b,c))
SDL_DYNAPI_PROC_NORET(void,SDL_GetWindowMinimumSize,(SDL_Window *a, int *b, int *c),(a,b,c))
SDL_DYNAPI_PROC_NORET(void,SDL_SetWindowMaximumSize,(SDL_Window *a, int b, int c),(a,b,c))
SDL_DYNAPI_PROC_NORET(void,SDL_GetWindowMaximumSize,(SDL_Window *a, int *b, int *c),(a,b,c))
SDL_DYNAPI_PROC_NORET(void,SDL_SetWindowBordered,(SDL_Window *a, SDL_bool b),(a,b))
SDL_DYNAPI_PROC_NORET(void,SDL_ShowWindow,(SDL_Window *a),(a))
SDL_DYNAPI_PROC_NORET(void,SDL_HideWindow,(SDL_Window *a),(a))
SDL_DYNAPI_PROC_NORET(void,SDL_RaiseWindow,(SDL_Window *a),(a))
SDL_DYNAPI_PROC_NORET(void,SDL_MaximizeWindow,(SDL_Window *a),(a))
SDL_DYNAPI_PROC_NORET(void,SDL_MinimizeWindow,(SDL_Window *a),(a))
SDL_DYNAPI_PROC_NORET(void,SDL_RestoreWindow,(SDL_Window *a),(a))
...
SDL_DYNAPI_PROC_NORET(void,SDL_SetWindowGrab,(SDL_Window *a, SDL_bool b),(a,b))
SDL_DYNAPI_PROC(SDL_bool,SDL_GetWindowGrab,(SDL_Window *a),(a),return)
SDL_DYNAPI_PROC_NORET(void,SDL_DestroyWindow,(SDL_Window *a),(a))
SDL_DYNAPI_PROC(SDL_bool,SDL_IsScreenSaverEnabled,(void),(),return)
SDL_DYNAPI_PROC_NORET(void,SDL_EnableScreenSaver,(void),())
SDL_DYNAPI_PROC_NORET(void,SDL_DisableScreenSaver,(void),())
...
SDL_DYNAPI_PROC_NORET(void,SDL_GL_UnloadLibrary,(void),())
...
SDL_DYNAPI_PROC_NORET(void,SDL_GL_GetDrawableSize,(SDL_Window *a, int *b, int *c),(a,b,c))
SDL_DYNAPI_PROC(int,SDL_GL_SetSwapInterval,(int a),(a),return)
SDL_DYNAPI_PROC(int,SDL_GL_GetSwapInterval,(void),(),return)
SDL_DYNAPI_PROC_NORET(void,SDL_GL_SwapWindow,(SDL_Window *a),(a))
SDL_DYNAPI_PROC_NORET(void,SDL_GL_DeleteContext,(SDL_GLContext a),(a))
...
SDL_DYNAPI_PROC_NORET(void,SDL_GL_ResetAttributes,(void),())
...
SDL_DYNAPI_PROC_NORET(void,SDL_ClearQueuedAudio,(SDL_AudioDeviceID a),(a))
SDL_DYNAPI_PROC(SDL_Window*,SDL_GetGrabbedWindow,(void),(),return)
#if defined(__WIN32__) || defined(__GDK__)
SDL_DYNAPI_PROC_NORET(void,SDL_SetWindowsMessageHook,(SDL_WindowsMessageHook a, void *b),(a,b))
#endif
...
SDL_DYNAPI_PROC_NORET(void,SDL_SetWindowResizable,(SDL_Window *a, SDL_bool b),(a,b))
...
SDL_DYNAPI_PROC_NORET(void,SDL_MemoryBarrierReleaseFunction,(void),())
SDL_DYNAPI_PROC_NORET(void,SDL_MemoryBarrierAcquireFunction,(void),())
...
SDL_DYNAPI_PROC_NORET(void,SDL_Vulkan_UnloadLibrary,(void),())
...
SDL_DYNAPI_PROC_NORET(void,SDL_Vulkan_GetDrawableSize,(SDL_Window *a, int *b, int *c),(a,b,c))
SDL_DYNAPI_PROC_NORET(void,SDL_LockJoysticks,(void),())
SDL_DYNAPI_PROC_NORET(void,SDL_UnlockJoysticks,(void),())
SDL_DYNAPI_PROC_NORET(void,SDL_GetMemoryFunctions,(SDL_malloc_func *a, SDL_calloc_func *b, SDL_realloc_func *c, SDL_free_func *d),(a,b,c,d))
...
SDL_DYNAPI_PROC_NORET(void,SDL_AudioStreamClear,(SDL_AudioStream *a),(a))
SDL_DYNAPI_PROC(int,SDL_AudioStreamAvailable,(SDL_AudioStream *a),(a),return)
SDL_DYNAPI_PROC_NORET(void,SDL_FreeAudioStream,(SDL_AudioStream *a),(a))
...
SDL_DYNAPI_PROC_NORET(void,SDL_SetYUVConversionMode,(SDL_YUV_CONVERSION_MODE a),(a))
...
SDL_DYNAPI_PROC_NORET(void,SDL_AndroidBackButton,(void),())
#endif
...
SDL_DYNAPI_PROC_NORET(void,SDL_SensorClose,(SDL_Sensor *a),(a))
SDL_DYNAPI_PROC_NORET(void,SDL_SensorUpdate,(void),())
...
SDL_DYNAPI_PROC_NORET(void,SDL_SIMDFree,(void *a),(a))
...
SDL_DYNAPI_PROC_NORET(void,SDL_Metal_DestroyView,(SDL_MetalView a),(a))
...
SDL_DYNAPI_PROC_NORET(void,SDL_GameControllerSetPlayerIndex,(SDL_GameController *a, int b),(a,b))
SDL_DYNAPI_PROC(SDL_Joystick*,SDL_JoystickFromPlayerIndex,(int a),(a),return)
SDL_DYNAPI_PROC_NORET(void,SDL_JoystickSetPlayerIndex,(SDL_Joystick *a, int b),(a,b))
...
SDL_DYNAPI_PROC_NORET(void,SDL_OnApplicationWillTerminate,(void),())
SDL_DYNAPI_PROC_NORET(void,SDL_OnApplicationDidReceiveMemoryWarning,(void),())
SDL_DYNAPI_PROC_NORET(void,SDL_OnApplicationWillResignActive,(void),())
SDL_DYNAPI_PROC_NORET(void,SDL_OnApplicationDidEnterBackground,(void),())
SDL_DYNAPI_PROC_NORET(void,SDL_OnApplicationWillEnterForeground,(void),())
SDL_DYNAPI_PROC_NORET(void,SDL_OnApplicationDidBecomeActive,(void),())
#ifdef __IOS__
SDL_DYNAPI_PROC_NORET(void,SDL_OnApplicationDidChangeStatusBarOrientation,(void),())
#endif
#ifdef __ANDROID__
...
SDL_DYNAPI_PROC_NORET(void,SDL_LockSensors,(void),())
SDL_DYNAPI_PROC_NORET(void,SDL_UnlockSensors,(void),())
SDL_DYNAPI_PROC(void*,SDL_Metal_GetLayer,(SDL_MetalView a),(a),return)
SDL_DYNAPI_PROC_NORET(void,SDL_Metal_GetDrawableSize,(SDL_Window *a, int *b, int *c),(a,b,c))
...
SDL_DYNAPI_PROC_NORET(void,SDL_SetWindowKeyboardGrab,(SDL_Window *a, SDL_bool b),(a,b))
SDL_DYNAPI_PROC_NORET(void,SDL_SetWindowMouseGrab,(SDL_Window *a, SDL_bool b),(a,b))
...
SDL_DYNAPI_PROC_NORET(void,SDL_TLSCleanup,(void),())
SDL_DYNAPI_PROC_NORET(void,SDL_SetWindowAlwaysOnTop,(SDL_Window *a, SDL_bool b),(a,b))
...
SDL_DYNAPI_PROC_NORET(void,SDL_hid_free_enumeration,(SDL_hid_device_info *a),(a))
...
SDL_DYNAPI_PROC_NORET(void,SDL_hid_close,(SDL_hid_device *a),(a))
...
SDL_DYNAPI_PROC_NORET(void,SDL_RenderWindowToLogical,(SDL_Renderer *a, int b, int c, float *d, float *e),(a,b,c,d,e))
SDL_DYNAPI_PROC_NORET(void,SDL_RenderLogicalToWindow,(SDL_Renderer *a, float b, float c, int *d, int *e),(a,b,c,d,e))
...
SDL_DYNAPI_PROC_NORET(void,SDL_hid_ble_scan,(SDL_bool a),(a))
...
SDL_DYNAPI_PROC_NORET(void,SDL_ClearComposition,(void),())
...
SDL_DYNAPI_PROC_NORET(void,SDL_UnionFRect,(const SDL_FRect *a, const SDL_FRect *b, SDL_FRect *c),(a,b,c))
...
SDL_DYNAPI_PROC_NORET(void,SDL_GUIDToString,(SDL_GUID a, char *b, int c),(a,b,c))
...
#endif
SDL_DYNAPI_PROC_NORET(void,SDL_GetOriginalMemoryFunctions,(SDL_malloc_func *a, SDL_calloc_func *b, SDL_realloc_func *c, SDL_free_func *d),(a,b,c,d))
SDL_DYNAPI_PROC_NORET(void,SDL_ResetKeyboard,(void),())
...
SDL_DYNAPI_PROC_NORET(void,SDL_GetWindowSizeInPixels,(SDL_Window *a, int *b, int *c),(a,b,c))
SDL_DYNAPI_PROC_NORET(void,SDL_GetJoystickGUIDInfo,(SDL_JoystickGUID a, Uint16 *b, Uint16 *c, Uint16 *d, Uint16 *e),(a,b,c,d,e))
...
SDL_DYNAPI_PROC_NORET(void,SDL_ResetHints,(void),())
...
SDL_DYNAPI_PROC_NORET(void,SDL_EGL_SetEGLAttributeCallbacks,(SDL_EGLAttribArrayCallback a, SDL_EGLIntArrayCallback b, SDL_EGLIntArrayCallback c),(a,b,c))
#if defined(__GDK__)
SDL_DYNAPI_PROC_NORET(void,SDL_GDKSuspendComplete,(void),())
#endif
...
SDL_DYNAPI_PROC_NORET(void,SDL_DelayNS,(Uint64 a),(a))
