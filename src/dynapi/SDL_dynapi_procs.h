...
SDL_DYNAPI_PROC(SDL_GPUFence*,SDL_SubmitGPUCommandBufferAndAcquireGPUFence,(SDL_GPUCommandBuffer *a),(a),return)
SDL_DYNAPI_PROC(SDL_bool,SDL_SupportsGPUPresentMode,(SDL_GPUDevice *a, SDL_Window *b, SDL_GPUPresentMode c),(a,b,c),return)
SDL_DYNAPI_PROC(SDL_bool,SDL_SupportsGPUTextureSampleCount,(SDL_GPUDevice *a, SDL_GPUTextureFormat b, SDL_GPUSampleCount c),(a,b,c),return)
...
SDL_DYNAPI_PROC(void,SDL_UnclaimWindowForGPUDevice,(SDL_GPUDevice *a, SDL_Window *b),(a,b),)
