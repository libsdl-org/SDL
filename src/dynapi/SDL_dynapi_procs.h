...
SDL_DYNAPI_PROC(bool,SDL_CompareAndSwapAtomicIntStrongWithOrder,(SDL_AtomicInt *a,int b,int c,SDL_MemoryOrder d,SDL_MemoryOrder e),(a,b,c,d,e),return)
SDL_DYNAPI_PROC(bool,SDL_CompareAndSwapAtomicIntWeakWithOrder,(SDL_AtomicInt *a,int b,int c,SDL_MemoryOrder d,SDL_MemoryOrder e),(a,b,c,d,e),return)
SDL_DYNAPI_PROC(int,SDL_SetAtomicIntWithOrder,(SDL_AtomicInt *a,int b,SDL_MemoryOrder c),(a,b,c),return)
SDL_DYNAPI_PROC(int,SDL_GetAtomicIntWithOrder,(SDL_AtomicInt *a,SDL_MemoryOrder b),(a,b),return)
SDL_DYNAPI_PROC(int,SDL_AddAtomicIntWithOrder,(SDL_AtomicInt *a,int b,SDL_MemoryOrder c),(a,b,c),return)
SDL_DYNAPI_PROC(bool,SDL_CompareAndSwapAtomicU32StrongWithOrder,(SDL_AtomicU32 *a,Uint32 b,Uint32 c,SDL_MemoryOrder d,SDL_MemoryOrder e),(a,b,c,d,e),return)
SDL_DYNAPI_PROC(bool,SDL_CompareAndSwapAtomicU32WeakWithOrder,(SDL_AtomicU32 *a,Uint32 b,Uint32 c,SDL_MemoryOrder d,SDL_MemoryOrder e),(a,b,c,d,e),return)
SDL_DYNAPI_PROC(Uint32,SDL_SetAtomicU32WithOrder,(SDL_AtomicU32 *a,Uint32 b,SDL_MemoryOrder c),(a,b,c),return)
SDL_DYNAPI_PROC(Uint32,SDL_GetAtomicU32WithOrder,(SDL_AtomicU32 *a,SDL_MemoryOrder b),(a,b),return)
SDL_DYNAPI_PROC(Uint32,SDL_AddAtomicU32WithOrder,(SDL_AtomicU32 *a,int b,SDL_MemoryOrder c),(a,b,c),return)
SDL_DYNAPI_PROC(bool,SDL_CompareAndSwapAtomicPointerStrongWithOrder,(void **a,void *b,void *c,SDL_MemoryOrder d,SDL_MemoryOrder e),(a,b,c,d,e),return)
SDL_DYNAPI_PROC(bool,SDL_CompareAndSwapAtomicPointerWeakWithOrder,(void **a,void *b,void *c,SDL_MemoryOrder d,SDL_MemoryOrder e),(a,b,c,d,e),return)
SDL_DYNAPI_PROC(void*,SDL_SetAtomicPointerWithOrder,(void **a,void *b,SDL_MemoryOrder c),(a,b,c),return)
SDL_DYNAPI_PROC(void*,SDL_GetAtomicPointerWithOrder,(void **a,SDL_MemoryOrder b),(a,b),return)
