...
SDL_DYNAPI_PROC(char**,SDL_GlobDirectory,(const char *a, const char *b, int *c),(a,b,c),return)
SDL_DYNAPI_PROC(char**,SDL_GlobStorageDirectory,(SDL_Storage *a, const char *b, const char *c, int *d),(a,b,c,d),return)
