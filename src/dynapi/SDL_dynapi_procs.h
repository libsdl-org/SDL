...
SDL_DYNAPI_PROC(SDL_ClipboardData*,SDL_CreateClipboardData,(void *a, size_t b, const char *c),(a,b,c),return)
SDL_DYNAPI_PROC(int,SDL_AddClipboardData,(SDL_ClipboardData *a, void *b, size_t c, const char *d),(a,b,c,d),return)
SDL_DYNAPI_PROC(void,SDL_DestroyClipboardData,(SDL_ClipboardData *a),(a),)
SDL_DYNAPI_PROC(int,SDL_SetClipboardData,(SDL_ClipboardData *a, SDL_bool b),(a,b),return)
