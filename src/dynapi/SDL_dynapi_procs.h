...
SDL_DYNAPI_PROC(int,SDL_EnumerateDirectory,(const char *a, SDL_EnumerateCallback b, void *c),(a,b,c),return)
SDL_DYNAPI_PROC(int,SDL_RemoveFile,(const char *a),(a),return)
SDL_DYNAPI_PROC(int,SDL_RenameFile,(const char *a, const char *b),(a,b),return)
SDL_DYNAPI_PROC(int,SDL_StatFile,(const char *a, SDL_Stat *b),(a,b),return)
