...
SDL_DYNAPI_PROC_VOID(SDL_LogCritical,(int a, SDL_PRINTF_FORMAT_STRING const char *b, ...),(a,b))
SDL_DYNAPI_PROC_VOID(SDL_LogDebug,(int a, SDL_PRINTF_FORMAT_STRING const char *b, ...),(a,b))
SDL_DYNAPI_PROC_VOID(SDL_LogError,(int a, SDL_PRINTF_FORMAT_STRING const char *b, ...),(a,b))
SDL_DYNAPI_PROC_VOID(SDL_LogInfo,(int a, SDL_PRINTF_FORMAT_STRING const char *b, ...),(a,b))
SDL_DYNAPI_PROC_VOID(SDL_LogMessage,(int a, SDL_LogPriority b, SDL_PRINTF_FORMAT_STRING const char *c, ...),(a,b,c))
SDL_DYNAPI_PROC_VOID(SDL_LogVerbose,(int a, SDL_PRINTF_FORMAT_STRING const char *b, ...),(a,b))
SDL_DYNAPI_PROC_VOID(SDL_LogWarn,(int a, SDL_PRINTF_FORMAT_STRING const char *b, ...),(a,b))
...
SDL_DYNAPI_PROC_VOID(SDL_SetWindowsMessageHook,(SDL_WindowsMessageHook a, void *b),(a,b))
SDL_DYNAPI_PROC_VOID(SDL_UnregisterApp,(void),())
...
SDL_DYNAPI_PROC_VOID(SDL_GDKSuspendComplete,(void),())
...
SDL_DYNAPI_PROC_VOID(SDL_OnApplicationDidChangeStatusBarOrientation,(void),())
SDL_DYNAPI_PROC(int,SDL_iPhoneSetAnimationCallback,(SDL_Window *a, int b, void (SDLCALL *c)(void *), void *d),(a,b,c,d),return)
SDL_DYNAPI_PROC_VOID(SDL_iPhoneSetEventPump,(SDL_bool a),(a))

SDL_DYNAPI_PROC_VOID(SDL_AndroidBackButton,(void),())
...
SDL_DYNAPI_PROC_VOID(SDL_LockSpinlock,(SDL_SpinLock *a),(a))
...
SDL_DYNAPI_PROC_VOID(SDL_UnlockSpinlock,(SDL_SpinLock *a),(a))
...
SDL_DYNAPI_PROC_VOID(SDL_CleanupTLS,(void),())
SDL_DYNAPI_PROC_VOID(SDL_ClearComposition,(void),())
SDL_DYNAPI_PROC_VOID(SDL_ClearError,(void),())
SDL_DYNAPI_PROC_VOID(SDL_CloseGamepad,(SDL_Gamepad *a),(a))
SDL_DYNAPI_PROC_VOID(SDL_CloseJoystick,(SDL_Joystick *a),(a))
SDL_DYNAPI_PROC_VOID(SDL_CloseSensor,(SDL_Sensor *a),(a))
...
SDL_DYNAPI_PROC_VOID(SDL_DelEventWatch,(SDL_EventFilter a, void *b),(a,b))
SDL_DYNAPI_PROC_VOID(SDL_DelHintCallback,(const char *a, SDL_HintCallback b, void *c),(a,b,c))
SDL_DYNAPI_PROC_VOID(SDL_Delay,(Uint32 a),(a))
SDL_DYNAPI_PROC_VOID(SDL_DelayNS,(Uint64 a),(a))
SDL_DYNAPI_PROC_VOID(SDL_DestroyCondition,(SDL_Condition *a),(a))
SDL_DYNAPI_PROC_VOID(SDL_DestroyCursor,(SDL_Cursor *a),(a))
SDL_DYNAPI_PROC_VOID(SDL_DestroyMutex,(SDL_Mutex *a),(a))
SDL_DYNAPI_PROC_VOID(SDL_DestroyPalette,(SDL_Palette *a),(a))
SDL_DYNAPI_PROC_VOID(SDL_DestroyPixelFormat,(SDL_PixelFormat *a),(a))
SDL_DYNAPI_PROC_VOID(SDL_DestroyRW,(SDL_RWops *a),(a))
SDL_DYNAPI_PROC_VOID(SDL_DestroyRWLock,(SDL_RWLock *a),(a))
SDL_DYNAPI_PROC_VOID(SDL_DestroyRenderer,(SDL_Renderer *a),(a))
SDL_DYNAPI_PROC_VOID(SDL_DestroySemaphore,(SDL_Semaphore *a),(a))
SDL_DYNAPI_PROC_VOID(SDL_DestroySurface,(SDL_Surface *a),(a))
SDL_DYNAPI_PROC_VOID(SDL_DestroyTexture,(SDL_Texture *a),(a))
SDL_DYNAPI_PROC_VOID(SDL_DestroyWindow,(SDL_Window *a),(a))
SDL_DYNAPI_PROC(int,SDL_DestroyWindowSurface,(SDL_Window *a),(a),return)
SDL_DYNAPI_PROC_VOID(SDL_DetachThread,(SDL_Thread *a),(a))
...
SDL_DYNAPI_PROC_VOID(SDL_EGL_SetEGLAttributeCallbacks,(SDL_EGLAttribArrayCallback a, SDL_EGLIntArrayCallback b, SDL_EGLIntArrayCallback c),(a,b,c))
...
SDL_DYNAPI_PROC_VOID(SDL_FilterEvents,(SDL_EventFilter a, void *b),(a,b))
SDL_DYNAPI_PROC(int,SDL_FlashWindow,(SDL_Window *a, SDL_FlashOperation b),(a,b),return)
SDL_DYNAPI_PROC_VOID(SDL_FlushEvent,(Uint32 a),(a))
SDL_DYNAPI_PROC_VOID(SDL_FlushEvents,(Uint32 a, Uint32 b),(a,b))
...
SDL_DYNAPI_PROC_VOID(SDL_GL_ResetAttributes,(void),())
...
SDL_DYNAPI_PROC_VOID(SDL_GetJoystickGUIDInfo,(SDL_JoystickGUID a, Uint16 *b, Uint16 *c, Uint16 *d, Uint16 *e),(a,b,c,d,e))
...
SDL_DYNAPI_PROC_VOID(SDL_GetMemoryFunctions,(SDL_malloc_func *a, SDL_calloc_func *b, SDL_realloc_func *c, SDL_free_func *d),(a,b,c,d))
...
SDL_DYNAPI_PROC_VOID(SDL_GetOriginalMemoryFunctions,(SDL_malloc_func *a, SDL_calloc_func *b, SDL_realloc_func *c, SDL_free_func *d),(a,b,c,d))
...
SDL_DYNAPI_PROC_VOID(SDL_GetRGB,(Uint32 a, const SDL_PixelFormat *b, Uint8 *c, Uint8 *d, Uint8 *e),(a,b,c,d,e))
SDL_DYNAPI_PROC_VOID(SDL_GetRGBA,(Uint32 a, const SDL_PixelFormat *b, Uint8 *c, Uint8 *d, Uint8 *e, Uint8 *f),(a,b,c,d,e,f))
...
SDL_DYNAPI_PROC_VOID(SDL_CloseHaptic,(SDL_Haptic *a),(a))
SDL_DYNAPI_PROC_VOID(SDL_DestroyHapticEffect,(SDL_Haptic *a, int b),(a,b))
...
SDL_DYNAPI_PROC_VOID(SDL_LockJoysticks,(void),())
SDL_DYNAPI_PROC_VOID(SDL_LockMutex,(SDL_Mutex *a),(a))
SDL_DYNAPI_PROC_VOID(SDL_LockRWLockForReading,(SDL_RWLock *a),(a))
SDL_DYNAPI_PROC_VOID(SDL_LockRWLockForWriting,(SDL_RWLock *a),(a))
...
SDL_DYNAPI_PROC_VOID(SDL_LogGetOutputFunction,(SDL_LogOutputFunction *a, void **b),(a,b))
SDL_DYNAPI_PROC(SDL_LogPriority,SDL_LogGetPriority,(int a),(a),return)
SDL_DYNAPI_PROC_VOID(SDL_LogMessageV,(int a, SDL_LogPriority b, SDL_PRINTF_FORMAT_STRING const char *c, va_list d),(a,b,c,d))
SDL_DYNAPI_PROC_VOID(SDL_LogResetPriorities,(void),())
SDL_DYNAPI_PROC_VOID(SDL_LogSetAllPriority,(SDL_LogPriority a),(a))
SDL_DYNAPI_PROC_VOID(SDL_LogSetOutputFunction,(SDL_LogOutputFunction a, void *b),(a,b))
SDL_DYNAPI_PROC_VOID(SDL_LogSetPriority,(int a, SDL_LogPriority b),(a,b))
...
SDL_DYNAPI_PROC_VOID(SDL_MemoryBarrierAcquireFunction,(void),())
SDL_DYNAPI_PROC_VOID(SDL_MemoryBarrierReleaseFunction,(void),())
SDL_DYNAPI_PROC(SDL_MetalView,SDL_Metal_CreateView,(SDL_Window *a),(a),return)
SDL_DYNAPI_PROC_VOID(SDL_Metal_DestroyView,(SDL_MetalView a),(a))
...
SDL_DYNAPI_PROC_VOID(SDL_OnApplicationDidBecomeActive,(void),())
SDL_DYNAPI_PROC_VOID(SDL_OnApplicationDidEnterBackground,(void),())
SDL_DYNAPI_PROC_VOID(SDL_OnApplicationDidReceiveMemoryWarning,(void),())
SDL_DYNAPI_PROC_VOID(SDL_OnApplicationWillEnterForeground,(void),())
SDL_DYNAPI_PROC_VOID(SDL_OnApplicationWillResignActive,(void),())
SDL_DYNAPI_PROC_VOID(SDL_OnApplicationWillTerminate,(void),())
...
SDL_DYNAPI_PROC_VOID(SDL_PumpEvents,(void),())
...
SDL_DYNAPI_PROC_VOID(SDL_Quit,(void),())
SDL_DYNAPI_PROC_VOID(SDL_QuitSubSystem,(Uint32 a),(a))
...
SDL_DYNAPI_PROC_VOID(SDL_ResetAssertionReport,(void),())
SDL_DYNAPI_PROC(SDL_bool,SDL_ResetHint,(const char *a),(a),return)
SDL_DYNAPI_PROC_VOID(SDL_ResetHints,(void),())
SDL_DYNAPI_PROC_VOID(SDL_ResetKeyboard,(void),())
...
SDL_DYNAPI_PROC_VOID(SDL_SetAssertionHandler,(SDL_AssertionHandler a, void *b),(a,b))
...
SDL_DYNAPI_PROC_VOID(SDL_SetEventEnabled,(Uint32 a, SDL_bool b),(a,b))
SDL_DYNAPI_PROC_VOID(SDL_SetEventFilter,(SDL_EventFilter a, void *b),(a,b))
SDL_DYNAPI_PROC_VOID(SDL_SetGamepadEventsEnabled,(SDL_bool a),(a))
...
SDL_DYNAPI_PROC_VOID(SDL_SetJoystickEventsEnabled,(SDL_bool a),(a))
...
SDL_DYNAPI_PROC_VOID(SDL_SetMainReady,(void),())
...
SDL_DYNAPI_PROC_VOID(SDL_SetModState,(SDL_Keymod a),(a))
...
SDL_DYNAPI_PROC_VOID(SDL_StartTextInput,(void),())
SDL_DYNAPI_PROC_VOID(SDL_StopTextInput,(void),())
...
SDL_DYNAPI_PROC_VOID(SDL_UnloadObject,(void *a),(a))
SDL_DYNAPI_PROC_VOID(SDL_UnlockJoysticks,(void),())
SDL_DYNAPI_PROC_VOID(SDL_UnlockMutex,(SDL_Mutex *a),(a))
SDL_DYNAPI_PROC_VOID(SDL_UnlockRWLock,(SDL_RWLock *a),(a))
SDL_DYNAPI_PROC_VOID(SDL_UnlockSurface,(SDL_Surface *a),(a))
SDL_DYNAPI_PROC_VOID(SDL_UnlockTexture,(SDL_Texture *a),(a))
SDL_DYNAPI_PROC_VOID(SDL_UpdateGamepads,(void),())
SDL_DYNAPI_PROC_VOID(SDL_UpdateJoysticks,(void),())
...
SDL_DYNAPI_PROC_VOID(SDL_UpdateSensors,(void),())
...
SDL_DYNAPI_PROC_VOID(SDL_Vulkan_UnloadLibrary,(void),())
...
SDL_DYNAPI_PROC_VOID(SDL_WaitThread,(SDL_Thread *a, int *b),(a,b))
SDL_DYNAPI_PROC(int,SDL_WarpMouseGlobal,(float a, float b),(a,b),return)
SDL_DYNAPI_PROC_VOID(SDL_WarpMouseInWindow,(SDL_Window *a, float b, float c),(a,b,c))
...
SDL_DYNAPI_PROC_VOID(SDL_aligned_free,(void *a),(a))
...
SDL_DYNAPI_PROC_VOID(SDL_free,(void *a),(a))
SDL_DYNAPI_PROC(char*,SDL_getenv,(const char *a),(a),return)
SDL_DYNAPI_PROC_VOID(SDL_hid_ble_scan,(SDL_bool a),(a))
...
SDL_DYNAPI_PROC_VOID(SDL_hid_free_enumeration,(SDL_hid_device_info *a),(a))
...
SDL_DYNAPI_PROC_VOID(SDL_qsort,(void *a, size_t b, size_t c, int (SDLCALL *d)(const void *, const void *)),(a,b,c,d))
...
SDL_DYNAPI_PROC_VOID(SDL_CloseAudioDevice,(SDL_AudioDeviceID a),(a))
...
SDL_DYNAPI_PROC_VOID(SDL_UnbindAudioStreams,(SDL_AudioStream **a, int b),(a,b))
SDL_DYNAPI_PROC_VOID(SDL_UnbindAudioStream,(SDL_AudioStream *a),(a))
...
SDL_DYNAPI_PROC_VOID(SDL_DestroyAudioStream,(SDL_AudioStream *a),(a))
...
SDL_DYNAPI_PROC_VOID(SDL_UnlockProperties,(SDL_PropertiesID a),(a))
...
SDL_DYNAPI_PROC_VOID(SDL_DestroyProperties,(SDL_PropertiesID a),(a))
...
SDL_DYNAPI_PROC_VOID(SDL_SetX11EventHook,(SDL_X11EventHook a, void *b),(a,b))
...
SDL_DYNAPI_PROC_VOID(SDL_CloseCamera,(SDL_Camera *a),(a))
...
SDL_DYNAPI_PROC_VOID(SDL_qsort_r,(void *a, size_t b, size_t c, int (SDLCALL *d)(void *, const void *, const void *), void *e),(a,b,c,d,e))
