...
SDL_DYNAPI_PROC(bool,SDL_CompareAndSwapRelaxedAtomicInt,(SDL_AtomicInt *a,int b,int c),(a,b,c),return)
SDL_DYNAPI_PROC(int,SDL_SetRelaxedAtomicInt,(SDL_AtomicInt *a,int b),(a,b),return)
SDL_DYNAPI_PROC(int,SDL_GetRelaxedAtomicInt,(SDL_AtomicInt *a),(a),return)
SDL_DYNAPI_PROC(int,SDL_AddRelaxedAtomicInt,(SDL_AtomicInt *a,int b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_CompareAndSwapRelaxedAtomicU32,(SDL_AtomicU32 *a,Uint32 b,Uint32 c),(a,b,c),return)
SDL_DYNAPI_PROC(Uint32,SDL_SetRelaxedAtomicU32,(SDL_AtomicU32 *a,Uint32 b),(a,b),return)
SDL_DYNAPI_PROC(Uint32,SDL_GetRelaxedAtomicU32,(SDL_AtomicU32 *a),(a),return)
SDL_DYNAPI_PROC(Uint32,SDL_AddRelaxedAtomicU32,(SDL_AtomicU32 *a,int b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_CompareAndSwapRelaxedAtomicPointer,(void **a,void *b,void *c),(a,b,c),return)
SDL_DYNAPI_PROC(void*,SDL_SetRelaxedAtomicPointer,(void **a,void *b),(a,b),return)
SDL_DYNAPI_PROC(void*,SDL_GetRelaxedAtomicPointer,(void **a),(a),return)
