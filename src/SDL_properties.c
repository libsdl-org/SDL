...
static void SDLCALL SDL_FreeProperties(void *unused, const void *key, const void *value)
{
    (void) unused;
    (void) key;  // this is an SDL_PropertiesID--an integer--doesn't need freeing.
...
SDL_PropertiesID SDL_CreateProperties(void)
{
    ...
    if (!SDL_InsertIntoHashTable(SDL_properties, (const void *)(uintptr_t)props, properties, false)) {
        SDL_FreeProperties(NULL, NULL, properties);
        return 0;
    }
