...
JOB_SPECS = {
    ...
    "steamrt3": JobSpec(name="Steam Linux Runtime 3.0 (x86_64, redist)",               os=JobOs.UbuntuLatest,      platform=SdlPlatform.Linux,       artifact="SDL-steamrt3",           container="registry.gitlab.steamos.cloud/steamrt/sniper/sdk:latest" ),
    "steamrt4": JobSpec(name="Steam Linux Runtime 4.0 (x86_64, redist)",               os=JobOs.UbuntuLatest,      platform=SdlPlatform.Linux,       artifact="SDL-steamrt4",           container="registry.gitlab.steamos.cloud/steamrt/steamrt4/sdk:latest" ),
    "steamrt4-arm64": JobSpec(name="Steam Linux Runtime 4.0 (arm64, redist)",          os=JobOs.Ubuntu24_04_arm,   platform=SdlPlatform.Linux,       artifact="SDL-steamrt4-arm64",     container="registry.gitlab.steamos.cloud/steamrt/steamrt4/sdk/arm64:latest" ),
    "steamrt3-sysroot": JobSpec(name="Steam Linux Runtime 3.0 (x86_64, sysroot)",      os=JobOs.UbuntuLatest,      platform=SdlPlatform.Linux,       artifact=None,                     container="registry.gitlab.steamos.cloud/steamrt/sniper/sdk:latest", more_hard_deps = True, ),
    "steamrt4-sysroot": JobSpec(name="Steam Linux Runtime 4.0 (x86_64, sysroot)",      os=JobOs.UbuntuLatest,      platform=SdlPlatform.Linux,       artifact=None,                     container="registry.gitlab.steamos.cloud/steamrt/steamrt4/sdk:latest", more_hard_deps = True, ),
    "steamrt4-arm64-sysroot": JobSpec(name="Steam Linux Runtime 4.0 (arm64, sysroot)", os=JobOs.Ubuntu24_04_arm,   platform=SdlPlatform.Linux,       artifact=None,                     container="registry.gitlab.steamos.cloud/steamrt/steamrt4/sdk/arm64:latest", more_hard_deps = True, ),
