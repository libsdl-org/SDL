...
JOB_SPECS = {
    ...
    "steamrt-sniper-arm64": JobSpec(name="Steam Linux Runtime (arm64)",     os=JobOs.Ubuntu24_04_arm,   platform=SdlPlatform.Linux,       artifact="SDL-slrsniper-arm64",    container="registry.gitlab.steamos.cloud/steamrt/sniper/sdk/arm64:3.0.20250408.124536", ),
